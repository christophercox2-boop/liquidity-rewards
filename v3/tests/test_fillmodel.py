...
from v3.fillmodel import DAY_S, FillModel, family_of
...
class TestFamilies(unittest.TestCase):
    def test_families(self):
        ...
        self.assertEqual(family_of("ussewc-usse-ok-2026-11-03-rep"), "senate")
        self.assertEqual(family_of("usgubewc-usgub-tx-2026-11-03-rep"), "governor")
        self.assertEqual(family_of("vmc-ussemov-ga-2026-11-03-d4-7"), "margins")
        self.assertEqual(family_of("enwc-uspres-nom-dem-2028-petbut"), "slate-2028")
        self.assertEqual(family_of("paccc-usho-midterms-2026-11-03-rep"), "other")
...
class TestShieldDiscount(unittest.TestCase):
    ...
    def test_no_wall_leaves_the_hazard_alone(self):
        from v3.fillmodel import shield_discount
    ...
    def test_floored_because_a_wall_can_vanish(self):
        from v3.fillmodel import shield_discount, SHIELD_FLOOR
