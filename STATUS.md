...
## ✅ Last successful check: 2026-08-15 8:34 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$1,237.03/day estimated (ceiling, not promise — details below)
...
**What else to join:** `apdc-jerpowgov-2026-08-31` — SELL at the best price, ~$4.37/day for 200 contracts. Runners-up: `ewc-usgub-nv-2026-11-03-rep` (~$4.30/day), `ewc-usse-oh-2026-11-03-dem` (~$2.05/day)
...
### Estimated earning rate: ~$1,237.03/day (~$51.54/hour)
...
| `usgubewc-usgub-mn-2026-11-03-dem` | BUY | 71.0¢ | 10 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (580,226 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `ussewc-usse-ms-2026-11-03-rep` | SELL | 90.0¢ | 15 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (2,402 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `ewc-usp-2028-11-07-jbpri` | BUY | 18.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~90.1% of bid side (20,613 resting ≥ 20,000 ✓) ≈ $16.68/day (pool ÷ 27 markets) |
| `ewc-usp-2028-11-07-rondes` | BUY | 10.0¢ | 24 | 1 | $1,000.00 | ✅ scoring — ~89.7% of bid side (20,581 resting ≥ 20,000 ✓) ≈ $16.61/day (pool ÷ 27 markets) |
...
<details><summary><code>usgubewc-usgub-mn-2026-11-03-dem</code> BUY 10 @ 71¢ → $6.25/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 71¢ | 10 (10 yours) | ×0.1^0 = 10.0 |
|  | 56¢ | 16 | ×0.1^15 = 0.0 |
|  | 2¢ | 580,000 | ×0.1^69 = 0.0 |
| | | **Σ** | **10.0** |
...
|---|---:|---:|---:|---|---:|---:|
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (5,628 resting) | ~17.5% | ~$4.37 |
| `ewc-usgub-nv-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (73,155 resting) | ~68.8% | ~$4.30 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (668,940 resting) | ~8.2% | ~$2.05 |
...
| `ewc-usmayor-losang-2026-11-03-karbas` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (205,056 resting) | ~28.2% | ~$1.76 |
| `ewc-usse-mi-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (628,085 resting) | ~17.5% | ~$1.09 |
...
| `ewc-usgub-mi-2026-11-03-dem` | $25.00 ÷ 3 | 0.10 | 2,000 | SELL side (53,598 resting) | ~19.3% | ~$0.80 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (95,758 resting) | ~11.9% | ~$0.74 |
