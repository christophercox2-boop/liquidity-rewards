...
## ✅ Last successful check: 2026-08-07 4:03 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$126.44/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-ussep-mn-2026-08-11-dem-pegfla` — BUY at the best price, ~$23.22/day for 200 contracts. Runners-up: `ewc-usse-tx-2026-11-03-dem` (~$12.88/day), `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$10.57/day)
...
### Estimated earning rate: ~$126.44/day (~$5.27/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `scc-hrep-rep-2026-11-03-gte195` | BUY | 27.0¢ | 80 | 0 | $100.00 | ✅ scoring — ~100.0% of bid side (80,620 resting ≥ 5,000 ✓) ≈ $4.17/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-51` | BUY | 18.0¢ | 5 | 0 | $100.00 | ✅ scoring — ~96.5% of bid side (200,550 resting ≥ 5,000 ✓) ≈ $3.71/day (pool ÷ 13 markets) |
| `opdc-mcconnell-resign-2026-11-02` | SELL | 10.0¢ | 9 | 0 | $25.00 | ✅ scoring — ~89.5% of ask side (5,305 resting ≥ 2,000 ✓) ≈ $11.19/day |
...
| `scc-hrep-rep-2026-11-03-gte215` | SELL | 38.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~66.7% of ask side (62,739 resting ≥ 5,000 ✓) ≈ $2.78/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte180` | BUY | 80.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~66.1% of bid side (50,478 resting ≥ 5,000 ✓) ≈ $2.75/day (pool ÷ 12 markets) |
| `scc-hrep-rep-2026-11-03-gte190` | BUY | 66.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~65.7% of bid side (80,181 resting ≥ 5,000 ✓) ≈ $2.74/day (pool ÷ 12 markets) |
| `scc-hrep-rep-2026-11-03-gte210` | BUY | 37.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~62.5% of bid side (80,469 resting ≥ 5,000 ✓) ≈ $2.60/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-50` | SELL | 29.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~62.3% of ask side (113,526 resting ≥ 5,000 ✓) ≈ $2.40/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte185` | SELL | 82.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~62.0% of ask side (5,501 resting ≥ 5,000 ✓) ≈ $2.58/day (pool ÷ 12 markets) |
| `opdc-mcconnell-resign-2026-11-02` | BUY | 8.0¢ | 15 | 0 | $25.00 | ✅ scoring — ~59.9% of bid side (35,527 resting ≥ 2,000 ✓) ≈ $7.49/day |
| `dccc-measles-us-2026-12-31-gt3000` | BUY | 77.0¢ | 10 | 0 | $50.00 | ✅ scoring — ~57.1% of bid side (10,335 resting ≥ 10,000 ✓) ≈ $2.38/day (pool ÷ 6 markets) |
...
| `scc-hrep-rep-2026-11-03-gte225` | BUY | 10.0¢ | 30 | 0 | $100.00 | ✅ scoring — ~50.0% of bid side (80,510 resting ≥ 5,000 ✓) ≈ $2.08/day (pool ÷ 12 markets) |
...
| `apdc-jerpowgov-2026-12-31` | BUY | 24.0¢ | 20 | 0 | $100.00 | ✅ scoring — ~43.4% of bid side (5,346 resting ≥ 5,000 ✓) ≈ $10.85/day (pool ÷ 2 markets) |
...
| `lawec-cryptoleg-2026-12-31` | BUY | 20.0¢ | 21 | 0 | $25.00 | ✅ scoring — ~40.8% of bid side (27,840 resting ≥ 2,000 ✓) ≈ $2.55/day (pool ÷ 2 markets) |
| `opdc-mcconnell-resign-2026-11-02` | BUY | 8.0¢ | 10 | 0 | $25.00 | ✅ scoring — ~39.9% of bid side (35,527 resting ≥ 2,000 ✓) ≈ $4.99/day |
| `scc-senate-gop-2026-11-03-48` | BUY | 17.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~38.3% of bid side (50,426 resting ≥ 5,000 ✓) ≈ $1.47/day (pool ÷ 13 markets) |
| `apdc-alito-2026-12-31` | SELL | 19.0¢ | 126 | 0 | $100.00 | ✅ scoring — ~36.9% of ask side (5,600 resting ≥ 5,000 ✓) ≈ $9.24/day (pool ÷ 2 markets) |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte195</code> BUY 80 @ 27¢ → $4.17/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 27¢ | 80 (80 yours) | ×0.2^0 = 80.0 |
|  | 3¢ | 150 | ×0.2^24 = 0.0 |
|  | 2¢ | 80,190 | ×0.2^25 = 0.0 |
| | | **Σ** | **80.0** |
...
<details><summary><code>scc-senate-gop-2026-11-03-51</code> BUY 5 @ 18¢ → $3.71/day</summary>
...
<details><summary><code>opdc-mcconnell-resign-2026-11-02</code> SELL 9 @ 10¢ → $11.19/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 10¢ | 10 (9 yours) | ×0.1^0 = 9.6 |
|  | 15¢ | 197 | ×0.1^5 = 0.0 |
|  | 28¢ | 5 | ×0.1^18 = 0.0 |
|  | 85¢ | 10 | ×0.1^75 = 0.0 |
|  | 99¢ | 5,084 | ×0.1^89 = 0.0 |
...
`yours 8.6 / Σ 9.6 = 89.5%`  
`$25 ÷ 1 ÷ 2 = $12.50 × 89.5% = $11.19/day`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte215</code> SELL 10 @ 38¢ → $2.78/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte180</code> BUY 10 @ 80¢ → $2.75/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte190</code> BUY 10 @ 66¢ → $2.74/day</summary>
...
`yours 10.0 / Σ 15.2 = 65.7%`  
`$100 ÷ 12 ÷ 2 = $4.17 × 65.7% = $2.74/day`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte210</code> BUY 10 @ 37¢ → $2.60/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 37¢ | 16 (10 yours) | ×0.2^0 = 16.0 |
|  | 21¢ | 3 | ×0.2^16 = 0.0 |
|  | 2¢ | 80,250 | ×0.2^35 = 0.0 |
| | | **Σ** | **16.0** |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte185</code> SELL 10 @ 82¢ → $2.58/day</summary>
...
<details><summary><code>opdc-mcconnell-resign-2026-11-02</code> BUY 15 @ 8¢ → $7.49/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 8¢ | 25 (15 yours) | ×0.1^0 = 25.0 |
|  | 5¢ | 41 | ×0.1^3 = 0.0 |
|  | 4¢ | 30 | ×0.1^4 = 0.0 |
|  | 3¢ | 100 | ×0.1^5 = 0.0 |
|  | 2¢ | 5 | ×0.1^6 = 0.0 |
...
`yours 15.0 / Σ 25.0 = 59.9%`  
`$25 ÷ 1 ÷ 2 = $12.50 × 59.9% = $7.49/day`  

</details>
<details><summary><code>dccc-measles-us-2026-12-31-gt3000</code> BUY 10 @ 77¢ → $2.38/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte225</code> BUY 30 @ 10¢ → $2.08/day</summary>
...
<details><summary><code>apdc-jerpowgov-2026-12-31</code> BUY 20 @ 24¢ → $10.85/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 24¢ | 46 (20 yours) | ×0.2^0 = 46.1 |
|  | 2¢ | 100 | ×0.2^22 = 0.0 |
|  | 1¢ | 5,200 | ×0.2^23 = 0.0 |
| | | **Σ** | **46.1** |

`yours 20.0 / Σ 46.1 = 43.4%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 43.4% = $10.85/day`  
...
<details><summary><code>lawec-cryptoleg-2026-12-31</code> BUY 21 @ 20¢ → $2.55/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 20¢ | 52 (21 yours) | ×0.1^0 = 51.5 |
|  | 15¢ | 121 | ×0.1^5 = 0.0 |
|  | 7¢ | 875 | ×0.1^13 = 0.0 |
|  | 6¢ | 1,125 | ×0.1^14 = 0.0 |
| | | **Σ** | **51.5** |

`yours 21.0 / Σ 51.5 = 40.8%`  
...
<details><summary><code>opdc-mcconnell-resign-2026-11-02</code> BUY 10 @ 8¢ → $4.99/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 8¢ | 25 (10 yours) | ×0.1^0 = 25.0 |
|  | 5¢ | 41 | ×0.1^3 = 0.0 |
|  | 4¢ | 30 | ×0.1^4 = 0.0 |
|  | 3¢ | 100 | ×0.1^5 = 0.0 |
|  | 2¢ | 5 | ×0.1^6 = 0.0 |
...
<details><summary><code>apdc-alito-2026-12-31</code> SELL 126 @ 19¢ → $9.24/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 19¢ | 341 (126 yours) | ×0.2^0 = 341.0 |
|  | 25¢ | 579 | ×0.2^6 = 0.0 |
|  | 40¢ | 100 | ×0.2^21 = 0.0 |
|  | 99¢ | 4,580 | ×0.2^80 = 0.0 |
| | | **Σ** | **341.0** |

`yours 126.0 / Σ 341.0 = 36.9%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 36.9% = $9.24/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (47,212 resting) | ~92.9% | ~$23.22 |
| `ewc-usse-tx-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (254,349 resting) | ~17.2% | ~$12.88 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (76,902 resting) | ~42.3% | ~$10.57 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (42,862 resting) | ~29.5% | ~$7.38 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,604 resting) | ~25.5% | ~$6.37 |
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (101,785 resting) | ~6.8% | ~$5.13 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (189,793 resting) | ~4.1% | ~$3.04 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (68,528 resting) | ~3.6% | ~$2.70 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (87,998 resting) | ~3.3% | ~$2.48 |
| `ewc-usse-me-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (190,298 resting) | ~2.7% | ~$2.01 |
| `ewc-usse-tx-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (287,490 resting) | ~2.3% | ~$1.74 |
| `enwc-usgubp-fl-2026-08-18-rep-byrdon` | $100.00 ÷ 3 | 0.20 | 5,000 | BUY side (223,748 resting) | ~8.7% | ~$1.45 |
