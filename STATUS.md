...
## ✅ Last successful check: 2026-08-15 5:03 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$1,074.74/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-nv-2026-11-03-rep` — SELL at the best price, ~$3.10/day for 200 contracts. Runners-up: `ewc-usse-nh-2026-11-03-rep` (~$1.88/day), `ewc-usmayor-losang-2026-11-03-nitram` (~$1.80/day)
...
### Estimated earning rate: ~$1,074.74/day (~$44.78/hour)
...
| `enwc-uspres-nom-dem-2028-jamtal` | SELL | 15.0¢ | 15 | 0 | $1,000.00 | ✅ scoring — ~100.0% of ask side (54,984 resting ≥ 20,000 ✓) ≈ $29.41/day (pool ÷ 17 markets) |
...
| `ussewc-usse-al-2026-11-03-dem` | SELL | 12.0¢ | 20 | 0 | $25.00 | ✅ scoring — ~87.0% of ask side (203,573 resting ≥ 2,000 ✓) ≈ $5.43/day (pool ÷ 2 markets) |
...
<details><summary><code>ussewc-usse-al-2026-11-03-dem</code> SELL 20 @ 12¢ → $5.43/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 12¢ | 23 (20 yours) | ×0.1^0 = 23.0 |
...
| `ewc-usmayor-losang-2026-11-03-karbas` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (204,657 resting) | ~25.2% | ~$1.58 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (640,037 resting) | ~4.8% | ~$1.20 |
| `enwc-usgubp-fl-2026-08-18-rep-byrdon` | $300.00 ÷ 3 | 0.20 | 10,000 | SELL side (46,070 resting) | ~2.0% | ~$1.00 |
| `ewc-usgub-mi-2026-11-03-dem` | $25.00 ÷ 3 | 0.10 | 2,000 | SELL side (65,194 resting) | ~21.3% | ~$0.89 |
| `ewc-usse-mi-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (637,209 resting) | ~14.1% | ~$0.88 |
| `ewc-usse-mi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (622,242 resting) | ~14.1% | ~$0.88 |
...
| `ewc-usse-ia-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (71,962 resting) | ~11.2% | ~$0.70 |
