...
## ✅ Last successful check: 2026-08-11 7:20 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$149.74/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-ca-2026-11-03-xavbec` — BUY at the best price, ~$36.12/day for 200 contracts. Runners-up: `enwc-ussep-mn-2026-08-11-dem-angcra` (~$20.48/day), `enwc-ussep-mn-2026-08-11-dem-pegfla` (~$17.99/day)
...
### Estimated earning rate: ~$149.74/day (~$6.24/hour)
...
| `ussewc-usse-ky-2026-11-03-dem` | SELL | 6.0¢ | 50 | 0 | $25.00 | ✅ scoring — ~83.3% of ask side (67,232 resting ≥ 2,000 ✓) ≈ $5.21/day (pool ÷ 2 markets) |
...
| `ussewc-usse-or-2026-11-03-rep` | SELL | 5.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~74.0% of ask side (132,166 resting ≥ 2,000 ✓) ≈ $4.63/day (pool ÷ 2 markets) |
| `usgubewc-usgub-tn-2026-11-03-rep` | BUY | 96.0¢ | 60 | 0 | $25.00 | ✅ scoring — ~58.9% of bid side (2,445 resting ≥ 2,000 ✓) ≈ $3.68/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-or-2026-11-03-rep` | SELL | 12.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~50.0% of ask side (76,934 resting ≥ 2,000 ✓) ≈ $3.12/day (pool ÷ 2 markets) |
| `usgubewc-usgub-nh-2026-11-03-rep` | BUY | 78.0¢ | 40 | 1 | $25.00 | ✅ scoring — ~50.0% of bid side (12,254 resting ≥ 2,000 ✓) ≈ $3.12/day (pool ÷ 2 markets) |
| `scc-hrep-rep-2026-11-03-gte210` | SELL | 29.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~47.6% of ask side (69,074 resting ≥ 5,000 ✓) ≈ $1.98/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-51` | SELL | 25.0¢ | 5 | 0 | $100.00 | ✅ scoring — ~45.0% of ask side (78,752 resting ≥ 5,000 ✓) ≈ $1.73/day (pool ÷ 13 markets) |
...
| `usgubewc-usgub-ok-2026-11-03-dem` | SELL | 7.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~39.2% of ask side (142,191 resting ≥ 2,000 ✓) ≈ $2.45/day (pool ÷ 2 markets) |
...
| `ussewc-usse-ky-2026-11-03-rep` | BUY | 90.0¢ | 80 | 0 | $25.00 | ✅ scoring — ~30.8% of bid side (512,460 resting ≥ 2,000 ✓) ≈ $1.92/day (pool ÷ 2 markets) |
...
| `ussewc-usse-de-2026-11-03-dem` | BUY | 95.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~26.7% of bid side (502,431 resting ≥ 2,000 ✓) ≈ $1.67/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-id-2026-11-03-rep` | BUY | 95.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~26.2% of bid side (502,443 resting ≥ 2,000 ✓) ≈ $1.63/day (pool ÷ 2 markets) |
...
<details><summary><code>usgubewc-usgub-tn-2026-11-03-rep</code> BUY 60 @ 96¢ → $3.68/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 96¢ | 86 (60 yours) | ×0.1^0 = 86.0 |
|  | 95¢ | 159 | ×0.1^1 = 15.9 |
|  | 1¢ | 2,200 | ×0.1^95 = 0.0 |
| | | **Σ** | **101.9** |

`yours 60.0 / Σ 101.9 = 58.9%`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte210</code> SELL 10 @ 29¢ → $1.98/day</summary>
...
<details><summary><code>scc-senate-gop-2026-11-03-51</code> SELL 5 @ 25¢ → $1.73/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 25¢ | 5 (5 yours) | ×0.2^0 = 5.0 |
|  | 27¢ | 100 | ×0.2^2 = 4.0 |
|  | 28¢ | 265 | ×0.2^3 = 2.1 |
|  | 50¢ | 100 | ×0.2^25 = 0.0 |
...
<details><summary><code>usgubewc-usgub-ok-2026-11-03-dem</code> SELL 40 @ 7¢ → $2.45/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 7¢ | 102 (40 yours) | ×0.1^0 = 102.0 |
...
<details><summary><code>ussewc-usse-de-2026-11-03-dem</code> BUY 40 @ 95¢ → $1.67/day</summary>
...
<details><summary><code>usgubewc-usgub-id-2026-11-03-rep</code> BUY 40 @ 95¢ → $1.63/day</summary>
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (1,051,594 resting) | ~48.2% | ~$36.12 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (300,823 resting) | ~81.9% | ~$20.48 |
...
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (313,049 resting) | ~9.9% | ~$7.45 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (52,773 resting) | ~9.8% | ~$7.34 |
| `ewc-usse-tx-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (850,278 resting) | ~9.6% | ~$7.17 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (5,876 resting) | ~21.0% | ~$5.26 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (59,579 resting) | ~6.0% | ~$4.53 |
| `paccc-usho-midterms-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (885,341 resting) | ~5.9% | ~$4.41 |
| `paccc-usse-midterms-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (1,006,793 resting) | ~5.8% | ~$4.36 |
