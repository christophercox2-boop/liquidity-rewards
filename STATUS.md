...
## ✅ Last successful check: 2026-08-01 5:25 AM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$42.09/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-oh-2026-11-03-dem` — BUY at the best price, ~$16.95/day for 200 contracts. Runners-up: `enwc-ussep-mn-2026-08-11-dem-angcra` (~$8.78/day), `enwc-ussep-mn-2026-08-11-dem-pegfla` (~$8.32/day)
...
### Estimated earning rate: ~$42.09/day (~$1.75/hour)
...
| `scc-senate-gop-2026-11-03-50` | SELL | 34.0¢ | 43 | 0 | $100.00 | ✅ scoring — ~58.7% of ask side (12,191 resting ≥ 5,000 ✓) ≈ $2.26/day (pool ÷ 13 markets) |
...
| `scc-hrep-rep-2026-11-03-gte235` | SELL | 7.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~55.6% of ask side (9,043 resting ≥ 5,000 ✓) ≈ $2.31/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte195` | SELL | 80.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~50.0% of ask side (5,294 resting ≥ 5,000 ✓) ≈ $2.08/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-46` | SELL | 10.0¢ | 46 | 0 | $100.00 | ✅ scoring — ~49.7% of ask side (12,004 resting ≥ 5,000 ✓) ≈ $1.91/day (pool ÷ 13 markets) |
...
| `scc-hrep-rep-2026-11-03-gte225` | BUY | 1.0¢ | 5,000 | 1 | $100.00 | ✅ scoring — ~43.7% of bid side (6,450 resting ≥ 5,000 ✓) ≈ $1.82/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-53` | SELL | 10.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~35.7% of ask side (12,294 resting ≥ 5,000 ✓) ≈ $1.37/day (pool ÷ 13 markets) |
...
| `ewc-pres-arg-2027-10-24-javmil` | BUY | 62.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~20.8% of bid side (2,504 resting ≥ 2,000 ✓) ≈ $0.24/day (pool ÷ 11 markets) |
| `scc-senate-gop-2026-11-03-gte57` | BUY | 9.0¢ | 93 | 0 | $100.00 | ✅ scoring — ~17.5% of bid side (5,848 resting ≥ 5,000 ✓) ≈ $0.67/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte205` | SELL | 62.0¢ | 30 | 0 | $100.00 | ✅ scoring — ~14.5% of ask side (7,510 resting ≥ 5,000 ✓) ≈ $0.60/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-56` | SELL | 6.0¢ | 50 | 1 | $100.00 | ✅ scoring — ~13.1% of ask side (11,982 resting ≥ 5,000 ✓) ≈ $0.50/day (pool ÷ 13 markets) |
| `apdc-alito-2026-12-31` | BUY | 17.0¢ | 100 | 0 | $100.00 | ✅ scoring — ~12.7% of bid side (7,067 resting ≥ 5,000 ✓) ≈ $2.12/day (pool ÷ 3 markets) |
| `scc-senate-gop-2026-11-03-55` | BUY | 1.0¢ | 5,000 | 0 | $100.00 | ✅ scoring — ~11.6% of bid side (42,922 resting ≥ 5,000 ✓) ≈ $0.45/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte180` | SELL | 96.0¢ | 100 | 0 | $100.00 | ✅ scoring — ~10.6% of ask side (45,501 resting ≥ 5,000 ✓) ≈ $0.44/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte215` | BUY | 17.0¢ | 50 | 1 | $100.00 | ✅ scoring — ~6.0% of bid side (5,578 resting ≥ 5,000 ✓) ≈ $0.25/day (pool ÷ 12 markets) |
| `scc-hrep-rep-2026-11-03-gte230` | SELL | 7.0¢ | 30 | 1 | $100.00 | ✅ scoring — ~5.6% of ask side (14,861 resting ≥ 5,000 ✓) ≈ $0.23/day (pool ÷ 12 markets) |
...
<details><summary><code>scc-senate-gop-2026-11-03-50</code> SELL 43 @ 34¢ → $2.26/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 34¢ | 73 (43 yours) | ×0.2^0 = 73.0 |
|  | 38¢ | 128 | ×0.2^4 = 0.2 |
|  | 50¢ | 100 | ×0.2^16 = 0.0 |
|  | 51¢ | 37 | ×0.2^17 = 0.0 |
|  | 98¢ | 1,852 | ×0.2^64 = 0.0 |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte195</code> SELL 50 @ 80¢ → $2.08/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 80¢ | 100 (50 yours) | ×0.2^0 = 100.0 |
|  | 86¢ | 14 | ×0.2^6 = 0.0 |
|  | 98¢ | 127 | ×0.2^18 = 0.0 |
|  | 99¢ | 5,053 | ×0.2^19 = 0.0 |
| | | **Σ** | **100.0** |
...
<details><summary><code>scc-senate-gop-2026-11-03-46</code> SELL 46 @ 10¢ → $1.91/day</summary>
...
`yours 46.0 / Σ 92.6 = 49.7%`  
`$100 ÷ 13 ÷ 2 = $3.85 × 49.7% = $1.91/day`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte225</code> BUY 5,000 @ 1¢ → $1.82/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 2¢ | 1,250 | ×0.2^0 = 1,250.0 |
| ▶ | 1¢ | 5,200 (5,000 yours) | ×0.2^1 = 1,040.0 |
| | | **Σ** | **2,290.0** |

`yours 1,000.0 / Σ 2,290.0 = 43.7%`  
`$100 ÷ 12 ÷ 2 = $4.17 × 43.7% = $1.82/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-53</code> SELL 50 @ 10¢ → $1.37/day</summary>
...
<details><summary><code>ewc-pres-arg-2027-10-24-javmil</code> BUY 1 @ 62¢ → $0.24/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 62¢ | 6 (1 yours) | ×0.1^0 = 6.3 |
|  | 59¢ | 1 | ×0.1^3 = 0.0 |
|  | 56¢ | 4 | ×0.1^6 = 0.0 |
|  | 1¢ | 2,493 | ×0.1^61 = 0.0 |
| | | **Σ** | **6.3** |

`yours 1.3 / Σ 6.3 = 20.8%`  
`$25 ÷ 11 ÷ 2 = $1.14 × 20.8% = $0.24/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-gte57</code> BUY 93 @ 9¢ → $0.67/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 9¢ | 526 (93 yours) | ×0.2^0 = 525.8 |
|  | 7¢ | 93 | ×0.2^2 = 3.7 |
|  | 1¢ | 5,229 | ×0.2^8 = 0.0 |
| | | **Σ** | **529.5** |

`yours 92.8 / Σ 529.5 = 17.5%`  
...
<details><summary><code>apdc-alito-2026-12-31</code> BUY 100 @ 17¢ → $2.12/day</summary>
...
`yours 100.0 / Σ 787.2 = 12.7%`  
`$100 ÷ 3 ÷ 2 = $16.67 × 12.7% = $2.12/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-55</code> BUY 5,000 @ 1¢ → $0.45/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 42,922 (5,000 yours) | ×0.2^0 = 42,922.0 |
| | | **Σ** | **42,922.0** |

`yours 5,000.0 / Σ 42,922.0 = 11.6%`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte180</code> SELL 100 @ 96¢ → $0.44/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 96¢ | 542 (100 yours) | ×0.2^0 = 542.0 |
|  | 97¢ | 199 | ×0.2^1 = 39.8 |
|  | 99¢ | 44,760 | ×0.2^3 = 358.1 |
| | | **Σ** | **939.9** |

`yours 100.0 / Σ 939.9 = 10.6%`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte215</code> BUY 50 @ 17¢ → $0.25/day</summary>
...
`yours 10.0 / Σ 166.0 = 6.0%`  
`$100 ÷ 12 ÷ 2 = $4.17 × 6.0% = $0.25/day`  
...
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (64,600 resting) | ~35.1% | ~$8.78 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (6,394 resting) | ~33.3% | ~$8.32 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 3 | 0.20 | 5,000 | SELL side (8,749 resting) | ~47.8% | ~$7.96 |
| `apdc-jerpowgov-2026-12-31` | $100.00 ÷ 3 | 0.20 | 5,000 | SELL side (8,712 resting) | ~47.8% | ~$7.96 |
| `enwc-ussep-mi-2026-08-04-dem-halste` | $300.00 ÷ 3 | 0.20 | 10,000 | BUY side (31,046 resting) | ~10.5% | ~$5.25 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (74,092 resting) | ~6.2% | ~$4.62 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (148,474 resting) | ~5.1% | ~$3.81 |
| `ewc-usse-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (94,949 resting) | ~4.8% | ~$3.61 |
| `ewc-usse-tx-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (385,743 resting) | ~3.1% | ~$2.32 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (80,382 resting) | ~2.1% | ~$1.59 |
