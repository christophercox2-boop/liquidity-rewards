...
## ✅ Last successful check: 2026-08-18 6:26 PM ET
...
**Earning right now:** ~$188.67/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-usgubp-ok-2026-06-16-rep-gendru` — BUY at the best price, ~$20.83/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$19.04/day), `ewc-usgub-ga-2026-11-03-dem` (~$10.67/day)
...
### Estimated earning rate: ~$188.67/day (~$7.86/hour)
...
| `usgubewc-usgub-ma-2026-11-03-dem` | BUY | 94.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~98.4% of bid side (2,750 resting ≥ 2,000 ✓) ≈ $6.15/day (event pool ÷ 2 markets) |
...
| `enwc-uspres-nom-dem-2028-jonoss` | BUY | 27.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~78.1% of bid side (74,161 resting ≥ 20,000 ✓) ≈ $4.60/day (event pool ÷ 17 markets) |
...
| `usgubewc-usgub-ne-2026-11-03-rep` | SELL | 95.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~44.4% of ask side (2,501 resting ≥ 2,000 ✓) ≈ $2.78/day (event pool ÷ 2 markets) |
| `apdc-alito-2026-12-31` | BUY | 9.0¢ | 1,000 | 0 | $100.00 | ✅ scoring — ~39.9% of bid side (31,203 resting ≥ 5,000 ✓) ≈ $9.97/day (event pool ÷ 2 markets) |
| `ussewc-usse-tn-2026-11-03-rep` | BUY | 95.0¢ | 35 | 0 | $25.00 | ✅ scoring — ~38.9% of bid side (500,491 resting ≥ 2,000 ✓) ≈ $2.43/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-wy-2026-11-03-dem` | SELL | 5.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~36.4% of ask side (2,056 resting ≥ 2,000 ✓) ≈ $2.27/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-ne-2026-11-03-rep` | BUY | 91.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~31.9% of bid side (500,664 resting ≥ 2,000 ✓) ≈ $2.00/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-ne-2026-11-03-rep` | BUY | 91.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~31.9% of bid side (500,664 resting ≥ 2,000 ✓) ≈ $2.00/day (event pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-51` | BUY | 14.0¢ | 7 | 0 | $100.00 | ✅ scoring — ~31.8% of bid side (305,672 resting ≥ 5,000 ✓) ≈ $1.22/day (event pool ÷ 13 markets) |
| `ussewc-usse-tn-2026-11-03-dem` | SELL | 5.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~30.8% of ask side (527,392 resting ≥ 2,000 ✓) ≈ $1.92/day (event pool ÷ 2 markets) |
| `enwc-uspres-nom-rep-2028-jdvan` | BUY | 50.0¢ | 70 | 1 | $200.00 | ✅ scoring — ~29.1% of bid side (73,514 resting ≥ 20,000 ✓) ≈ $2.08/day (event pool ÷ 14 markets) |
| `enwc-uspres-nom-dem-2028-petbut` | BUY | 11.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~28.7% of bid side (107,788 resting ≥ 20,000 ✓) ≈ $1.69/day (event pool ÷ 17 markets) |
| `enwc-uspres-nom-dem-2028-petbut` | BUY | 10.0¢ | 5 | 1 | $200.00 | ✅ scoring — ~28.7% of bid side (107,788 resting ≥ 20,000 ✓) ≈ $1.69/day (event pool ÷ 17 markets) |
| `usgubewc-usgub-il-2026-11-03-rep` | SELL | 7.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~28.4% of ask side (208,353 resting ≥ 2,000 ✓) ≈ $1.78/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-ar-2026-11-03-dem` | SELL | 6.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~28.1% of ask side (130,788 resting ≥ 2,000 ✓) ≈ $1.76/day (event pool ÷ 2 markets) |
| `ewc-usp-2028-11-07-jonoss` | BUY | 15.0¢ | 100 | 2 | $200.00 | ✅ scoring — ~26.0% of bid side (54,435 resting ≥ 20,000 ✓) ≈ $0.96/day (event pool ÷ 27 markets) |
| `usgubewc-usgub-hi-2026-11-03-rep` | SELL | 5.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~24.4% of ask side (208,415 resting ≥ 2,000 ✓) ≈ $1.53/day (event pool ÷ 2 markets) |
| …and 1426 more | | | | | | |
...
<details><summary><code>usgubewc-usgub-ne-2026-11-03-rep</code> SELL 1 @ 95¢ → $2.78/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 95¢ | 2 (1 yours) | ×0.1^0 = 2.0 |
|  | 99¢ | 2,499 | ×0.1^4 = 0.2 |
| | | **Σ** | **2.2** |
...
<details><summary><code>usgubewc-usgub-wy-2026-11-03-dem</code> SELL 2 @ 5¢ → $2.27/day</summary>
...
<details><summary><code>scc-senate-gop-2026-11-03-51</code> BUY 7 @ 14¢ → $1.22/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 14¢ | 22 (7 yours) | ×0.2^0 = 22.0 |
|  | 2¢ | 5,276 | ×0.2^12 = 0.0 |
| | | **Σ** | **22.0** |

`yours 7.0 / Σ 22.0 = 31.8%`  
...
<details><summary><code>ussewc-usse-tn-2026-11-03-dem</code> SELL 2 @ 5¢ → $1.92/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 5¢ | 6 (2 yours) | ×0.1^0 = 6.0 |
|  | 7¢ | 50 | ×0.1^2 = 0.5 |
...
<details><summary><code>enwc-uspres-nom-rep-2028-jdvan</code> BUY 70 @ 50¢ → $2.08/day</summary>
...
`yours 14.0 / Σ 48.2 = 29.1%`  
`$200 ÷ 14 ÷ 2 = $7.14 × 29.1% = $2.08/day`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-petbut</code> BUY 1 @ 11¢ → $1.69/day</summary>
...
`yours 1.0 / Σ 3.5 = 28.7%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 28.7% = $1.69/day`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-petbut</code> BUY 5 @ 10¢ → $1.69/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 11¢ | 1 | ×0.2^0 = 1.0 |
| ▶ | 10¢ | 5 (5 yours) | ×0.2^1 = 1.0 |
|  | 8¢ | 6 | ×0.2^3 = 0.0 |
|  | 7¢ | 30 | ×0.2^4 = 0.0 |
|  | 6¢ | 125 | ×0.2^5 = 0.0 |
|  | 5¢ | 21,000 | ×0.2^6 = 1.3 |
...
<details><summary><code>usgubewc-usgub-il-2026-11-03-rep</code> SELL 1 @ 7¢ → $1.78/day</summary>
...
`yours 1.0 / Σ 3.5 = 28.4%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 28.4% = $1.78/day`  
...
<details><summary><code>usgubewc-usgub-ar-2026-11-03-dem</code> SELL 1 @ 6¢ → $1.76/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-jonoss</code> BUY 100 @ 15¢ → $0.96/day</summary>
...
<details><summary><code>usgubewc-usgub-hi-2026-11-03-rep</code> SELL 2 @ 5¢ → $1.53/day</summary>
...
`yours 2.0 / Σ 8.2 = 24.4%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 24.4% = $1.53/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (26,427 resting) | ~83.3% | ~$20.83 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (28,778 resting) | ~76.1% | ~$19.04 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (79,897 resting) | ~14.2% | ~$10.67 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (74,731 resting) | ~45.3% | ~$2.83 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (284,448 resting) | ~3.6% | ~$2.71 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (632,128 resting) | ~7.0% | ~$1.74 |
| `ewc-usse-nc-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (66,824 resting) | ~6.4% | ~$1.60 |
| `ewc-usgub-wi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (1,246,754 resting) | ~23.2% | ~$1.45 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (280,868 resting) | ~1.9% | ~$1.43 |
