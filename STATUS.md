...
## ✅ Last successful check: 2026-08-12 6:45 AM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$172.09/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-ga-2026-11-03-dem` — SELL at the best price, ~$16.36/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$14.81/day), `ewc-usgub-ca-2026-11-03-stehil` (~$13.97/day)
...
### Estimated earning rate: ~$172.09/day (~$7.17/hour)
...
| `ussewc-usse-sc-2026-11-03-dem` | SELL | 10.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~72.6% of ask side (205,643 resting ≥ 2,000 ✓) ≈ $4.54/day (pool ÷ 2 markets) |
...
| `apdc-jerpowgov-2026-12-31` | SELL | 23.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~65.4% of ask side (19,306 resting ≥ 5,000 ✓) ≈ $16.35/day (pool ÷ 2 markets) |
...
| `ussewc-usse-or-2026-11-03-rep` | BUY | 1.0¢ | 1,290 | 0 | $25.00 | ✅ scoring — ~44.5% of bid side (2,900 resting ≥ 2,000 ✓) ≈ $2.78/day (pool ÷ 2 markets) |
| `apdc-alito-2026-12-31` | BUY | 11.0¢ | 40 | 0 | $100.00 | ✅ scoring — ~42.5% of bid side (21,614 resting ≥ 5,000 ✓) ≈ $10.63/day (pool ÷ 2 markets) |
...
| `ussewc-usse-wy-2026-11-03-dem` | BUY | 1.0¢ | 2,000 | 0 | $25.00 | ✅ scoring — ~31.0% of bid side (6,445 resting ≥ 2,000 ✓) ≈ $1.94/day (pool ÷ 2 markets) |
...
| `opdc-mcconnell-resign-2026-11-02` | SELL | 16.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~26.5% of ask side (10,335 resting ≥ 2,000 ✓) ≈ $3.31/day |
...
<details><summary><code>ussewc-usse-sc-2026-11-03-dem</code> SELL 40 @ 10¢ → $4.54/day</summary>
...
<details><summary><code>apdc-jerpowgov-2026-12-31</code> SELL 10 @ 23¢ → $16.35/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 23¢ | 15 (10 yours) | ×0.2^0 = 15.0 |
|  | 25¢ | 7 | ×0.2^2 = 0.3 |
|  | 28¢ | 1 | ×0.2^5 = 0.0 |
|  | 29¢ | 134 | ×0.2^6 = 0.0 |
|  | 32¢ | 23 | ×0.2^9 = 0.0 |
...
`yours 10.0 / Σ 15.3 = 65.4%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 65.4% = $16.35/day`  
...
<details><summary><code>ussewc-usse-or-2026-11-03-rep</code> BUY 1,290 @ 1¢ → $2.78/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 2,900 (1,290 yours) | ×0.1^0 = 2,900.0 |
| | | **Σ** | **2,900.0** |

`yours 1,290.0 / Σ 2,900.0 = 44.5%`  
...
<details><summary><code>apdc-alito-2026-12-31</code> BUY 40 @ 11¢ → $10.63/day</summary>
...
<details><summary><code>ussewc-usse-wy-2026-11-03-dem</code> BUY 2,000 @ 1¢ → $1.94/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 6,445 (2,000 yours) | ×0.1^0 = 6,445.0 |
| | | **Σ** | **6,445.0** |

`yours 2,000.0 / Σ 6,445.0 = 31.0%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 31.0% = $1.94/day`  
...
<details><summary><code>opdc-mcconnell-resign-2026-11-02</code> SELL 40 @ 16¢ → $3.31/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 16¢ | 132 (40 yours) | ×0.1^0 = 132.0 |
|  | 17¢ | 156 | ×0.1^1 = 15.6 |
|  | 18¢ | 348 | ×0.1^2 = 3.5 |
|  | 33¢ | 300 | ×0.1^17 = 0.0 |
|  | 35¢ | 151 | ×0.1^19 = 0.0 |
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (77,555 resting) | ~21.8% | ~$16.36 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (37,503 resting) | ~59.3% | ~$14.81 |
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (369,237 resting) | ~18.6% | ~$13.97 |
...
| `ewc-usse-tx-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (649,624 resting) | ~6.9% | ~$5.21 |
| `ewc-usse-tx-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (862,948 resting) | ~6.0% | ~$4.54 |
| `ewc-usse-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (91,431 resting) | ~3.9% | ~$2.91 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (135,394 resting) | ~10.6% | ~$2.66 |
