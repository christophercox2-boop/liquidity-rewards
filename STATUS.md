...
## ✅ Last successful check: 2026-08-15 6:19 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$1,020.62/day estimated (ceiling, not promise — details below)
...
**What else to join:** `apdc-jerpowgov-2026-08-31` — SELL at the best price, ~$3.57/day for 200 contracts. Runners-up: `ewc-usgub-nv-2026-11-03-rep` (~$3.09/day), `ewc-usmayor-losang-2026-11-03-nitram` (~$1.80/day)
...
### Estimated earning rate: ~$1,020.62/day (~$42.53/hour)
...
| `enwc-uspres-nom-dem-2028-rokha` | BUY | 10.0¢ | 2 | 0 | $1,000.00 | ✅ scoring — ~87.9% of bid side (110,554 resting ≥ 20,000 ✓) ≈ $25.84/day (pool ÷ 17 markets) |
...
| `usgubewc-usgub-id-2026-11-03-rep` | SELL | 96.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~86.7% of ask side (5,206 resting ≥ 2,000 ✓) ≈ $5.42/day (pool ÷ 2 markets) |
| `ussewc-usse-tn-2026-11-03-dem` | SELL | 9.0¢ | 50 | 0 | $25.00 | ✅ scoring — ~86.2% of ask side (527,494 resting ≥ 2,000 ✓) ≈ $5.39/day (pool ÷ 2 markets) |
| `usgubewc-usgub-il-2026-11-03-rep` | SELL | 9.0¢ | 75 | 0 | $25.00 | ✅ scoring — ~85.2% of ask side (208,476 resting ≥ 2,000 ✓) ≈ $5.33/day (pool ÷ 2 markets) |
| `scc-hrep-rep-2026-11-03-gte205` | SELL | 56.0¢ | 25 | 0 | $100.00 | ✅ scoring — ~84.0% of ask side (82,415 resting ≥ 5,000 ✓) ≈ $3.50/day (pool ÷ 12 markets) |
| `usgubewc-usgub-ar-2026-11-03-dem` | SELL | 10.0¢ | 25 | 0 | $25.00 | ✅ scoring — ~83.3% of ask side (130,755 resting ≥ 2,000 ✓) ≈ $5.21/day (pool ÷ 2 markets) |
| `ussewc-usse-al-2026-11-03-dem` | SELL | 12.0¢ | 20 | 0 | $25.00 | ✅ scoring — ~83.3% of ask side (203,674 resting ≥ 2,000 ✓) ≈ $5.21/day (pool ÷ 2 markets) |
| `enwc-uspres-nom-dem-2028-stasmi` | BUY | 10.0¢ | 2 | 0 | $1,000.00 | ✅ scoring — ~80.8% of bid side (110,481 resting ≥ 20,000 ✓) ≈ $23.76/day (pool ÷ 17 markets) |
...
| `usgubewc-usgub-vt-2026-11-03-dem` | SELL | 15.0¢ | 5 | 0 | $25.00 | ✅ scoring — ~71.4% of ask side (330,179 resting ≥ 2,000 ✓) ≈ $4.46/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-53` | BUY | 7.0¢ | 25 | 0 | $100.00 | ✅ scoring — ~68.9% of bid side (90,564 resting ≥ 5,000 ✓) ≈ $2.65/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte210` | BUY | 36.0¢ | 1 | 2 | $100.00 | ✅ scoring — ~66.7% of bid side (400,451 resting ≥ 5,000 ✓) ≈ $2.78/day (pool ÷ 12 markets) |
| …and 2551 more | | | | | | |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte205</code> SELL 25 @ 56¢ → $3.50/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 56¢ | 25 (25 yours) | ×0.2^0 = 25.0 |
|  | 58¢ | 119 | ×0.2^2 = 4.8 |
|  | 63¢ | 0 | ×0.2^7 = 0.0 |
|  | 98¢ | 80,046 | ×0.2^42 = 0.0 |
| | | **Σ** | **29.8** |

`yours 25.0 / Σ 29.8 = 84.0%`  
...
<details><summary><code>usgubewc-usgub-ar-2026-11-03-dem</code> SELL 25 @ 10¢ → $5.21/day</summary>
...
<details><summary><code>enwc-uspres-nom-dem-2028-stasmi</code> BUY 2 @ 10¢ → $23.76/day</summary>
...
`yours 2.2 / Σ 2.7 = 80.8%`  
`$1,000 ÷ 17 ÷ 2 = $29.41 × 80.8% = $23.76/day`  
...
<details><summary><code>usgubewc-usgub-vt-2026-11-03-dem</code> SELL 5 @ 15¢ → $4.46/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 15¢ | 7 (5 yours) | ×0.1^0 = 7.0 |
...
<details><summary><code>scc-senate-gop-2026-11-03-53</code> BUY 25 @ 7¢ → $2.65/day</summary>
...
`yours 25.0 / Σ 36.3 = 68.9%`  
`$100 ÷ 13 ÷ 2 = $3.85 × 68.9% = $2.65/day`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte210</code> BUY 1 @ 36¢ → $2.78/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 38¢ | 0 | ×0.2^0 = 0.0 |
| ▶ | 36¢ | 1 (1 yours) | ×0.2^2 = 0.0 |
|  | 2¢ | 400,250 | ×0.2^36 = 0.0 |
| | | **Σ** | **0.1** |

`yours 0.0 / Σ 0.1 = 66.7%`  
...
|---|---:|---:|---:|---|---:|---:|
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (5,520 resting) | ~14.3% | ~$3.57 |
| `ewc-usgub-nv-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (84,268 resting) | ~49.5% | ~$3.09 |
| `ewc-usmayor-losang-2026-11-03-nitram` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (204,974 resting) | ~28.8% | ~$1.80 |
| `ewc-usmayor-losang-2026-11-03-karbas` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (205,111 resting) | ~27.3% | ~$1.71 |
| `ewc-usse-nh-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (62,263 resting) | ~26.6% | ~$1.66 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (639,883 resting) | ~4.8% | ~$1.20 |
| `ewc-usgub-mi-2026-11-03-dem` | $25.00 ÷ 3 | 0.10 | 2,000 | SELL side (73,566 resting) | ~21.1% | ~$0.88 |
...
| `ewc-usse-mi-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (630,773 resting) | ~13.6% | ~$0.85 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (95,761 resting) | ~11.7% | ~$0.73 |
| `ewc-usse-nh-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (82,750 resting) | ~10.5% | ~$0.65 |
