...
## ✅ Last successful check: 2026-08-09 3:20 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$137.00/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-ca-2026-11-03-stehil` — SELL at the best price, ~$36.32/day for 200 contracts. Runners-up: `ewc-usgub-ca-2026-11-03-xavbec` (~$30.88/day), `apdc-jerpowgov-2026-08-31` (~$15.97/day)
...
### Estimated earning rate: ~$137.00/day (~$5.71/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `apdc-jerpowgov-2026-12-31` | BUY | 27.0¢ | 20 | 0 | $100.00 | ✅ scoring — ~98.5% of bid side (5,357 resting ≥ 5,000 ✓) ≈ $24.63/day (pool ÷ 2 markets) |
...
| `apdc-jerpowgov-2026-12-31` | SELL | 35.0¢ | 15 | 0 | $100.00 | ✅ scoring — ~89.5% of ask side (5,809 resting ≥ 5,000 ✓) ≈ $22.37/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-53` | BUY | 13.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~86.7% of bid side (10,712 resting ≥ 5,000 ✓) ≈ $3.33/day (pool ÷ 13 markets) |
| `tec-cbb-champ-2027-04-05-w-uconn` | BUY | 14.0¢ | 2 | 0 | $500.00 | ✅ scoring — ~78.9% of bid side (7,972 resting ≥ 2,500 ✓) ≈ $2.70/day (pool ÷ 73 markets) |
| `scc-hrep-rep-2026-11-03-gte180` | BUY | 78.0¢ | 5 | 0 | $100.00 | ✅ scoring — ~71.4% of bid side (50,457 resting ≥ 5,000 ✓) ≈ $2.98/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte195` | BUY | 49.0¢ | 115 | 1 | $100.00 | ✅ scoring — ~60.4% of bid side (80,710 resting ≥ 5,000 ✓) ≈ $2.52/day (pool ÷ 12 markets) |
...
| `opdc-mcconnell-resign-2026-11-02` | BUY | 14.0¢ | 30 | 0 | $25.00 | ✅ scoring — ~49.2% of bid side (35,789 resting ≥ 2,000 ✓) ≈ $6.15/day |
| `scc-hrep-rep-2026-11-03-gte210` | BUY | 44.0¢ | 11 | 0 | $100.00 | ✅ scoring — ~45.8% of bid side (80,474 resting ≥ 5,000 ✓) ≈ $1.91/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-49` | BUY | 19.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~43.5% of bid side (50,613 resting ≥ 5,000 ✓) ≈ $1.67/day (pool ÷ 13 markets) |
...
| `scc-hrep-rep-2026-11-03-gte225` | SELL | 12.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~30.2% of ask side (62,834 resting ≥ 5,000 ✓) ≈ $1.26/day (pool ÷ 12 markets) |
...
| `apdc-alito-2026-12-31` | SELL | 9.0¢ | 199 | 0 | $100.00 | ✅ scoring — ~22.5% of ask side (6,793 resting ≥ 5,000 ✓) ≈ $5.63/day (pool ÷ 2 markets) |
...
<details><summary><code>apdc-jerpowgov-2026-12-31</code> BUY 20 @ 27¢ → $24.63/day</summary>
...
`yours 20.0 / Σ 20.3 = 98.5%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 98.5% = $24.63/day`  
...
<details><summary><code>apdc-jerpowgov-2026-12-31</code> SELL 15 @ 35¢ → $22.37/day</summary>
...
`yours 15.0 / Σ 16.8 = 89.5%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 89.5% = $22.37/day`  
...
<details><summary><code>tec-cbb-champ-2027-04-05-w-uconn</code> BUY 2 @ 14¢ → $2.70/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte180</code> BUY 5 @ 78¢ → $2.98/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte195</code> BUY 115 @ 49¢ → $2.52/day</summary>
...
`yours 23.0 / Σ 38.1 = 60.4%`  
`$100 ÷ 12 ÷ 2 = $4.17 × 60.4% = $2.52/day`  
...
<details><summary><code>opdc-mcconnell-resign-2026-11-02</code> BUY 30 @ 14¢ → $6.15/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte210</code> BUY 11 @ 44¢ → $1.91/day</summary>
...
<details><summary><code>scc-senate-gop-2026-11-03-49</code> BUY 10 @ 19¢ → $1.67/day</summary>
...
<details><summary><code>apdc-alito-2026-12-31</code> SELL 199 @ 9¢ → $5.63/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 9¢ | 883 (199 yours) | ×0.2^0 = 882.9 |
|  | 13¢ | 5 | ×0.2^4 = 0.0 |
|  | 25¢ | 579 | ×0.2^16 = 0.0 |
|  | 33¢ | 125 | ×0.2^24 = 0.0 |
|  | 99¢ | 5,200 | ×0.2^90 = 0.0 |
...
`yours 198.9 / Σ 882.9 = 22.5%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 22.5% = $5.63/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (220,013 resting) | ~48.4% | ~$36.32 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (326,194 resting) | ~41.2% | ~$30.88 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (5,681 resting) | ~63.9% | ~$15.97 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (66,869 resting) | ~60.5% | ~$15.14 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (61,604 resting) | ~18.7% | ~$14.04 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,380 resting) | ~55.8% | ~$13.96 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (6,185 resting) | ~41.4% | ~$10.35 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (5,896 resting) | ~26.4% | ~$6.61 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (97,649 resting) | ~24.7% | ~$6.17 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (67,059 resting) | ~6.7% | ~$5.03 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (189,263 resting) | ~4.7% | ~$3.52 |
| `ewc-usgub-ia-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (67,188 resting) | ~41.3% | ~$2.58 |
