...
## ✅ Last successful check: 2026-08-16 7:42 PM ET
...
**Earning right now:** ~$578.24/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-oh-2026-11-03-rep` — BUY at the best price, ~$6.00/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$3.82/day), `ewc-usgub-oh-2026-11-03-dem` (~$3.31/day)
...
### Estimated earning rate: ~$578.24/day (~$24.09/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `usgubewc-usgub-md-2026-11-03-rep` | SELL | 6.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (65,477 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-ne-2026-11-03-rep` | BUY | 60.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,202 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-tn-2026-11-03-rep` | BUY | 59.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (2,244 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-ma-2026-11-03-rep` | SELL | 5.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (2,000 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `ussewc-usse-va-2026-11-03-dem` | BUY | 50.0¢ | 10 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (600,225 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-nm-2026-11-03-rep` | SELL | 38.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (65,479 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-il-2026-11-03-rep` | SELL | 8.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (208,290 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-id-2026-11-03-dem` | SELL | 19.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (208,290 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-il-2026-11-03-rep` | SELL | 5.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (330,175 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-ok-2026-11-03-rep` | BUY | 56.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (600,203 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-al-2026-11-03-rep` | BUY | 59.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,203 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-nm-2026-11-03-dem` | BUY | 46.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,232 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-co-2026-11-03-dem` | BUY | 60.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,215 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-tn-2026-11-03-dem` | SELL | 6.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (527,436 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-hi-2026-11-03-rep` | SELL | 6.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (208,289 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-sc-2026-11-03-dem` | SELL | 17.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (195,978 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-ma-2026-11-03-dem` | BUY | 45.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (600,201 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-wy-2026-11-03-rep` | BUY | 59.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (2,001 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-il-2026-11-03-dem` | BUY | 33.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,203 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-tx-2026-11-03-rep` | BUY | 56.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (2,002 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-ok-2026-11-03-rep` | BUY | 57.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (600,227 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-wy-2026-11-03-rep` | BUY | 50.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,202 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-ar-2026-11-03-dem` | SELL | 10.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (130,727 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-al-2026-11-03-dem` | SELL | 8.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (203,553 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-ok-2026-11-03-dem` | SELL | 9.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (130,727 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| …and 644 more | | | | | | |
...
<details><summary><code>usgubewc-usgub-ma-2026-11-03-rep</code> SELL 1 @ 5¢ → $6.25/day</summary>
...
<details><summary><code>ussewc-usse-va-2026-11-03-dem</code> BUY 10 @ 50¢ → $6.25/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 50¢ | 10 (10 yours) | ×0.1^0 = 10.0 |
|  | 3¢ | 15 | ×0.1^47 = 0.0 |
|  | 2¢ | 600,000 | ×0.1^48 = 0.0 |
| | | **Σ** | **10.0** |
...
<details><summary><code>usgubewc-usgub-nm-2026-11-03-rep</code> SELL 1 @ 38¢ → $6.25/day</summary>
...
<details><summary><code>usgubewc-usgub-ok-2026-11-03-rep</code> BUY 1 @ 56¢ → $6.25/day</summary>
...
<details><summary><code>ussewc-usse-co-2026-11-03-dem</code> BUY 1 @ 60¢ → $6.25/day</summary>
...
<details><summary><code>ussewc-usse-tn-2026-11-03-dem</code> SELL 1 @ 6¢ → $6.25/day</summary>
...
<details><summary><code>usgubewc-usgub-wy-2026-11-03-rep</code> BUY 1 @ 59¢ → $6.25/day</summary>
...
<details><summary><code>ussewc-usse-il-2026-11-03-dem</code> BUY 1 @ 33¢ → $6.25/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 33¢ | 1 (1 yours) | ×0.1^0 = 1.0 |
|  | 10¢ | 1 | ×0.1^23 = 0.0 |
|  | 8¢ | 1 | ×0.1^25 = 0.0 |
|  | 2¢ | 500,000 | ×0.1^31 = 0.0 |
| | | **Σ** | **1.0** |
...
<details><summary><code>usgubewc-usgub-tx-2026-11-03-rep</code> BUY 1 @ 56¢ → $6.25/day</summary>
...
<details><summary><code>ussewc-usse-wy-2026-11-03-rep</code> BUY 1 @ 50¢ → $6.25/day</summary>
...
<details><summary><code>usgubewc-usgub-ar-2026-11-03-dem</code> SELL 1 @ 10¢ → $6.25/day</summary>
...
<details><summary><code>ussewc-usse-al-2026-11-03-dem</code> SELL 1 @ 8¢ → $6.25/day</summary>
...
<details><summary><code>usgubewc-usgub-ok-2026-11-03-dem</code> SELL 1 @ 9¢ → $6.25/day</summary>
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (277,261 resting) | ~8.0% | ~$6.00 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (27,541 resting) | ~15.3% | ~$3.82 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (280,650 resting) | ~4.4% | ~$3.31 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (85,204 resting) | ~3.7% | ~$2.81 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (37,899 resting) | ~8.4% | ~$2.10 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (90,803 resting) | ~2.7% | ~$1.99 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (91,546 resting) | ~28.7% | ~$1.79 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (5,843 resting) | ~5.4% | ~$1.36 |
...
| `ewc-usgub-ks-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (68,688 resting) | ~17.2% | ~$1.07 |
