...
## ✅ Last successful check: 2026-08-19 7:22 AM ET
...
**Earning right now:** ~$301.87/day estimated (ceiling, not promise — details below)
...
**What else to join:** `paccc-usho-midterms-2026-11-03-rep` — SELL at the best price, ~$25.83/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$24.88/day), `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$14.20/day)
...
### Estimated earning rate: ~$301.87/day (~$12.58/hour)
...
| `usgubewc-usgub-nm-2026-11-03-rep` | SELL | 7.0¢ | 24 | 0 | $25.00 | ✅ scoring — ~91.6% of ask side (65,647 resting ≥ 2,000 ✓) ≈ $5.73/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-ms-2026-11-03-dem` | SELL | 8.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~90.4% of ask side (66,196 resting ≥ 2,000 ✓) ≈ $5.65/day (event pool ÷ 2 markets) |
...
| `enwc-uspres-nom-rep-2028-rondes` | BUY | 10.0¢ | 82 | 1 | $200.00 | ✅ scoring — ~82.0% of bid side (61,122 resting ≥ 20,000 ✓) ≈ $5.85/day (event pool ÷ 14 markets) |
...
| `ussewc-usse-la-2026-11-03-rep` | BUY | 91.0¢ | 4 | 0 | $25.00 | ✅ scoring — ~57.1% of bid side (500,303 resting ≥ 2,000 ✓) ≈ $3.57/day (event pool ÷ 2 markets) |
| `enwc-uspres-nom-dem-2028-andbes` | BUY | 10.0¢ | 55 | 0 | $200.00 | ✅ scoring — ~55.8% of bid side (41,004 resting ≥ 20,000 ✓) ≈ $3.28/day (event pool ÷ 17 markets) |
...
| `scc-senate-gop-2026-11-03-49` | SELL | 22.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~49.8% of ask side (91,921 resting ≥ 5,000 ✓) ≈ $1.91/day (event pool ÷ 13 markets) |
| `usgubewc-usgub-tn-2026-11-03-rep` | BUY | 94.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~49.6% of bid side (2,068 resting ≥ 2,000 ✓) ≈ $3.10/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-tn-2026-11-03-rep` | BUY | 94.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~49.6% of bid side (2,068 resting ≥ 2,000 ✓) ≈ $3.10/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-il-2026-11-03-rep` | SELL | 5.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~48.8% of ask side (208,352 resting ≥ 2,000 ✓) ≈ $3.05/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-md-2026-11-03-dem` | BUY | 95.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~46.1% of bid side (500,277 resting ≥ 2,000 ✓) ≈ $2.88/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-md-2026-11-03-dem` | BUY | 95.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~46.1% of bid side (500,277 resting ≥ 2,000 ✓) ≈ $2.88/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-ne-2026-11-03-rep` | SELL | 94.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~44.5% of ask side (2,712 resting ≥ 2,000 ✓) ≈ $2.78/day (event pool ÷ 2 markets) |
| `ussewc-usse-ok-2026-11-03-rep` | BUY | 95.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~44.1% of bid side (600,366 resting ≥ 2,000 ✓) ≈ $2.76/day (event pool ÷ 2 markets) |
...
| `enwc-uspres-nom-rep-2028-margre` | BUY | 1.0¢ | 19,263 | 3 | $200.00 | ✅ scoring — ~40.2% of bid side (21,923 resting ≥ 20,000 ✓) ≈ $2.87/day (event pool ÷ 14 markets) |
| `ewc-usp-2028-11-07-dontrujr` | BUY | 9.0¢ | 50 | 0 | $200.00 | ✅ scoring — ~39.9% of bid side (20,468 resting ≥ 20,000 ✓) ≈ $1.48/day (event pool ÷ 27 markets) |
...
| `enwc-uspres-nom-rep-2028-elomus` | BUY | 1.0¢ | 19,336 | 3 | $200.00 | ✅ scoring — ~38.9% of bid side (22,010 resting ≥ 20,000 ✓) ≈ $2.78/day (event pool ÷ 14 markets) |
| …and 2725 more | | | | | | |
...
<details><summary><code>usgubewc-usgub-nm-2026-11-03-rep</code> SELL 24 @ 7¢ → $5.73/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 7¢ | 26 (24 yours) | ×0.1^0 = 26.0 |
|  | 8¢ | 2 | ×0.1^1 = 0.2 |
|  | 16¢ | 144 | ×0.1^9 = 0.0 |
|  | 98¢ | 65,250 | ×0.1^91 = 0.0 |
| | | **Σ** | **26.2** |

`yours 24.0 / Σ 26.2 = 91.6%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 91.6% = $5.73/day`  
...
<details><summary><code>enwc-uspres-nom-rep-2028-rondes</code> BUY 82 @ 10¢ → $5.85/day</summary>
...
<details><summary><code>ussewc-usse-la-2026-11-03-rep</code> BUY 4 @ 91¢ → $3.57/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 91¢ | 7 (4 yours) | ×0.1^0 = 7.0 |
|  | 83¢ | 80 | ×0.1^8 = 0.0 |
|  | 68¢ | 5 | ×0.1^23 = 0.0 |
|  | 31¢ | 1 | ×0.1^60 = 0.0 |
|  | 15¢ | 10 | ×0.1^76 = 0.0 |
...
`yours 55.0 / Σ 98.6 = 55.8%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 55.8% = $3.28/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-49</code> SELL 1 @ 22¢ → $1.91/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 22¢ | 2 (1 yours) | ×0.2^0 = 2.0 |
|  | 28¢ | 126 | ×0.2^6 = 0.0 |
|  | 29¢ | 50 | ×0.2^7 = 0.0 |
|  | 67¢ | 51 | ×0.2^45 = 0.0 |
|  | 68¢ | 1 | ×0.2^46 = 0.0 |
...
<details><summary><code>usgubewc-usgub-tn-2026-11-03-rep</code> BUY 3 @ 94¢ → $3.10/day</summary>
...
<details><summary><code>usgubewc-usgub-il-2026-11-03-rep</code> SELL 2 @ 5¢ → $3.05/day</summary>
...
<details><summary><code>usgubewc-usgub-md-2026-11-03-dem</code> BUY 3 @ 95¢ → $2.88/day</summary>
...
`yours 3.0 / Σ 6.5 = 46.1%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 46.1% = $2.88/day`  
...
<details><summary><code>ussewc-usse-ok-2026-11-03-rep</code> BUY 3 @ 95¢ → $2.76/day</summary>
...
<details><summary><code>enwc-uspres-nom-rep-2028-margre</code> BUY 19,263 @ 1¢ → $2.87/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 4¢ | 210 | ×0.2^0 = 209.9 |
| ▶ | 1¢ | 21,713 (19,263 yours) | ×0.2^3 = 173.7 |
| | | **Σ** | **383.6** |

`yours 154.1 / Σ 383.6 = 40.2%`  
`$200 ÷ 14 ÷ 2 = $7.14 × 40.2% = $2.87/day`  
...
<details><summary><code>enwc-uspres-nom-rep-2028-elomus</code> BUY 19,336 @ 1¢ → $2.78/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 4¢ | 224 | ×0.2^0 = 223.8 |
| ▶ | 1¢ | 21,786 (19,336 yours) | ×0.2^3 = 174.3 |
| | | **Σ** | **398.0** |

`yours 154.7 / Σ 398.0 = 38.9%`  
...
|---|---:|---:|---:|---|---:|---:|
| `paccc-usho-midterms-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (478,930 resting) | ~34.4% | ~$25.83 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (41,297 resting) | ~99.5% | ~$24.88 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (26,988 resting) | ~56.8% | ~$14.20 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (65,473 resting) | ~15.5% | ~$11.61 |
| `ewc-usse-tx-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (153,076 resting) | ~9.9% | ~$7.46 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (282,254 resting) | ~6.6% | ~$4.98 |
| `paccc-usho-midterms-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (537,764 resting) | ~6.1% | ~$4.58 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (26,634 resting) | ~5.1% | ~$3.83 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (89,151 resting) | ~57.7% | ~$3.61 |
| `ewc-usse-ak-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (386,986 resting) | ~42.5% | ~$2.66 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (633,804 resting) | ~6.5% | ~$1.63 |
| `ewc-usgub-wi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (1,242,655 resting) | ~25.1% | ~$1.57 |
