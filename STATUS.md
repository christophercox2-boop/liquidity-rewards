...
## ✅ Last successful check: 2026-08-12 8:02 AM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$187.92/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-ga-2026-11-03-dem` — SELL at the best price, ~$20.56/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$14.86/day), `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$13.95/day)
...
### Estimated earning rate: ~$187.92/day (~$7.83/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `usgubewc-usgub-me-2026-11-03-dem` | BUY | 95.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,240 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-me-2026-11-03-rep` | SELL | 9.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (65,515 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `ussewc-usse-co-2026-11-03-dem` | BUY | 94.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~80.0% of bid side (510,250 resting ≥ 2,000 ✓) ≈ $5.00/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-53` | BUY | 7.0¢ | 40 | 0 | $100.00 | ✅ scoring — ~71.6% of bid side (50,627 resting ≥ 5,000 ✓) ≈ $2.75/day (pool ÷ 13 markets) |
| `apdc-jerpowgov-2026-12-31` | BUY | 25.0¢ | 40 | 0 | $100.00 | ✅ scoring — ~67.3% of bid side (15,411 resting ≥ 5,000 ✓) ≈ $16.83/day (pool ÷ 2 markets) |
...
| `ussewc-usse-wy-2026-11-03-dem` | SELL | 4.0¢ | 85 | 0 | $25.00 | ✅ scoring — ~61.8% of ask side (136,105 resting ≥ 2,000 ✓) ≈ $3.87/day (pool ÷ 2 markets) |
| `ussewc-usse-ok-2026-11-03-dem` | SELL | 4.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~61.5% of ask side (130,790 resting ≥ 2,000 ✓) ≈ $3.85/day (pool ÷ 2 markets) |
| `ussewc-usse-al-2026-11-03-dem` | SELL | 4.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~61.5% of ask side (203,590 resting ≥ 2,000 ✓) ≈ $3.85/day (pool ÷ 2 markets) |
| `ussewc-usse-va-2026-11-03-rep` | SELL | 4.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~61.4% of ask side (65,685 resting ≥ 2,000 ✓) ≈ $3.84/day (pool ÷ 2 markets) |
| `ussewc-usse-nj-2026-11-03-rep` | BUY | 1.0¢ | 1,436 | 0 | $25.00 | ✅ scoring — ~58.5% of bid side (2,453 resting ≥ 2,000 ✓) ≈ $3.66/day (pool ÷ 2 markets) |
...
| `lawec-cryptoleg-2026-12-31` | SELL | 38.0¢ | 10 | 0 | $25.00 | ✅ scoring — ~47.6% of ask side (48,034 resting ≥ 2,000 ✓) ≈ $5.95/day |
| `ussewc-usse-il-2026-11-03-dem` | BUY | 93.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~46.5% of bid side (500,286 resting ≥ 2,000 ✓) ≈ $2.91/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-48` | SELL | 19.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~40.0% of ask side (91,820 resting ≥ 5,000 ✓) ≈ $1.54/day (pool ÷ 13 markets) |
| `apdc-jerpowgov-2026-12-31` | SELL | 27.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~36.3% of ask side (19,290 resting ≥ 5,000 ✓) ≈ $9.08/day (pool ÷ 2 markets) |
| `usgubewc-usgub-ny-2026-11-03-dem` | BUY | 93.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~36.0% of bid side (510,611 resting ≥ 2,000 ✓) ≈ $2.25/day (pool ÷ 2 markets) |
| `ussewc-usse-wy-2026-11-03-dem` | BUY | 1.0¢ | 2,000 | 0 | $25.00 | ✅ scoring — ~34.6% of bid side (5,781 resting ≥ 2,000 ✓) ≈ $2.16/day (pool ÷ 2 markets) |
| `usgubewc-usgub-ok-2026-11-03-rep` | BUY | 94.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~33.0% of bid side (610,603 resting ≥ 2,000 ✓) ≈ $2.06/day (pool ÷ 2 markets) |
...
| `scc-hrep-rep-2026-11-03-gte215` | BUY | 16.0¢ | 40 | 1 | $100.00 | ✅ scoring — ~32.0% of bid side (400,608 resting ≥ 5,000 ✓) ≈ $1.33/day (pool ÷ 12 markets) |
| `usgubewc-usgub-hi-2026-11-03-dem` | SELL | 96.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~31.7% of ask side (10,939 resting ≥ 2,000 ✓) ≈ $1.98/day (pool ÷ 2 markets) |
| `ussewc-usse-or-2026-11-03-rep` | BUY | 1.0¢ | 1,290 | 0 | $25.00 | ✅ scoring — ~31.3% of bid side (4,125 resting ≥ 2,000 ✓) ≈ $1.95/day (pool ÷ 2 markets) |
| `pandc-anydis-2027-12-31` | BUY | 14.0¢ | 20 | 0 | $50.00 | ✅ scoring — ~31.0% of bid side (10,400 resting ≥ 10,000 ✓) ≈ $3.88/day (pool ÷ 2 markets) |
| `usgubewc-usgub-id-2026-11-03-dem` | BUY | 1.0¢ | 2,000 | 0 | $25.00 | ✅ scoring — ~30.4% of bid side (6,580 resting ≥ 2,000 ✓) ≈ $1.90/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-52` | BUY | 15.0¢ | 8 | 0 | $100.00 | ✅ scoring — ~27.9% of bid side (300,599 resting ≥ 5,000 ✓) ≈ $1.07/day (pool ÷ 13 markets) |
| `pandc-anydis-2027-12-31` | SELL | 22.0¢ | 20 | 0 | $50.00 | ✅ scoring — ~25.4% of ask side (10,317 resting ≥ 10,000 ✓) ≈ $3.17/day (pool ÷ 2 markets) |
| …and 410 more | | | | | | |
...
<details><summary><code>usgubewc-usgub-me-2026-11-03-rep</code> SELL 40 @ 9¢ → $6.25/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 9¢ | 40 (40 yours) | ×0.1^0 = 40.0 |
...
<details><summary><code>ussewc-usse-co-2026-11-03-dem</code> BUY 40 @ 94¢ → $5.00/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 94¢ | 50 (40 yours) | ×0.1^0 = 50.0 |
...
<details><summary><code>scc-senate-gop-2026-11-03-53</code> BUY 40 @ 7¢ → $2.75/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 7¢ | 52 (40 yours) | ×0.2^0 = 51.6 |
|  | 5¢ | 26 | ×0.2^2 = 1.0 |
|  | 1¢ | 50,549 | ×0.2^6 = 3.2 |
| | | **Σ** | **55.9** |

`yours 40.0 / Σ 55.9 = 71.6%`  
...
<details><summary><code>apdc-jerpowgov-2026-12-31</code> BUY 40 @ 25¢ → $16.83/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 25¢ | 52 (40 yours) | ×0.2^0 = 51.6 |
|  | 24¢ | 34 | ×0.2^1 = 6.8 |
|  | 23¢ | 10 | ×0.2^2 = 0.4 |
|  | 18¢ | 20 | ×0.2^7 = 0.0 |
|  | 17¢ | 6 | ×0.2^8 = 0.0 |
...
`yours 39.6 / Σ 58.8 = 67.3%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 67.3% = $16.83/day`  
...
<details><summary><code>ussewc-usse-wy-2026-11-03-dem</code> SELL 85 @ 4¢ → $3.87/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 4¢ | 135 (85 yours) | ×0.1^0 = 135.0 |
|  | 6¢ | 245 | ×0.1^2 = 2.5 |
|  | 50¢ | 5,000 | ×0.1^46 = 0.0 |
| | | **Σ** | **137.4** |

`yours 85.0 / Σ 137.4 = 61.8%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 61.8% = $3.87/day`  
...
<details><summary><code>ussewc-usse-al-2026-11-03-dem</code> SELL 40 @ 4¢ → $3.85/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 4¢ | 65 (40 yours) | ×0.1^0 = 65.0 |
|  | 98¢ | 203,325 | ×0.1^94 = 0.0 |
| | | **Σ** | **65.0** |
...
<details><summary><code>ussewc-usse-nj-2026-11-03-rep</code> BUY 1,436 @ 1¢ → $3.66/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 2,453 (1,436 yours) | ×0.1^0 = 2,452.7 |
| | | **Σ** | **2,452.7** |

`yours 1,436.0 / Σ 2,452.7 = 58.5%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 58.5% = $3.66/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-48</code> SELL 10 @ 19¢ → $1.54/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 19¢ | 25 (10 yours) | ×0.2^0 = 25.0 |
|  | 50¢ | 100 | ×0.2^31 = 0.0 |
...
<details><summary><code>apdc-jerpowgov-2026-12-31</code> SELL 10 @ 27¢ → $9.08/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 27¢ | 16 (10 yours) | ×0.2^0 = 16.0 |
|  | 28¢ | 31 | ×0.2^1 = 6.2 |
|  | 29¢ | 134 | ×0.2^2 = 5.3 |
|  | 32¢ | 23 | ×0.2^5 = 0.0 |
|  | 35¢ | 16 | ×0.2^8 = 0.0 |
|  | 99¢ | 19,071 | ×0.2^72 = 0.0 |
| | | **Σ** | **27.5** |

`yours 10.0 / Σ 27.5 = 36.3%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 36.3% = $9.08/day`  
...
<details><summary><code>usgubewc-usgub-ny-2026-11-03-dem</code> BUY 40 @ 93¢ → $2.25/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 93¢ | 111 (40 yours) | ×0.1^0 = 111.0 |
|  | 80¢ | 300 | ×0.1^13 = 0.0 |
|  | 2¢ | 500,000 | ×0.1^91 = 0.0 |
| | | **Σ** | **111.0** |
...
| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 5,781 (2,000 yours) | ×0.1^0 = 5,781.0 |
| | | **Σ** | **5,781.0** |

`yours 2,000.0 / Σ 5,781.0 = 34.6%`  
...
<details><summary><code>usgubewc-usgub-ok-2026-11-03-rep</code> BUY 40 @ 94¢ → $2.06/day</summary>
...
`yours 40.0 / Σ 121.3 = 33.0%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 33.0% = $2.06/day`  
...
<details><summary><code>usgubewc-usgub-hi-2026-11-03-dem</code> SELL 40 @ 96¢ → $1.98/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 96¢ | 90 (40 yours) | ×0.1^0 = 90.0 |
|  | 97¢ | 257 | ×0.1^1 = 25.7 |
|  | 99¢ | 10,592 | ×0.1^3 = 10.6 |
| | | **Σ** | **126.3** |

`yours 40.0 / Σ 126.3 = 31.7%`  
...
<details><summary><code>pandc-anydis-2027-12-31</code> BUY 20 @ 14¢ → $3.88/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 14¢ | 53 (20 yours) | ×0.25^0 = 53.0 |
|  | 13¢ | 46 | ×0.25^1 = 11.5 |
|  | 1¢ | 10,301 | ×0.25^13 = 0.0 |
| | | **Σ** | **64.5** |

`yours 20.0 / Σ 64.5 = 31.0%`  
`$50 ÷ 2 ÷ 2 = $12.50 × 31.0% = $3.88/day`  
...
<details><summary><code>usgubewc-usgub-id-2026-11-03-dem</code> BUY 2,000 @ 1¢ → $1.90/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 6,580 (2,000 yours) | ×0.1^0 = 6,580.0 |
| | | **Σ** | **6,580.0** |

`yours 2,000.0 / Σ 6,580.0 = 30.4%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 30.4% = $1.90/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (61,977 resting) | ~27.4% | ~$20.56 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (37,532 resting) | ~59.4% | ~$14.86 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (37,501 resting) | ~55.8% | ~$13.95 |
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (369,437 resting) | ~15.7% | ~$11.77 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (71,989 resting) | ~12.6% | ~$9.49 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (1,066,635 resting) | ~12.1% | ~$9.05 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (10,418 resting) | ~30.0% | ~$7.49 |
| `ewc-usse-tx-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (633,492 resting) | ~6.0% | ~$4.53 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (274,667 resting) | ~4.4% | ~$3.33 |
| `ewc-usse-tx-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (864,193 resting) | ~4.4% | ~$3.32 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (144,014 resting) | ~3.5% | ~$2.66 |
| `paccc-usse-midterms-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (1,037,243 resting) | ~3.2% | ~$2.38 |
