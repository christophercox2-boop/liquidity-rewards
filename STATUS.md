...
## ✅ Last successful check: 2026-08-18 6:47 PM ET
...
**Earning right now:** ~$220.43/day estimated (ceiling, not promise — details below)
...
### Estimated earning rate: ~$220.43/day (~$9.18/hour)
...
| `ewc-usp-2028-11-07-petbut` | SELL | 10.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~94.8% of ask side (59,329 resting ≥ 20,000 ✓) ≈ $3.51/day (event pool ÷ 27 markets) |
...
| `usgubewc-usgub-md-2026-11-03-rep` | BUY | 1.0¢ | 1,799 | 0 | $25.00 | ✅ scoring — ~74.7% of bid side (2,408 resting ≥ 2,000 ✓) ≈ $4.67/day (event pool ÷ 2 markets) |
...
| `scc-senate-gop-2026-11-03-47` | BUY | 12.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~49.0% of bid side (105,655 resting ≥ 5,000 ✓) ≈ $1.88/day (event pool ÷ 13 markets) |
| `usgubewc-usgub-tx-2026-11-03-dem` | BUY | 14.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~46.1% of bid side (17,157 resting ≥ 2,000 ✓) ≈ $2.88/day (event pool ÷ 2 markets) |
| `enwc-uspres-nom-dem-2028-petbut` | SELL | 13.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~45.4% of ask side (33,710 resting ≥ 20,000 ✓) ≈ $2.67/day (event pool ÷ 17 markets) |
| `enwc-uspres-nom-dem-2028-petbut` | SELL | 13.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~45.4% of ask side (33,710 resting ≥ 20,000 ✓) ≈ $2.67/day (event pool ÷ 17 markets) |
| `ussewc-usse-ok-2026-11-03-rep` | BUY | 95.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~44.8% of bid side (600,427 resting ≥ 2,000 ✓) ≈ $2.80/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-tn-2026-11-03-rep` | BUY | 95.0¢ | 35 | 0 | $25.00 | ✅ scoring — ~34.7% of bid side (500,567 resting ≥ 2,000 ✓) ≈ $2.17/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-ok-2026-11-03-dem` | SELL | 7.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~33.3% of ask side (130,903 resting ≥ 2,000 ✓) ≈ $2.08/day (event pool ÷ 2 markets) |
| `ussewc-usse-ok-2026-11-03-dem` | SELL | 7.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~33.3% of ask side (130,903 resting ≥ 2,000 ✓) ≈ $2.08/day (event pool ÷ 2 markets) |
| …and 1458 more | | | | | | |
...
<details><summary><code>ewc-usp-2028-11-07-petbut</code> SELL 1 @ 10¢ → $3.51/day</summary>
...
`yours 1.2 / Σ 1.2 = 94.8%`  
`$200 ÷ 27 ÷ 2 = $3.70 × 94.8% = $3.51/day`  
...
<details><summary><code>usgubewc-usgub-md-2026-11-03-rep</code> BUY 1,799 @ 1¢ → $4.67/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 2,408 (1,799 yours) | ×0.1^0 = 2,408.0 |
| | | **Σ** | **2,408.0** |

`yours 1,799.0 / Σ 2,408.0 = 74.7%`  
...
<details><summary><code>ussewc-usse-ok-2026-11-03-rep</code> BUY 3 @ 95¢ → $2.80/day</summary>
...
<details><summary><code>ussewc-usse-tn-2026-11-03-rep</code> BUY 35 @ 95¢ → $2.17/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 95¢ | 100 (35 yours) | ×0.1^0 = 100.0 |
|  | 94¢ | 4 | ×0.1^1 = 0.4 |
|  | 93¢ | 50 | ×0.1^2 = 0.5 |
|  | 58¢ | 1 | ×0.1^37 = 0.0 |
|  | 12¢ | 212 | ×0.1^83 = 0.0 |
...
`yours 35.0 / Σ 100.9 = 34.7%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 34.7% = $2.17/day`  
...
<details><summary><code>ussewc-usse-ok-2026-11-03-dem</code> SELL 2 @ 7¢ → $2.08/day</summary>
...
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (632,345 resting) | ~9.3% | ~$2.34 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (285,493 resting) | ~3.0% | ~$2.26 |
| `ewc-usse-nc-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (66,835 resting) | ~6.4% | ~$1.60 |
| `ewc-usgub-wi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (1,241,073 resting) | ~23.3% | ~$1.46 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (280,976 resting) | ~1.9% | ~$1.42 |
