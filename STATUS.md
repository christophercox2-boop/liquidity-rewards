...
## ✅ Last successful check: 2026-08-18 6:30 PM ET
...
**Earning right now:** ~$221.64/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-usgubp-ok-2026-06-16-rep-gendru` — BUY at the best price, ~$20.83/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$19.04/day), `ewc-usgub-ga-2026-11-03-dem` (~$10.58/day)
...
### Estimated earning rate: ~$221.64/day (~$9.24/hour)
...
| `enwc-uspres-nom-dem-2028-petbut` | SELL | 12.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~99.2% of ask side (33,718 resting ≥ 20,000 ✓) ≈ $5.83/day (event pool ÷ 17 markets) |
| `enwc-uspres-nom-rep-2028-rondes` | BUY | 9.0¢ | 135 | 0 | $200.00 | ✅ scoring — ~99.0% of bid side (63,768 resting ≥ 20,000 ✓) ≈ $7.07/day (event pool ÷ 14 markets) |
| `usgubewc-usgub-ma-2026-11-03-dem` | BUY | 94.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~98.4% of bid side (2,751 resting ≥ 2,000 ✓) ≈ $6.15/day (event pool ÷ 2 markets) |
| `enwc-uspres-nom-dem-2028-rokha` | SELL | 5.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~97.3% of ask side (33,801 resting ≥ 20,000 ✓) ≈ $5.72/day (event pool ÷ 17 markets) |
| `usgubewc-usgub-md-2026-11-03-dem` | BUY | 95.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~96.6% of bid side (500,419 resting ≥ 2,000 ✓) ≈ $6.04/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-hi-2026-11-03-dem` | BUY | 95.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~85.7% of bid side (500,582 resting ≥ 2,000 ✓) ≈ $5.36/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-ok-2026-11-03-dem` | SELL | 8.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~66.7% of ask side (130,781 resting ≥ 2,000 ✓) ≈ $4.17/day (event pool ÷ 2 markets) |
| `ussewc-usse-tn-2026-11-03-rep` | BUY | 95.0¢ | 35 | 0 | $25.00 | ✅ scoring — ~65.9% of bid side (500,423 resting ≥ 2,000 ✓) ≈ $4.12/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-il-2026-11-03-rep` | SELL | 7.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~56.8% of ask side (208,354 resting ≥ 2,000 ✓) ≈ $3.55/day (event pool ÷ 2 markets) |
...
| `scc-senate-gop-2026-11-03-47` | BUY | 12.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~43.8% of bid side (105,636 resting ≥ 5,000 ✓) ≈ $1.69/day (event pool ÷ 13 markets) |
| `usgubewc-usgub-md-2026-11-03-rep` | BUY | 1.0¢ | 1,799 | 0 | $25.00 | ✅ scoring — ~41.3% of bid side (4,352 resting ≥ 2,000 ✓) ≈ $2.58/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-ok-2026-11-03-dem` | SELL | 8.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~33.3% of ask side (130,781 resting ≥ 2,000 ✓) ≈ $2.08/day (event pool ÷ 2 markets) |
...
<details><summary><code>enwc-uspres-nom-dem-2028-petbut</code> SELL 1 @ 12¢ → $5.83/day</summary>
...
<details><summary><code>enwc-uspres-nom-rep-2028-rondes</code> BUY 135 @ 9¢ → $7.07/day</summary>
...
`yours 135.0 / Σ 136.3 = 99.0%`  
`$200 ÷ 14 ÷ 2 = $7.14 × 99.0% = $7.07/day`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-rokha</code> SELL 1 @ 5¢ → $5.72/day</summary>
...
<details><summary><code>usgubewc-usgub-md-2026-11-03-dem</code> BUY 3 @ 95¢ → $6.04/day</summary>
...
<details><summary><code>usgubewc-usgub-ok-2026-11-03-dem</code> SELL 2 @ 8¢ → $4.17/day</summary>
...
<details><summary><code>ussewc-usse-tn-2026-11-03-rep</code> BUY 35 @ 95¢ → $4.12/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 95¢ | 48 (35 yours) | ×0.1^0 = 48.0 |
|  | 94¢ | 46 | ×0.1^1 = 4.6 |
|  | 93¢ | 50 | ×0.1^2 = 0.5 |
|  | 58¢ | 1 | ×0.1^37 = 0.0 |
|  | 12¢ | 78 | ×0.1^83 = 0.0 |
...
<details><summary><code>usgubewc-usgub-md-2026-11-03-rep</code> BUY 1,799 @ 1¢ → $2.58/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 4,352 (1,799 yours) | ×0.1^0 = 4,352.0 |
| | | **Σ** | **4,352.0** |

`yours 1,799.0 / Σ 4,352.0 = 41.3%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 41.3% = $2.58/day`  
...
<details><summary><code>usgubewc-usgub-ok-2026-11-03-dem</code> SELL 1 @ 8¢ → $2.08/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 8¢ | 3 (1 yours) | ×0.1^0 = 3.0 |
|  | 14¢ | 50 | ×0.1^6 = 0.0 |
|  | 51¢ | 3 | ×0.1^43 = 0.0 |
|  | 98¢ | 130,500 | ×0.1^90 = 0.0 |
| | | **Σ** | **3.0** |
...
|---|---:|---:|---:|---|---:|---:|
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (25,990 resting) | ~83.3% | ~$20.83 |
...
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (632,129 resting) | ~7.0% | ~$1.74 |
| `ewc-usse-nc-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (66,827 resting) | ~6.4% | ~$1.60 |
| `ewc-usgub-wi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (1,245,819 resting) | ~23.2% | ~$1.45 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (280,688 resting) | ~1.9% | ~$1.45 |
