...
## ✅ Last successful check: 2026-08-03 9:10 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$35.03/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-usgubp-ok-2026-06-16-rep-gendru` — SELL at the best price, ~$16.50/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$16.22/day), `ewc-usgub-oh-2026-11-03-dem` (~$7.96/day)
...
### Estimated earning rate: ~$35.03/day (~$1.46/hour)
...
| `scc-senate-gop-2026-11-03-55` | SELL | 6.0¢ | 40 | 0 | $100.00 | ✅ scoring — ~27.5% of ask side (12,282 resting ≥ 5,000 ✓) ≈ $1.06/day (pool ÷ 13 markets) |
...
| `pintc-meet-trump-2026-12-31-kimjon` | BUY | 23.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~24.9% of bid side (2,496 resting ≥ 2,000 ✓) ≈ $0.24/day (pool ÷ 13 markets) |
| `apdc-alito-2026-12-31` | BUY | 17.0¢ | 100 | 0 | $100.00 | ✅ scoring — ~18.8% of bid side (12,374 resting ≥ 5,000 ✓) ≈ $4.69/day (pool ÷ 2 markets) |
| `scc-hrep-rep-2026-11-03-gte205` | SELL | 58.0¢ | 12 | 0 | $100.00 | ✅ scoring — ~13.6% of ask side (6,484 resting ≥ 5,000 ✓) ≈ $0.57/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte235` | SELL | 9.0¢ | 50 | 1 | $100.00 | ✅ scoring — ~4.7% of ask side (5,572 resting ≥ 5,000 ✓) ≈ $0.19/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-51` | BUY | 1.0¢ | 5,000 | 0 | $100.00 | ✅ scoring — ~2.5% of bid side (196,586 resting ≥ 5,000 ✓) ≈ $0.10/day (pool ÷ 13 markets) |
| `scc-senate-gop-2026-11-03-53` | BUY | 5.0¢ | 590 | 0 | $100.00 | ✅ scoring — ~2.4% of bid side (25,261 resting ≥ 5,000 ✓) ≈ $0.09/day (pool ÷ 13 markets) |
| `ewc-usse-tx-2026-11-03-dem` | BUY | 47.0¢ | 50 | 0 | $300.00 | ✅ scoring — ~2.2% of bid side (380,324 resting ≥ 10,000 ✓) ≈ $1.65/day (pool ÷ 2 markets) |
| …and 49 more | | | | | | |
...
| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 196,586 (5,000 yours) | ×0.2^0 = 196,585.5 |
| | | **Σ** | **196,585.5** |

`yours 5,000.0 / Σ 196,585.5 = 2.5%`  
...
<details><summary><code>ewc-usse-tx-2026-11-03-dem</code> BUY 50 @ 47¢ → $1.65/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 47¢ | 915 (50 yours) | ×0.2^0 = 915.0 |
|  | 46¢ | 6,360 | ×0.2^1 = 1,272.0 |
|  | 45¢ | 2,228 | ×0.2^2 = 89.1 |
|  | 35¢ | 15,000 | ×0.2^12 = 0.0 |
| | | **Σ** | **2,276.1** |

`yours 50.0 / Σ 2,276.1 = 2.2%`  
`$300 ÷ 2 ÷ 2 = $75.00 × 2.2% = $1.65/day`  
...
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (81,923 resting) | ~10.6% | ~$7.96 |
...
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (322,570 resting) | ~2.7% | ~$2.06 |
| `ewc-usse-me-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (187,905 resting) | ~2.4% | ~$1.79 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (101,785 resting) | ~2.0% | ~$1.50 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (125,028 resting) | ~1.9% | ~$1.40 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (139,167 resting) | ~1.3% | ~$0.94 |
