...
## ✅ Last successful check: 2026-08-15 11:41 PM ET
...
**Earning right now:** ~$484.64/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-nv-2026-11-03-rep` — SELL at the best price, ~$4.30/day for 200 contracts. Runners-up: `ewc-usse-mi-2026-11-03-rep` (~$3.22/day), `enwc-ussep-sc-2026-08-11-rep-darnor` (~$2.94/day)
...
### Estimated earning rate: ~$484.64/day (~$20.19/hour)
...
| `usgubewc-usgub-or-2026-11-03-rep` | BUY | 18.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (2,503 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-ok-2026-11-03-rep` | SELL | 88.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (2,188 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-al-2026-11-03-rep` | SELL | 90.0¢ | 50 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (20,254 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-fl-2026-11-03-dem` | BUY | 23.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (10,398 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `enwc-uspres-nom-dem-2028-jbpri` | BUY | 8.0¢ | 75 | 0 | $1,000.00 | ✅ scoring — ~94.0% of bid side (190,531 resting ≥ 20,000 ✓) ≈ $7.83/day (program pool ÷ 60 markets) |
...
| `ewc-usp-2028-11-07-dontrujr` | BUY | 10.0¢ | 60 | 1 | $1,000.00 | ✅ scoring — ~89.1% of bid side (20,514 resting ≥ 20,000 ✓) ≈ $7.42/day (program pool ÷ 60 markets) |
...
| `ewc-usp-2028-11-07-jamtal` | BUY | 18.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~85.4% of bid side (20,064 resting ≥ 20,000 ✓) ≈ $7.12/day (program pool ÷ 60 markets) |
...
| `enwc-uspres-nom-dem-2028-rokha` | BUY | 10.0¢ | 24 | 0 | $1,000.00 | ✅ scoring — ~82.4% of bid side (20,481 resting ≥ 20,000 ✓) ≈ $6.87/day (program pool ÷ 60 markets) |
...
| `ewc-usp-2028-11-07-markel` | BUY | 14.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~81.5% of bid side (20,514 resting ≥ 20,000 ✓) ≈ $6.79/day (program pool ÷ 60 markets) |
| `ewc-usp-2028-11-07-petbut` | BUY | 15.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~80.6% of bid side (20,707 resting ≥ 20,000 ✓) ≈ $6.72/day (program pool ÷ 60 markets) |
...
| `ussewc-usse-ky-2026-11-03-rep` | BUY | 90.0¢ | 10 | 0 | $25.00 | ✅ scoring — ~78.1% of bid side (500,368 resting ≥ 2,000 ✓) ≈ $4.88/day (pool ÷ 2 markets) |
| `ussewc-usse-ks-2026-11-03-dem` | BUY | 23.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~77.9% of bid side (2,210 resting ≥ 2,000 ✓) ≈ $4.87/day (pool ÷ 2 markets) |
| …and 2613 more | | | | | | |
...
<details><summary><code>enwc-uspres-nom-dem-2028-jbpri</code> BUY 75 @ 8¢ → $7.83/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 8¢ | 77 (75 yours) | ×0.2^0 = 77.3 |
|  | 6¢ | 1 | ×0.2^2 = 0.0 |
|  | 5¢ | 1 | ×0.2^3 = 0.0 |
|  | 3¢ | 1 | ×0.2^5 = 0.0 |
|  | 1¢ | 190,451 | ×0.2^7 = 2.4 |
...
`yours 75.0 / Σ 79.8 = 94.0%`  
`$1,000 ÷ 60 ÷ 2 = $8.33 × 94.0% = $7.83/day`  
...
<details><summary><code>ewc-usp-2028-11-07-dontrujr</code> BUY 60 @ 10¢ → $7.42/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-jamtal</code> BUY 1 @ 18¢ → $7.12/day</summary>
...
`yours 1.0 / Σ 1.2 = 85.4%`  
`$1,000 ÷ 60 ÷ 2 = $8.33 × 85.4% = $7.12/day`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-rokha</code> BUY 24 @ 10¢ → $6.87/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 10¢ | 29 (24 yours) | ×0.2^0 = 29.1 |
|  | 4¢ | 1 | ×0.2^6 = 0.0 |
|  | 1¢ | 20,451 | ×0.2^9 = 0.0 |
| | | **Σ** | **29.1** |

`yours 24.0 / Σ 29.1 = 82.4%`  
`$1,000 ÷ 60 ÷ 2 = $8.33 × 82.4% = $6.87/day`  
...
<details><summary><code>ewc-usp-2028-11-07-markel</code> BUY 1 @ 14¢ → $6.79/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-petbut</code> BUY 1 @ 15¢ → $6.72/day</summary>
...
<details><summary><code>ussewc-usse-ky-2026-11-03-rep</code> BUY 10 @ 90¢ → $4.88/day</summary>
...
<details><summary><code>ussewc-usse-ks-2026-11-03-dem</code> BUY 1 @ 23¢ → $4.87/day</summary>
...
`yours 1.0 / Σ 1.3 = 77.9%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 77.9% = $4.87/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-nv-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (73,160 resting) | ~68.8% | ~$4.30 |
| `ewc-usse-mi-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (627,572 resting) | ~51.5% | ~$3.22 |
| `enwc-ussep-sc-2026-08-11-rep-darnor` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (263,956 resting) | ~47.1% | ~$2.94 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (631,417 resting) | ~8.5% | ~$2.12 |
| `ewc-usse-nh-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (48,674 resting) | ~31.4% | ~$1.97 |
| `ewc-usmayor-losang-2026-11-03-karbas` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (204,908 resting) | ~29.9% | ~$1.87 |
...
| `ewc-usgub-mi-2026-11-03-dem` | $25.00 ÷ 3 | 0.10 | 2,000 | SELL side (53,317 resting) | ~19.4% | ~$0.81 |
| `enwc-usgubp-fl-2026-08-18-rep-byrdon` | $300.00 ÷ 3 | 0.20 | 10,000 | SELL side (49,929 resting) | ~1.4% | ~$0.71 |
| `ewc-usse-ak-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (67,004 resting) | ~10.8% | ~$0.68 |
