...
## ✅ Last successful check: 2026-08-09 11:05 AM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$110.68/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-ca-2026-11-03-stehil` — SELL at the best price, ~$24.52/day for 200 contracts. Runners-up: `ewc-usgub-ca-2026-11-03-xavbec` (~$17.69/day), `enwc-ussep-mn-2026-08-11-dem-angcra` (~$17.48/day)
...
### Estimated earning rate: ~$110.68/day (~$4.61/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `scc-hrep-rep-2026-11-03-gte200` | SELL | 54.0¢ | 3 | 0 | $100.00 | ✅ scoring — ~99.8% of ask side (48,052 resting ≥ 5,000 ✓) ≈ $4.16/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-49` | BUY | 16.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~99.8% of bid side (50,600 resting ≥ 5,000 ✓) ≈ $3.84/day (pool ÷ 13 markets) |
...
| `tec-cbb-champ-2027-04-05-w-uconn` | BUY | 14.0¢ | 2 | 0 | $500.00 | ✅ scoring — ~88.4% of bid side (8,782 resting ≥ 2,500 ✓) ≈ $3.03/day (pool ÷ 73 markets) |
...
| `scc-hrep-rep-2026-11-03-gte195` | SELL | 72.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~55.6% of ask side (5,359 resting ≥ 5,000 ✓) ≈ $2.31/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-49` | SELL | 48.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~27.6% of ask side (113,719 resting ≥ 5,000 ✓) ≈ $1.06/day (pool ÷ 13 markets) |
...
| `apdc-alito-2026-12-31` | SELL | 10.0¢ | 200 | 0 | $100.00 | ✅ scoring — ~21.3% of ask side (7,107 resting ≥ 5,000 ✓) ≈ $5.34/day (pool ÷ 2 markets) |
| `scc-hrep-rep-2026-11-03-gte190` | SELL | 75.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~20.8% of ask side (7,883 resting ≥ 5,000 ✓) ≈ $0.87/day (pool ÷ 12 markets) |
...
<details><summary><code>scc-senate-gop-2026-11-03-49</code> BUY 10 @ 16¢ → $3.84/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte195</code> SELL 10 @ 72¢ → $2.31/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 72¢ | 10 (10 yours) | ×0.2^0 = 10.0 |
|  | 73¢ | 40 | ×0.2^1 = 8.0 |
|  | 82¢ | 187 | ×0.2^10 = 0.0 |
|  | 99¢ | 5,122 | ×0.2^27 = 0.0 |
| | | **Σ** | **18.0** |
...
<details><summary><code>scc-senate-gop-2026-11-03-49</code> SELL 10 @ 48¢ → $1.06/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 48¢ | 10 (10 yours) | ×0.2^0 = 10.0 |
|  | 49¢ | 89 | ×0.2^1 = 17.8 |
|  | 50¢ | 212 | ×0.2^2 = 8.5 |
|  | 66¢ | 0 | ×0.2^18 = 0.0 |
|  | 97¢ | 58,828 | ×0.2^49 = 0.0 |
| | | **Σ** | **36.3** |

`yours 10.0 / Σ 36.3 = 27.6%`  
...
<details><summary><code>apdc-alito-2026-12-31</code> SELL 200 @ 10¢ → $5.34/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 10¢ | 937 (200 yours) | ×0.2^0 = 937.0 |
|  | 13¢ | 5 | ×0.2^3 = 0.0 |
|  | 18¢ | 242 | ×0.2^8 = 0.0 |
|  | 25¢ | 579 | ×0.2^15 = 0.0 |
|  | 27¢ | 143 | ×0.2^17 = 0.0 |
...
`yours 200.0 / Σ 937.0 = 21.3%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 21.3% = $5.34/day`  
...
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (326,606 resting) | ~23.6% | ~$17.69 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (5,545 resting) | ~69.9% | ~$17.48 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (9,083 resting) | ~63.9% | ~$15.97 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (61,926 resting) | ~12.2% | ~$9.15 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,624 resting) | ~33.2% | ~$8.30 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (81,585 resting) | ~31.6% | ~$7.89 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (40,566 resting) | ~29.3% | ~$7.32 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,217 resting) | ~17.8% | ~$4.45 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (189,185 resting) | ~4.8% | ~$3.64 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (68,284 resting) | ~4.6% | ~$3.43 |
| `ewc-usgub-ia-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (52,899 resting) | ~41.6% | ~$2.60 |
