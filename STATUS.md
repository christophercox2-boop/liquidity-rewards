...
## ✅ Last successful check: 2026-08-18 6:31 AM ET
...
**Earning right now:** ~$201.01/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-usgubp-ok-2026-06-16-rep-gendru` — BUY at the best price, ~$10.91/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$2.39/day), `enwc-usgubp-fl-2026-08-18-rep-byrdon` (~$1.73/day)
...
### Estimated earning rate: ~$201.01/day (~$8.38/hour)
...
| `enwc-uspres-nom-dem-2028-rokha` | SELL | 6.0¢ | 3 | 0 | $200.00 | ✅ scoring — ~94.2% of ask side (38,808 resting ≥ 20,000 ✓) ≈ $5.54/day (event pool ÷ 17 markets) |
...
| `vsc-usgubp-fl-fshbck-atl-9pct` | SELL | 63.0¢ | 2 | 0 | $500.00 | ✅ scoring — ~71.0% of ask side (15,786 resting ≥ 10,000 ✓) ≈ $17.74/day (event pool ÷ 10 markets) |
...
| `enwc-uspres-nom-dem-2028-petbut` | BUY | 11.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~68.7% of bid side (133,001 resting ≥ 20,000 ✓) ≈ $4.04/day (event pool ÷ 17 markets) |
| `erac-usgubp-ak-adv-2026-08-18-edndev` | BUY | 1.0¢ | 9,899 | 0 | $500.00 | ✅ scoring — ~67.9% of bid side (14,579 resting ≥ 10,000 ✓) ≈ $8.93/day (event pool ÷ 19 markets) |
| `enwc-uspres-nom-dem-2028-micoba` | BUY | 8.0¢ | 132 | 0 | $200.00 | ✅ scoring — ~48.6% of bid side (20,001 resting ≥ 20,000 ✓) ≈ $2.86/day (event pool ÷ 17 markets) |
| `ewc-usp-2028-11-07-micoba` | BUY | 1.0¢ | 9,973 | 3 | $200.00 | ✅ scoring — ~48.4% of bid side (20,000 resting ≥ 20,000 ✓) ≈ $1.79/day (event pool ÷ 27 markets) |
| `enwc-ushrp-fl19-2026-08-18-catlau` | BUY | 1.0¢ | 2,000 | 0 | $25.00 | ✅ scoring — ~48.3% of bid side (4,145 resting ≥ 2,000 ✓) ≈ $0.86/day (event pool ÷ 7 markets) |
...
| `ewc-usp-2028-11-07-micoba` | BUY | 1.0¢ | 9,546 | 3 | $200.00 | ✅ scoring — ~46.3% of bid side (20,000 resting ≥ 20,000 ✓) ≈ $1.71/day (event pool ÷ 27 markets) |
...
| `scc-senate-gop-2026-11-03-52` | BUY | 8.0¢ | 1 | 1 | $100.00 | ✅ scoring — ~34.0% of bid side (325,748 resting ≥ 5,000 ✓) ≈ $1.31/day (event pool ÷ 13 markets) |
...
| `vsc-usgubp-fl-fshbck-atl-15pct` | SELL | 21.0¢ | 4 | 0 | $500.00 | ✅ scoring — ~33.3% of ask side (28,996 resting ≥ 10,000 ✓) ≈ $8.32/day (event pool ÷ 10 markets) |
| `ewc-usp-2028-11-07-jossha` | SELL | 9.0¢ | 3 | 1 | $200.00 | ✅ scoring — ~28.3% of ask side (60,594 resting ≥ 20,000 ✓) ≈ $1.05/day (event pool ÷ 27 markets) |
| `ussewc-usse-sc-2026-11-03-rep` | SELL | 85.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~27.9% of ask side (8,804 resting ≥ 2,000 ✓) ≈ $1.74/day (event pool ÷ 2 markets) |
| …and 2063 more | | | | | | |
...
<details><summary><code>enwc-uspres-nom-dem-2028-rokha</code> SELL 3 @ 6¢ → $5.54/day</summary>
...
`yours 3.0 / Σ 3.2 = 94.2%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 94.2% = $5.54/day`  
...
<details><summary><code>vsc-usgubp-fl-fshbck-atl-9pct</code> SELL 2 @ 63¢ → $17.74/day</summary>
...
`yours 2.0 / Σ 2.8 = 71.0%`  
`$500 ÷ 10 ÷ 2 = $25.00 × 71.0% = $17.74/day`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-petbut</code> BUY 1 @ 11¢ → $4.04/day</summary>
...
<details><summary><code>erac-usgubp-ak-adv-2026-08-18-edndev</code> BUY 9,899 @ 1¢ → $8.93/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 14,579 (9,899 yours) | ×0.2^0 = 14,578.9 |
| | | **Σ** | **14,578.9** |

`yours 9,899.1 / Σ 14,578.9 = 67.9%`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-micoba</code> BUY 132 @ 8¢ → $2.86/day</summary>
...
`yours 132.0 / Σ 271.8 = 48.6%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 48.6% = $2.86/day`  
...
<details><summary><code>ewc-usp-2028-11-07-micoba</code> BUY 9,973 @ 1¢ → $1.79/day</summary>
...
<details><summary><code>enwc-ushrp-fl19-2026-08-18-catlau</code> BUY 2,000 @ 1¢ → $0.86/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 4,145 (2,000 yours) | ×0.1^0 = 4,145.0 |
| | | **Σ** | **4,145.0** |

`yours 2,000.0 / Σ 4,145.0 = 48.3%`  
`$25 ÷ 7 ÷ 2 = $1.79 × 48.3% = $0.86/day`  
...
<details><summary><code>ewc-usp-2028-11-07-micoba</code> BUY 9,546 @ 1¢ → $1.71/day</summary>
...
`yours 76.4 / Σ 165.0 = 46.3%`  
`$200 ÷ 27 ÷ 2 = $3.70 × 46.3% = $1.71/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-52</code> BUY 1 @ 8¢ → $1.31/day</summary>
...
<details><summary><code>vsc-usgubp-fl-fshbck-atl-15pct</code> SELL 4 @ 21¢ → $8.32/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 21¢ | 12 (4 yours) | ×0.2^0 = 12.0 |
|  | 26¢ | 6 | ×0.2^5 = 0.0 |
|  | 27¢ | 204 | ×0.2^6 = 0.0 |
|  | 29¢ | 3,535 | ×0.2^8 = 0.0 |
|  | 30¢ | 1,858 | ×0.2^9 = 0.0 |
...
|  | 33¢ | 281 | ×0.2^12 = 0.0 |
|  | 35¢ | 50 | ×0.2^14 = 0.0 |
|  | 99¢ | 22,204 | ×0.2^78 = 0.0 |
| | | **Σ** | **12.0** |

`yours 4.0 / Σ 12.0 = 33.3%`  
`$500 ÷ 10 ÷ 2 = $25.00 × 33.3% = $8.32/day`  
...
<details><summary><code>ewc-usp-2028-11-07-jossha</code> SELL 3 @ 9¢ → $1.05/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
|  | 8¢ | 1 | ×0.2^0 = 1.0 |
| ▶ | 9¢ | 3 (3 yours) | ×0.2^1 = 0.6 |
|  | 12¢ | 1 | ×0.2^4 = 0.0 |
|  | 13¢ | 4 | ×0.2^5 = 0.0 |
|  | 15¢ | 40,149 | ×0.2^7 = 0.5 |
| | | **Σ** | **2.1** |

`yours 0.6 / Σ 2.1 = 28.3%`  
`$200 ÷ 27 ÷ 2 = $3.70 × 28.3% = $1.05/day`  
...
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (36,825 resting) | ~9.6% | ~$2.39 |
| `enwc-usgubp-fl-2026-08-18-rep-byrdon` | $500.00 ÷ 3 | 0.20 | 10,000 | SELL side (43,233 resting) | ~2.1% | ~$1.73 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (290,702 resting) | ~2.3% | ~$1.73 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (556,169 resting) | ~6.6% | ~$1.65 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (5,876 resting) | ~5.4% | ~$1.35 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (91,032 resting) | ~19.4% | ~$1.21 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (84,230 resting) | ~1.6% | ~$1.16 |
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (76,517 resting) | ~1.5% | ~$1.13 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (94,414 resting) | ~1.4% | ~$1.05 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (69,134 resting) | ~1.0% | ~$0.78 |
| `ewc-usgub-wi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (1,254,410 resting) | ~11.3% | ~$0.71 |
