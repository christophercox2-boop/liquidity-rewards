...
## ✅ Last successful check: 2026-08-18 8:32 AM ET
...
**Earning right now:** ~$202.86/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-usgubp-ok-2026-06-16-rep-gendru` — BUY at the best price, ~$11.03/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$9.55/day), `ewc-usgub-oh-2026-11-03-dem` (~$1.80/day)
...
### Estimated earning rate: ~$202.86/day (~$8.45/hour)
...
| `ewc-usp-2028-11-07-elomus` | BUY | 8.0¢ | 3 | 0 | $200.00 | ✅ scoring — ~82.3% of bid side (54,001 resting ≥ 20,000 ✓) ≈ $3.05/day (event pool ÷ 27 markets) |
| `enwc-uspres-nom-dem-2028-jbpri` | SELL | 10.0¢ | 32 | 0 | $200.00 | ✅ scoring — ~75.8% of ask side (43,508 resting ≥ 20,000 ✓) ≈ $4.46/day (event pool ÷ 17 markets) |
...
| `vsc-usgubp-fl-fshbck-atl-9pct` | SELL | 64.0¢ | 2 | 0 | $500.00 | ✅ scoring — ~71.4% of ask side (15,714 resting ≥ 10,000 ✓) ≈ $17.85/day (event pool ÷ 10 markets) |
| `erac-usgubp-ak-adv-2026-08-18-despay` | BUY | 1.0¢ | 9,890 | 1 | $500.00 | ✅ scoring — ~70.3% of bid side (12,525 resting ≥ 10,000 ✓) ≈ $9.25/day (event pool ÷ 19 markets) |
...
| `erac-usgubp-ak-adv-2026-08-18-edndev` | BUY | 1.0¢ | 9,899 | 0 | $500.00 | ✅ scoring — ~65.8% of bid side (15,037 resting ≥ 10,000 ✓) ≈ $8.66/day (event pool ÷ 19 markets) |
| `ewc-usp-2028-11-07-gleyou` | SELL | 6.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~58.7% of ask side (60,962 resting ≥ 20,000 ✓) ≈ $2.17/day (event pool ÷ 27 markets) |
| `erac-usgubp-ak-adv-2026-08-18-shehug` | BUY | 1.0¢ | 8,774 | 0 | $500.00 | ✅ scoring — ~54.1% of bid side (16,230 resting ≥ 10,000 ✓) ≈ $7.11/day (event pool ÷ 19 markets) |
| `ewc-usp-2028-11-07-micoba` | BUY | 1.0¢ | 9,973 | 3 | $200.00 | ✅ scoring — ~48.6% of bid side (20,001 resting ≥ 20,000 ✓) ≈ $1.80/day (event pool ÷ 27 markets) |
| `ewc-usp-2028-11-07-micoba` | BUY | 1.0¢ | 9,546 | 3 | $200.00 | ✅ scoring — ~46.6% of bid side (20,001 resting ≥ 20,000 ✓) ≈ $1.72/day (event pool ÷ 27 markets) |
...
| `enwc-uspres-nom-dem-2028-micoba` | BUY | 1.0¢ | 9,253 | 1 | $200.00 | ✅ scoring — ~41.8% of bid side (22,000 resting ≥ 20,000 ✓) ≈ $2.46/day (event pool ÷ 17 markets) |
...
| `usgubewc-usgub-tx-2026-11-03-dem` | BUY | 14.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~40.6% of bid side (27,179 resting ≥ 2,000 ✓) ≈ $2.54/day (event pool ÷ 2 markets) |
...
<details><summary><code>enwc-uspres-nom-dem-2028-jbpri</code> SELL 32 @ 10¢ → $4.46/day</summary>
...
`yours 32.0 / Σ 42.2 = 75.8%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 75.8% = $4.46/day`  
...
<details><summary><code>vsc-usgubp-fl-fshbck-atl-9pct</code> SELL 2 @ 64¢ → $17.85/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 64¢ | 2 (2 yours) | ×0.2^0 = 2.0 |
|  | 65¢ | 4 | ×0.2^1 = 0.8 |
|  | 71¢ | 50 | ×0.2^7 = 0.0 |
|  | 72¢ | 12 | ×0.2^8 = 0.0 |
|  | 75¢ | 161 | ×0.2^11 = 0.0 |
|  | 93¢ | 50 | ×0.2^29 = 0.0 |
|  | 99¢ | 15,435 | ×0.2^35 = 0.0 |
| | | **Σ** | **2.8** |

`yours 2.0 / Σ 2.8 = 71.4%`  
`$500 ÷ 10 ÷ 2 = $25.00 × 71.4% = $17.85/day`  
...
<details><summary><code>erac-usgubp-ak-adv-2026-08-18-despay</code> BUY 9,890 @ 1¢ → $9.25/day</summary>
...
`yours 1,978.1 / Σ 2,812.7 = 70.3%`  
`$500 ÷ 19 ÷ 2 = $13.16 × 70.3% = $9.25/day`  
...
<details><summary><code>erac-usgubp-ak-adv-2026-08-18-edndev</code> BUY 9,899 @ 1¢ → $8.66/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 15,037 (9,899 yours) | ×0.2^0 = 15,037.0 |
| | | **Σ** | **15,037.0** |

`yours 9,899.1 / Σ 15,037.0 = 65.8%`  
`$500 ÷ 19 ÷ 2 = $13.16 × 65.8% = $8.66/day`  
...
<details><summary><code>ewc-usp-2028-11-07-gleyou</code> SELL 1 @ 6¢ → $2.17/day</summary>
...
<details><summary><code>erac-usgubp-ak-adv-2026-08-18-shehug</code> BUY 8,774 @ 1¢ → $7.11/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 16,230 (8,774 yours) | ×0.2^0 = 16,230.3 |
| | | **Σ** | **16,230.3** |

`yours 8,774.0 / Σ 16,230.3 = 54.1%`  
`$500 ÷ 19 ÷ 2 = $13.16 × 54.1% = $7.11/day`  
...
|  | 4¢ | 4 | ×0.2^0 = 4.0 |
|  | 2¢ | 1 | ×0.2^2 = 0.0 |
| ▶ | 1¢ | 19,996 (9,973 yours) | ×0.2^3 = 160.0 |
| | | **Σ** | **164.0** |

`yours 79.8 / Σ 164.0 = 48.6%`  
...
|  | 4¢ | 4 | ×0.2^0 = 4.0 |
|  | 2¢ | 1 | ×0.2^2 = 0.0 |
| ▶ | 1¢ | 19,996 (9,546 yours) | ×0.2^3 = 160.0 |
| | | **Σ** | **164.0** |

`yours 76.4 / Σ 164.0 = 46.6%`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-micoba</code> BUY 9,253 @ 1¢ → $2.46/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 2¢ | 30 | ×0.2^0 = 30.0 |
| ▶ | 1¢ | 21,970 (9,253 yours) | ×0.2^1 = 4,394.0 |
| | | **Σ** | **4,424.0** |

`yours 1,850.6 / Σ 4,424.0 = 41.8%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 41.8% = $2.46/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (26,910 resting) | ~44.1% | ~$11.03 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (60,248 resting) | ~38.2% | ~$9.55 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (289,093 resting) | ~2.4% | ~$1.80 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (632,439 resting) | ~6.7% | ~$1.67 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (6,760 resting) | ~6.0% | ~$1.50 |
| `enwc-usgubp-fl-2026-08-18-rep-byrdon` | $500.00 ÷ 3 | 0.20 | 10,000 | BUY side (667,721 resting) | ~1.6% | ~$1.34 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (90,522 resting) | ~18.7% | ~$1.17 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (83,952 resting) | ~1.6% | ~$1.16 |
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (76,487 resting) | ~1.5% | ~$1.13 |
| `ewc-usse-nc-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (52,149 resting) | ~4.4% | ~$1.11 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (94,491 resting) | ~1.4% | ~$1.03 |
| `enwc-usgubp-fl-2026-08-18-rep-jamfis` | $500.00 ÷ 3 | 0.20 | 10,000 | BUY side (20,532 resting) | ~1.0% | ~$0.80 |
