...
## ✅ Last successful check: 2026-08-10 12:24 AM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$344.11/day estimated (ceiling, not promise — details below)
...
### Estimated earning rate: ~$344.11/day (~$14.34/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `scc-senate-gop-2026-11-03-49` | SELL | 29.0¢ | 20 | 0 | $100.00 | ✅ scoring — ~100.0% of ask side (113,466 resting ≥ 5,000 ✓) ≈ $3.85/day (pool ÷ 13 markets) |
...
| `opdc-mcconnell-resign-2026-11-02` | SELL | 21.0¢ | 6 | 0 | $25.00 | ✅ scoring — ~98.4% of ask side (2,558 resting ≥ 2,000 ✓) ≈ $12.31/day |
...
| `ussewc-usse-la-2026-11-03-rep` | BUY | 55.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~80.0% of bid side (2,550 resting ≥ 2,000 ✓) ≈ $5.00/day (pool ÷ 2 markets) |
| `ussewc-usse-co-2026-11-03-dem` | BUY | 53.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~79.9% of bid side (2,190 resting ≥ 2,000 ✓) ≈ $5.00/day (pool ÷ 2 markets) |
| `ussewc-usse-ky-2026-11-03-rep` | BUY | 53.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~79.9% of bid side (2,190 resting ≥ 2,000 ✓) ≈ $5.00/day (pool ÷ 2 markets) |
| …and 194 more | | | | | | |

**Tap an order for its book window and the math:**

<details><summary><code>scc-senate-gop-2026-11-03-49</code> SELL 20 @ 29¢ → $3.85/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 29¢ | 20 (20 yours) | ×0.2^0 = 20.0 |
|  | 50¢ | 13 | ×0.2^21 = 0.0 |
|  | 96¢ | 25 | ×0.2^67 = 0.0 |
...
<details><summary><code>ussewc-usse-la-2026-11-03-rep</code> BUY 40 @ 55¢ → $5.00/day</summary>
...
<details><summary><code>ussewc-usse-co-2026-11-03-dem</code> BUY 40 @ 53¢ → $5.00/day</summary>
...
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,609 resting) | ~59.4% | ~$14.85 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (5,548 resting) | ~43.5% | ~$10.87 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (67,071 resting) | ~6.7% | ~$5.04 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (40,116 resting) | ~17.8% | ~$4.45 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (189,090 resting) | ~5.0% | ~$3.77 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (86,900 resting) | ~12.4% | ~$3.10 |
