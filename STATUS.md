...
## ✅ Last successful check: 2026-08-15 10:29 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/liquidity-rewards/actions/workflows/liquidity-rewards.yml).

> ⚠️ **2028-slate estimates are UNCALIBRATED and run HIGH.** Aug-14 actuals: nominees paid ~25% of tracked, winners ~10%, party markets ~1-5%. Every older family (races, Fed, sports) still reconciles ~100%. Divide slate numbers accordingly until the Aug-15 payout calibrates them.

## 📌 Summary

**Earning right now:** ~$1,017.27/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-nv-2026-11-03-rep` — SELL at the best price, ~$4.29/day for 200 contracts. Runners-up: `ewc-usse-oh-2026-11-03-dem` (~$4.14/day), `enwc-ussep-sc-2026-08-11-rep-darnor` (~$3.91/day)
...
### Estimated earning rate: ~$1,017.27/day (~$42.39/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `usgubewc-usgub-mn-2026-11-03-dem` | BUY | 87.0¢ | 10 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (580,226 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `ussewc-usse-ky-2026-11-03-rep` | BUY | 86.0¢ | 10 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,235 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `ussewc-usse-ms-2026-11-03-rep` | SELL | 90.0¢ | 15 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (2,979 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `enwc-uspres-nom-dem-2028-aleocc` | BUY | 26.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~99.5% of bid side (31,658 resting ≥ 20,000 ✓) ≈ $29.27/day (pool ÷ 17 markets) |
...
| `ewc-usp-2028-11-07-dontrujr` | BUY | 10.0¢ | 60 | 1 | $1,000.00 | ✅ scoring — ~97.9% of bid side (20,513 resting ≥ 20,000 ✓) ≈ $18.13/day (pool ÷ 27 markets) |
...
| `enwc-uspres-nom-dem-2028-gavnew` | SELL | 22.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~87.3% of ask side (65,501 resting ≥ 20,000 ✓) ≈ $25.67/day (pool ÷ 17 markets) |
...
| `ussewc-usse-fl-2026-11-03-dem` | SELL | 21.0¢ | 25 | 0 | $25.00 | ✅ scoring — ~82.8% of ask side (133,068 resting ≥ 2,000 ✓) ≈ $5.17/day (pool ÷ 2 markets) |
| `ewc-usp-2028-11-07-tulgab` | BUY | 10.0¢ | 60 | 1 | $1,000.00 | ✅ scoring — ~80.6% of bid side (20,518 resting ≥ 20,000 ✓) ≈ $14.92/day (pool ÷ 27 markets) |
| `ewc-usp-2028-11-07-stasmi` | BUY | 10.0¢ | 24 | 0 | $1,000.00 | ✅ scoring — ~80.0% of bid side (20,486 resting ≥ 20,000 ✓) ≈ $14.81/day (pool ÷ 27 markets) |
| `ewc-usp-2028-11-07-jossha` | BUY | 9.0¢ | 2 | 0 | $1,000.00 | ✅ scoring — ~79.4% of bid side (114,455 resting ≥ 20,000 ✓) ≈ $14.71/day (pool ÷ 27 markets) |
| `ewc-usp-2028-11-07-jamtal` | BUY | 18.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~76.9% of bid side (20,123 resting ≥ 20,000 ✓) ≈ $14.24/day (pool ÷ 27 markets) |
| …and 2616 more | | | | | | |

**Tap an order for its book window and the math:**

<details><summary><code>usgubewc-usgub-mn-2026-11-03-dem</code> BUY 10 @ 87¢ → $6.25/day</summary>
...
<details><summary><code>ussewc-usse-ky-2026-11-03-rep</code> BUY 10 @ 86¢ → $6.25/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 86¢ | 10 (10 yours) | ×0.1^0 = 10.0 |
|  | 40¢ | 25 | ×0.1^46 = 0.0 |
...
<details><summary><code>enwc-uspres-nom-dem-2028-aleocc</code> BUY 1 @ 26¢ → $29.27/day</summary>
...
`$1,000 ÷ 17 ÷ 2 = $29.41 × 99.5% = $29.27/day`  
...
<details><summary><code>ewc-usp-2028-11-07-dontrujr</code> BUY 60 @ 10¢ → $18.13/day</summary>
...
`yours 12.0 / Σ 12.3 = 97.9%`  
`$1,000 ÷ 27 ÷ 2 = $18.52 × 97.9% = $18.13/day`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-gavnew</code> SELL 1 @ 22¢ → $25.67/day</summary>
...
`$1,000 ÷ 17 ÷ 2 = $29.41 × 87.3% = $25.67/day`  
...
<details><summary><code>ussewc-usse-fl-2026-11-03-dem</code> SELL 25 @ 21¢ → $5.17/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-tulgab</code> BUY 60 @ 10¢ → $14.92/day</summary>
...
`$1,000 ÷ 27 ÷ 2 = $18.52 × 80.6% = $14.92/day`  
...
<details><summary><code>ewc-usp-2028-11-07-stasmi</code> BUY 24 @ 10¢ → $14.81/day</summary>
...
`$1,000 ÷ 27 ÷ 2 = $18.52 × 80.0% = $14.81/day`  
...
<details><summary><code>ewc-usp-2028-11-07-jossha</code> BUY 2 @ 9¢ → $14.71/day</summary>
...
`$1,000 ÷ 27 ÷ 2 = $18.52 × 79.4% = $14.71/day`  
...
<details><summary><code>ewc-usp-2028-11-07-jamtal</code> BUY 1 @ 18¢ → $14.24/day</summary>
...
`yours 1.0 / Σ 1.3 = 76.9%`  
`$1,000 ÷ 27 ÷ 2 = $18.52 × 76.9% = $14.24/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-nv-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (73,161 resting) | ~68.6% | ~$4.29 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (621,420 resting) | ~16.6% | ~$4.14 |
| `enwc-ussep-sc-2026-08-11-rep-darnor` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (263,851 resting) | ~62.5% | ~$3.91 |
| `ewc-usse-mi-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (628,032 resting) | ~46.3% | ~$2.89 |
| `ewc-usse-nh-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (48,807 resting) | ~31.4% | ~$1.97 |
| `ewc-usmayor-losang-2026-11-03-karbas` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (204,891 resting) | ~31.4% | ~$1.97 |
...
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (60,832 resting) | ~1.1% | ~$0.85 |
| `ewc-usgub-mi-2026-11-03-dem` | $25.00 ÷ 3 | 0.10 | 2,000 | SELL side (53,520 resting) | ~19.3% | ~$0.81 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (95,341 resting) | ~11.9% | ~$0.74 |
| `ewc-usgub-mi-2026-11-03-mikdug` | $25.00 ÷ 3 | 0.10 | 2,000 | SELL side (65,196 resting) | ~17.2% | ~$0.72 |
...
| 2026-08-15 9:52 PM ET | ✅ ok | 2381 | $3292.94 |
| 2026-08-15 9:50 PM ET | ✅ ok | 2381 | $3292.94 |
| 2026-08-15 9:40 PM ET | ✅ ok | 2381 | $3292.94 |
| 2026-08-15 9:35 PM ET | ✅ ok | 2381 | $3292.94 |
