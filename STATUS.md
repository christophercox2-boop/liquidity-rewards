...
## ✅ Last successful check: 2026-07-27 8:17 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$100.13/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-ussep-mi-2026-08-04-dem-abdels` — SELL at the best price, ~$48.07/day for 200 contracts. Runners-up: `enwc-ussep-mi-2026-08-04-dem-halste` (~$23.35/day), `enwc-ussep-mn-2026-08-11-dem-pegfla` (~$17.47/day)
...
### Estimated earning rate: ~$100.13/day (~$4.17/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `cranc-uspres28-12-31-2026-marrub` | SELL | 9.0¢ | 31 | 0 | $100.00 | ✅ scoring — ~100.0% of ask side (26,750 resting ≥ 5,000 ✓) ≈ $1.52/day (pool ÷ 33 markets) |
...
| `vmc-ussep-misen-2026-08-04-els0-5` | SELL | 27.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~99.9% of ask side (99,545 resting ≥ 2,000 ✓) ≈ $1.25/day (pool ÷ 10 markets) |
| `scc-senate-gop-2026-11-03-50` | BUY | 13.0¢ | 100 | 0 | $100.00 | ✅ scoring — ~83.3% of bid side (207,318 resting ≥ 5,000 ✓) ≈ $3.20/day (pool ÷ 13 markets) |
| `iarc-group-2026-12-31-joebid` | BUY | 4.0¢ | 200 | 1 | $25.00 | ✅ scoring — ~78.3% of bid side (35,677 resting ≥ 2,000 ✓) ≈ $0.98/day (pool ÷ 10 markets) |
| `vmc-ussep-misen-2026-08-04-els10-15` | SELL | 22.0¢ | 30 | 0 | $25.00 | ✅ scoring — ~75.0% of ask side (61,759 resting ≥ 2,000 ✓) ≈ $0.94/day (pool ÷ 10 markets) |
| `cranc-uspres28-12-31-2026-krinoe` | BUY | 6.0¢ | 200 | 1 | $100.00 | ✅ scoring — ~74.9% of bid side (30,697 resting ≥ 5,000 ✓) ≈ $1.14/day (pool ÷ 33 markets) |
| `scc-senate-gop-2026-11-03-46` | BUY | 9.0¢ | 100 | 1 | $100.00 | ✅ scoring — ~74.0% of bid side (50,584 resting ≥ 5,000 ✓) ≈ $2.85/day (pool ÷ 13 markets) |
| `scc-senate-gop-2026-11-03-47` | BUY | 9.0¢ | 100 | 1 | $100.00 | ✅ scoring — ~73.9% of bid side (100,584 resting ≥ 5,000 ✓) ≈ $2.84/day (pool ÷ 13 markets) |
| `scc-senate-gop-2026-11-03-53` | BUY | 9.0¢ | 100 | 1 | $100.00 | ✅ scoring — ~73.9% of bid side (120,584 resting ≥ 5,000 ✓) ≈ $2.84/day (pool ÷ 13 markets) |
...
| `mlaec-isrpol-pm-2026-10-27-yailap` | BUY | 4.0¢ | 100 | 1 | $25.00 | ✅ scoring — ~70.2% of bid side (22,574 resting ≥ 2,000 ✓) ≈ $0.88/day (pool ÷ 10 markets) |
...
| `scc-senate-gop-2026-11-03-55` | BUY | 8.0¢ | 100 | 2 | $100.00 | ✅ scoring — ~64.5% of bid side (10,584 resting ≥ 5,000 ✓) ≈ $2.48/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte235` | BUY | 8.0¢ | 100 | 2 | $100.00 | ✅ scoring — ~64.4% of bid side (22,399 resting ≥ 5,000 ✓) ≈ $2.68/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-56` | BUY | 8.0¢ | 100 | 2 | $100.00 | ✅ scoring — ~64.3% of bid side (30,584 resting ≥ 5,000 ✓) ≈ $2.47/day (pool ÷ 13 markets) |
| `scc-senate-gop-2026-11-03-gte57` | BUY | 8.0¢ | 100 | 2 | $100.00 | ✅ scoring — ~64.3% of bid side (30,584 resting ≥ 5,000 ✓) ≈ $2.47/day (pool ÷ 13 markets) |
| `scc-senate-gop-2026-11-03-54` | BUY | 8.0¢ | 100 | 2 | $100.00 | ✅ scoring — ~56.8% of bid side (70,584 resting ≥ 5,000 ✓) ≈ $2.19/day (pool ÷ 13 markets) |
| `scc-senate-gop-2026-11-03-lte45` | BUY | 8.0¢ | 100 | 2 | $100.00 | ✅ scoring — ~56.8% of bid side (70,584 resting ≥ 5,000 ✓) ≈ $2.19/day (pool ÷ 13 markets) |
...
| `scc-senate-gop-2026-11-03-49` | BUY | 8.0¢ | 100 | 2 | $100.00 | ✅ scoring — ~56.2% of bid side (220,584 resting ≥ 5,000 ✓) ≈ $2.16/day (pool ÷ 13 markets) |
| `cranc-uspres28-12-31-2026-erikir` | BUY | 8.0¢ | 100 | 2 | $100.00 | ✅ scoring — ~55.4% of bid side (17,115 resting ≥ 5,000 ✓) ≈ $0.84/day (pool ÷ 33 markets) |
| `cranc-uspres28-12-31-2026-markel` | BUY | 7.0¢ | 200 | 1 | $100.00 | ✅ scoring — ~53.4% of bid side (70,716 resting ≥ 5,000 ✓) ≈ $0.81/day (pool ÷ 33 markets) |
...
| `scc-senate-gop-2026-11-03-52` | BUY | 9.0¢ | 100 | 0 | $100.00 | ✅ scoring — ~42.6% of bid side (60,807 resting ≥ 5,000 ✓) ≈ $1.64/day (pool ÷ 13 markets) |
...
<details><summary><code>vmc-ussep-misen-2026-08-04-els10-15</code> SELL 30 @ 22¢ → $0.94/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 22¢ | 40 (30 yours) | ×0.1^0 = 40.0 |
|  | 28¢ | 34 | ×0.1^6 = 0.0 |
|  | 29¢ | 100 | ×0.1^7 = 0.0 |
|  | 30¢ | 2 | ×0.1^8 = 0.0 |
|  | 45¢ | 25 | ×0.1^23 = 0.0 |
...
<details><summary><code>scc-senate-gop-2026-11-03-55</code> BUY 100 @ 8¢ → $2.48/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte235</code> BUY 100 @ 8¢ → $2.68/day</summary>
...
<details><summary><code>scc-senate-gop-2026-11-03-lte45</code> BUY 100 @ 8¢ → $2.19/day</summary>
...
<details><summary><code>cranc-uspres28-12-31-2026-erikir</code> BUY 100 @ 8¢ → $0.84/day</summary>
...
`yours 4.0 / Σ 7.2 = 55.4%`  
`$100 ÷ 33 ÷ 2 = $1.52 × 55.4% = $0.84/day`  
...
<details><summary><code>cranc-uspres28-12-31-2026-markel</code> BUY 200 @ 7¢ → $0.81/day</summary>
...
`yours 40.0 / Σ 74.9 = 53.4%`  
`$100 ÷ 33 ÷ 2 = $1.52 × 53.4% = $0.81/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-52</code> BUY 100 @ 9¢ → $1.64/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 9¢ | 230 (100 yours) | ×0.2^0 = 230.0 |
|  | 7¢ | 100 | ×0.2^2 = 4.0 |
|  | 5¢ | 2 | ×0.2^4 = 0.0 |
|  | 2¢ | 60,250 | ×0.2^7 = 0.8 |
| | | **Σ** | **234.8** |

`yours 100.0 / Σ 234.8 = 42.6%`  
...
|---|---:|---:|---:|---|---:|---:|
| `enwc-ussep-mi-2026-08-04-dem-abdels` | $300.00 ÷ 3 | 0.20 | 10,000 | SELL side (77,354 resting) | ~96.1% | ~$48.07 |
...
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (77,882 resting) | ~11.6% | ~$8.69 |
| `ewc-usse-tx-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (96,734 resting) | ~10.5% | ~$7.86 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (80,677 resting) | ~8.8% | ~$6.57 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (150,537 resting) | ~6.8% | ~$5.14 |
| `ewc-usse-tx-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (88,777 resting) | ~6.4% | ~$4.77 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (94,036 resting) | ~4.5% | ~$3.38 |
