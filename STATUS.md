...
## ✅ Last successful check: 2026-08-16 8:09 AM ET
...
**Earning right now:** ~$462.23/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usse-oh-2026-11-03-dem` — BUY at the best price, ~$10.33/day for 200 contracts. Runners-up: `enwc-ussep-sc-2026-08-11-rep-darnor` (~$6.10/day), `apdc-jerpowgov-2026-08-31` (~$4.10/day)
...
### Estimated earning rate: ~$462.23/day (~$19.26/hour)
...
| `ussewc-usse-sc-2026-11-03-dem` | BUY | 40.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (2,414 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-ky-2026-11-03-rep` | SELL | 85.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (2,510 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-fl-2026-11-03-dem` | BUY | 30.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (10,314 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-va-2026-11-03-rep` | SELL | 2.0¢ | 30 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (65,509 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `usgubewc-usgub-or-2026-11-03-dem` | BUY | 40.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (600,203 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
| `ussewc-usse-fl-2026-11-03-dem` | BUY | 15.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~99.8% of bid side (50,463 resting ≥ 2,000 ✓) ≈ $6.24/day (pool ÷ 2 markets) |
| `ewc-usgub-nv-2026-11-03-dem` | BUY | 46.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~99.0% of bid side (2,073 resting ≥ 2,000 ✓) ≈ $6.19/day (pool ÷ 2 markets) |
| `usgubewc-usgub-or-2026-11-03-rep` | BUY | 20.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~99.0% of bid side (2,400 resting ≥ 2,000 ✓) ≈ $6.19/day (pool ÷ 2 markets) |
...
| `ussewc-usse-tn-2026-11-03-dem` | BUY | 8.0¢ | 75 | 0 | $25.00 | ✅ scoring — ~98.7% of bid side (10,300 resting ≥ 2,000 ✓) ≈ $6.17/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-51` | BUY | 13.0¢ | 7 | 0 | $100.00 | ✅ scoring — ~97.1% of bid side (300,506 resting ≥ 5,000 ✓) ≈ $3.74/day (pool ÷ 13 markets) |
| `enwc-uspres-nom-dem-2028-jamtal` | BUY | 11.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~95.1% of bid side (110,562 resting ≥ 20,000 ✓) ≈ $7.93/day (program pool ÷ 60 markets) |
...
| `usgubewc-usgub-id-2026-11-03-rep` | SELL | 96.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~85.6% of ask side (3,013 resting ≥ 2,000 ✓) ≈ $5.35/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-il-2026-11-03-rep` | SELL | 9.0¢ | 75 | 0 | $25.00 | ✅ scoring — ~83.3% of ask side (208,478 resting ≥ 2,000 ✓) ≈ $5.21/day (pool ÷ 2 markets) |
| `ussewc-usse-ms-2026-11-03-rep` | SELL | 90.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~83.3% of ask side (2,729 resting ≥ 2,000 ✓) ≈ $5.20/day (pool ÷ 2 markets) |
| `usgubewc-usgub-al-2026-11-03-dem` | SELL | 14.0¢ | 50 | 0 | $25.00 | ✅ scoring — ~75.3% of ask side (133,733 resting ≥ 2,000 ✓) ≈ $4.71/day (pool ÷ 2 markets) |
...
<details><summary><code>usgubewc-usgub-or-2026-11-03-dem</code> BUY 1 @ 40¢ → $6.25/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 40¢ | 1 (1 yours) | ×0.1^0 = 1.0 |
|  | 36¢ | 2 | ×0.1^4 = 0.0 |
|  | 2¢ | 600,000 | ×0.1^38 = 0.0 |
| | | **Σ** | **1.0** |
...
<details><summary><code>ewc-usgub-nv-2026-11-03-dem</code> BUY 1 @ 46¢ → $6.19/day</summary>
...
<details><summary><code>ussewc-usse-tn-2026-11-03-dem</code> BUY 75 @ 8¢ → $6.17/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 8¢ | 76 (75 yours) | ×0.1^0 = 76.0 |
|  | 3¢ | 23 | ×0.1^5 = 0.0 |
|  | 2¢ | 1 | ×0.1^6 = 0.0 |
|  | 1¢ | 10,200 | ×0.1^7 = 0.0 |
| | | **Σ** | **76.0** |

`yours 75.0 / Σ 76.0 = 98.7%`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-jamtal</code> BUY 1 @ 11¢ → $7.93/day</summary>
...
<details><summary><code>usgubewc-usgub-id-2026-11-03-rep</code> SELL 40 @ 96¢ → $5.35/day</summary>
...
`yours 40.0 / Σ 46.8 = 85.6%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 85.6% = $5.35/day`  
...
<details><summary><code>ussewc-usse-ms-2026-11-03-rep</code> SELL 1 @ 90¢ → $5.20/day</summary>
...
<details><summary><code>usgubewc-usgub-al-2026-11-03-dem</code> SELL 50 @ 14¢ → $4.71/day</summary>
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (550,899 resting) | ~41.3% | ~$10.33 |
| `enwc-ussep-sc-2026-08-11-rep-darnor` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (263,736 resting) | ~97.6% | ~$6.10 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (6,843 resting) | ~16.4% | ~$4.10 |
| `ewc-usse-nh-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (2,553 resting) | ~35.5% | ~$2.22 |
| `ewc-usse-mi-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (552,188 resting) | ~32.3% | ~$2.02 |
...
| `ewc-usse-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (16,356 resting) | ~1.7% | ~$1.29 |
| `ewc-usse-nh-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (2,202 resting) | ~15.6% | ~$0.97 |
| `ewc-usse-mi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (552,324 resting) | ~15.6% | ~$0.97 |
