...
## ✅ Last successful check: 2026-08-05 6:29 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$21.05/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usse-tx-2026-11-03-rep` — BUY at the best price, ~$12.07/day for 200 contracts. Runners-up: `ewc-usgub-ca-2026-11-03-xavbec` (~$10.80/day), `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$9.81/day)
...
### Estimated earning rate: ~$21.05/day (~$0.88/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `scc-senate-gop-2026-11-03-50` | SELL | 40.0¢ | 42 | 0 | $100.00 | ✅ scoring — ~72.3% of ask side (113,629 resting ≥ 5,000 ✓) ≈ $2.78/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte185` | SELL | 75.0¢ | 61 | 0 | $100.00 | ✅ scoring — ~63.1% of ask side (5,935 resting ≥ 5,000 ✓) ≈ $2.63/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte205` | SELL | 48.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~34.5% of ask side (48,590 resting ≥ 5,000 ✓) ≈ $1.44/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte200` | BUY | 51.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~25.6% of bid side (80,500 resting ≥ 5,000 ✓) ≈ $1.07/day (pool ÷ 12 markets) |
| `scc-hrep-rep-2026-11-03-gte190` | BUY | 85.0¢ | 28 | 0 | $100.00 | ✅ scoring — ~25.6% of bid side (80,318 resting ≥ 5,000 ✓) ≈ $1.06/day (pool ÷ 12 markets) |
| `tec-cbb-champ-2027-04-05-w-nebr` | BUY | 1.0¢ | 1,000 | 1 | $500.00 | ✅ scoring — ~18.5% of bid side (4,949 resting ≥ 2,500 ✓) ≈ $0.63/day (pool ÷ 73 markets) |
| `apdc-alito-2026-12-31` | BUY | 18.0¢ | 150 | 0 | $100.00 | ✅ scoring — ~17.6% of bid side (7,325 resting ≥ 5,000 ✓) ≈ $4.41/day (pool ÷ 2 markets) |
| `scc-hrep-rep-2026-11-03-gte220` | SELL | 15.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~16.2% of ask side (49,684 resting ≥ 5,000 ✓) ≈ $0.68/day (pool ÷ 12 markets) |
| `scc-hrep-rep-2026-11-03-gte180` | SELL | 88.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~10.7% of ask side (47,853 resting ≥ 5,000 ✓) ≈ $0.45/day (pool ÷ 12 markets) |
| `scc-hrep-rep-2026-11-03-gte225` | BUY | 10.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~8.9% of bid side (80,671 resting ≥ 5,000 ✓) ≈ $0.37/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-51` | BUY | 18.0¢ | 15 | 2 | $100.00 | ✅ scoring — ~7.9% of bid side (200,510 resting ≥ 5,000 ✓) ≈ $0.30/day (pool ÷ 13 markets) |
...
| `scc-senate-gop-2026-11-03-53` | BUY | 8.0¢ | 29 | 1 | $100.00 | ✅ scoring — ~6.5% of bid side (11,117 resting ≥ 5,000 ✓) ≈ $0.25/day (pool ÷ 13 markets) |
...
| `scc-senate-gop-2026-11-03-56` | BUY | 5.0¢ | 133 | 0 | $100.00 | ✅ scoring — ~3.7% of bid side (54,886 resting ≥ 5,000 ✓) ≈ $0.14/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte220` | BUY | 14.0¢ | 12 | 0 | $100.00 | ✅ scoring — ~3.6% of bid side (87,762 resting ≥ 5,000 ✓) ≈ $0.15/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-56` | BUY | 4.0¢ | 500 | 1 | $100.00 | ✅ scoring — ~2.8% of bid side (54,886 resting ≥ 5,000 ✓) ≈ $0.11/day (pool ÷ 13 markets) |
| `scc-senate-gop-2026-11-03-lte45` | SELL | 8.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~2.7% of ask side (59,135 resting ≥ 5,000 ✓) ≈ $0.10/day (pool ÷ 13 markets) |
...
| `tec-cbb-champ-2027-04-05-w-mst` | BUY | 7.0¢ | 5 | 0 | $500.00 | ✅ scoring — ~1.7% of bid side (103,559 resting ≥ 2,500 ✓) ≈ $0.06/day (pool ÷ 73 markets) |
| `scc-senate-gop-2026-11-03-46` | BUY | 3.0¢ | 500 | 0 | $100.00 | ✅ scoring — ~1.3% of bid side (49,101 resting ≥ 5,000 ✓) ≈ $0.05/day (pool ÷ 13 markets) |
| `ewc-usse-oh-2026-11-03-rep` | BUY | 48.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~1.1% of bid side (92,548 resting ≥ 5,000 ✓) ≈ $0.28/day (pool ÷ 2 markets) |
...
| `ewc-usse-tx-2026-11-03-dem` | BUY | 47.0¢ | 50 | 0 | $300.00 | ✅ scoring — ~0.2% of bid side (393,627 resting ≥ 10,000 ✓) ≈ $0.16/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-46` | BUY | 3.0¢ | 45 | 0 | $100.00 | ✅ scoring — ~0.1% of bid side (49,101 resting ≥ 5,000 ✓) ≈ $0.00/day (pool ÷ 13 markets) |
| …and 11 more | | | | | | |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte185</code> SELL 61 @ 75¢ → $2.63/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 75¢ | 94 (61 yours) | ×0.2^0 = 94.5 |
|  | 77¢ | 22 | ×0.2^2 = 0.9 |
|  | 78¢ | 161 | ×0.2^3 = 1.3 |
|  | 99¢ | 5,658 | ×0.2^24 = 0.0 |
| | | **Σ** | **96.7** |

`yours 61.0 / Σ 96.7 = 63.1%`  
`$100 ÷ 12 ÷ 2 = $4.17 × 63.1% = $2.63/day`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte190</code> BUY 28 @ 85¢ → $1.06/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 85¢ | 110 (28 yours) | ×0.2^0 = 109.6 |
|  | 2¢ | 80,008 | ×0.2^83 = 0.0 |
| | | **Σ** | **109.6** |

`yours 28.0 / Σ 109.6 = 25.6%`  
`$100 ÷ 12 ÷ 2 = $4.17 × 25.6% = $1.06/day`  
...
|---|---:|---:|---:|
|  | 2¢ | 250 | ×0.35^0 = 250.0 |
| ▶ | 1¢ | 4,699 (1,000 yours) | ×0.35^1 = 1,644.6 |
| | | **Σ** | **1,894.6** |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte225</code> BUY 10 @ 10¢ → $0.37/day</summary>
...
<details><summary><code>scc-senate-gop-2026-11-03-51</code> BUY 15 @ 18¢ → $0.30/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 20¢ | 7 | ×0.2^0 = 7.0 |
| ▶ | 18¢ | 15 (15 yours) | ×0.2^2 = 0.6 |
|  | 6¢ | 2 | ×0.2^14 = 0.0 |
|  | 5¢ | 50 | ×0.2^15 = 0.0 |
|  | 1¢ | 200,435 | ×0.2^19 = 0.0 |
| | | **Σ** | **7.6** |
...
<details><summary><code>scc-senate-gop-2026-11-03-53</code> BUY 29 @ 8¢ → $0.25/day</summary>
...
| ▶ | 4¢ | 1,322 (500 yours) | ×0.2^1 = 264.4 |
|  | 3¢ | 436 | ×0.2^2 = 17.4 |
|  | 2¢ | 49,980 | ×0.2^3 = 399.8 |
| | | **Σ** | **3,629.7** |

`yours 100.0 / Σ 3,629.7 = 2.8%`  
...
| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 8¢ | 1,867 (50 yours) | ×0.2^0 = 1,867.0 |
|  | 50¢ | 100 | ×0.2^42 = 0.0 |
|  | 97¢ | 45,967 | ×0.2^89 = 0.0 |
| | | **Σ** | **1,867.0** |

`yours 50.0 / Σ 1,867.0 = 2.7%`  
`$100 ÷ 13 ÷ 2 = $3.85 × 2.7% = $0.10/day`  
...
|  | 4¢ | 500 | ×0.35^3 = 21.4 |
|  | 2¢ | 48 | ×0.35^5 = 0.3 |
|  | 1¢ | 102,843 | ×0.35^6 = 189.1 |
| | | **Σ** | **290.9** |

`yours 5.0 / Σ 290.9 = 1.7%`  
`$500 ÷ 73 ÷ 2 = $3.42 × 1.7% = $0.06/day`  
...
| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 3¢ | 38,901 (500 yours) | ×0.2^0 = 38,901.0 |
| | | **Σ** | **38,901.0** |

`yours 500.0 / Σ 38,901.0 = 1.3%`  
...
| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 48¢ | 3,221 (50 yours) | ×0.2^0 = 3,221.0 |
|  | 47¢ | 6,507 | ×0.2^1 = 1,301.4 |
| | | **Σ** | **4,522.4** |

`yours 50.0 / Σ 4,522.4 = 1.1%`  
...
<details><summary><code>ewc-usse-tx-2026-11-03-dem</code> BUY 50 @ 47¢ → $0.16/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 47¢ | 23,406 (50 yours) | ×0.2^0 = 23,406.0 |
| | | **Σ** | **23,406.0** |

`yours 50.0 / Σ 23,406.0 = 0.2%`  
`$300 ÷ 2 ÷ 2 = $75.00 × 0.2% = $0.16/day`  
...
| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 3¢ | 38,901 (45 yours) | ×0.2^0 = 38,901.0 |
| | | **Σ** | **38,901.0** |

`yours 45.0 / Σ 38,901.0 = 0.1%`  
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usse-tx-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (280,379 resting) | ~16.1% | ~$12.07 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (79,780 resting) | ~14.4% | ~$10.80 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,546 resting) | ~39.2% | ~$9.81 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,253 resting) | ~27.9% | ~$6.98 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (65,359 resting) | ~7.9% | ~$5.94 |
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (93,705 resting) | ~5.8% | ~$4.32 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (46,328 resting) | ~14.1% | ~$3.51 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (107,044 resting) | ~2.2% | ~$1.67 |
| `ewc-usse-me-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (182,156 resting) | ~2.1% | ~$1.59 |
| `cranc-uspres28-12-31-2026-dontru` | $100.00 ÷ 33 | 0.20 | 5,000 | BUY side (50,525 resting) | ~95.3% | ~$1.44 |
| `cranc-uspres28-12-31-2026-jdvan` | $100.00 ÷ 33 | 0.20 | 5,000 | BUY side (75,709 resting) | ~94.0% | ~$1.42 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (115,362 resting) | ~1.8% | ~$1.34 |
