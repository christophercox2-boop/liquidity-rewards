...
## ✅ Last successful check: 2026-08-18 8:14 PM ET
...
**Earning right now:** ~$271.02/day estimated (ceiling, not promise — details below)
...
### Estimated earning rate: ~$271.02/day (~$11.29/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `usgubewc-usgub-ma-2026-11-03-dem` | BUY | 92.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (2,246 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-la-2026-11-03-rep` | BUY | 91.0¢ | 4 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,224 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-tn-2026-11-03-rep` | BUY | 94.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (2,013 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-ar-2026-11-03-dem` | SELL | 6.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~99.0% of ask side (130,731 resting ≥ 2,000 ✓) ≈ $6.19/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-sc-2026-11-03-dem` | BUY | 12.0¢ | 10 | 0 | $25.00 | ✅ scoring — ~93.0% of bid side (2,030 resting ≥ 2,000 ✓) ≈ $5.81/day (event pool ÷ 2 markets) |
...
| `enwc-uspres-nom-dem-2028-jamtal` | SELL | 5.0¢ | 25 | 0 | $200.00 | ✅ scoring — ~71.4% of ask side (38,331 resting ≥ 20,000 ✓) ≈ $4.20/day (event pool ÷ 17 markets) |
...
| `usgubewc-usgub-nm-2026-11-03-dem` | BUY | 94.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~58.8% of bid side (500,228 resting ≥ 2,000 ✓) ≈ $3.68/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-tx-2026-11-03-dem` | BUY | 14.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~53.3% of bid side (17,120 resting ≥ 2,000 ✓) ≈ $3.33/day (event pool ÷ 2 markets) |
...
<details><summary><code>ussewc-usse-sc-2026-11-03-dem</code> BUY 10 @ 12¢ → $5.81/day</summary>
...
<details><summary><code>usgubewc-usgub-nm-2026-11-03-dem</code> BUY 3 @ 94¢ → $3.68/day</summary>
...
<details><summary><code>usgubewc-usgub-tx-2026-11-03-dem</code> BUY 3 @ 14¢ → $3.33/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 14¢ | 6 (3 yours) | ×0.1^0 = 6.4 |
|  | 10¢ | 1 | ×0.1^4 = 0.0 |
|  | 7¢ | 16 | ×0.1^7 = 0.0 |
|  | 2¢ | 15,000 | ×0.1^12 = 0.0 |
| | | **Σ** | **6.4** |

`yours 3.4 / Σ 6.4 = 53.3%`  
...
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (271,045 resting) | ~6.0% | ~$4.54 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (78,802 resting) | ~49.7% | ~$3.11 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (286,093 resting) | ~3.8% | ~$2.88 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (633,377 resting) | ~9.8% | ~$2.44 |
...
| `ewc-usgub-ks-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (81,424 resting) | ~19.1% | ~$1.20 |
