...
## ✅ Last successful check: 2026-08-15 9:40 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$937.64/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usse-oh-2026-11-03-dem` — BUY at the best price, ~$6.54/day for 200 contracts. Runners-up: `ewc-usgub-wi-2026-11-03-dem` (~$4.97/day), `ewc-usgub-nv-2026-11-03-rep` (~$4.31/day)
...
### Estimated earning rate: ~$937.64/day (~$39.07/hour)
...
| `ussewc-usse-ms-2026-11-03-rep` | SELL | 90.0¢ | 15 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (2,420 resting ≥ 2,000 ✓) ≈ $6.25/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-id-2026-11-03-rep` | SELL | 96.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~82.8% of ask side (7,419 resting ≥ 2,000 ✓) ≈ $5.17/day (pool ÷ 2 markets) |
...
| `usgubewc-usgub-al-2026-11-03-dem` | SELL | 14.0¢ | 50 | 0 | $25.00 | ✅ scoring — ~79.4% of ask side (133,761 resting ≥ 2,000 ✓) ≈ $4.96/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-53` | BUY | 7.0¢ | 25 | 0 | $100.00 | ✅ scoring — ~73.9% of bid side (90,502 resting ≥ 5,000 ✓) ≈ $2.84/day (pool ÷ 13 markets) |
| `ussewc-usse-ms-2026-11-03-dem` | SELL | 16.0¢ | 50 | 0 | $25.00 | ✅ scoring — ~72.5% of ask side (66,044 resting ≥ 2,000 ✓) ≈ $4.53/day (pool ÷ 2 markets) |
| …and 2613 more | | | | | | |
...
<details><summary><code>usgubewc-usgub-id-2026-11-03-rep</code> SELL 40 @ 96¢ → $5.17/day</summary>
...
<details><summary><code>usgubewc-usgub-al-2026-11-03-dem</code> SELL 50 @ 14¢ → $4.96/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 14¢ | 63 (50 yours) | ×0.1^0 = 63.0 |
|  | 22¢ | 602 | ×0.1^8 = 0.0 |
|  | 25¢ | 53 | ×0.1^11 = 0.0 |
|  | 98¢ | 132,818 | ×0.1^84 = 0.0 |
| | | **Σ** | **63.0** |

`yours 50.0 / Σ 63.0 = 79.4%`  
...
<details><summary><code>ussewc-usse-ms-2026-11-03-dem</code> SELL 50 @ 16¢ → $4.53/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 16¢ | 69 (50 yours) | ×0.1^0 = 69.0 |
|  | 45¢ | 500 | ×0.1^29 = 0.0 |
|  | 98¢ | 65,250 | ×0.1^82 = 0.0 |
| | | **Σ** | **69.0** |

`yours 50.0 / Σ 69.0 = 72.5%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 72.5% = $4.53/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (550,764 resting) | ~26.2% | ~$6.54 |
| `ewc-usgub-wi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (294,337 resting) | ~79.5% | ~$4.97 |
| `ewc-usgub-nv-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (3,015 resting) | ~69.0% | ~$4.31 |
| `ewc-usse-mi-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (552,344 resting) | ~47.1% | ~$2.94 |
| `ewc-usmayor-losang-2026-11-03-nitram` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (204,977 resting) | ~28.6% | ~$1.79 |
| `ewc-usmayor-losang-2026-11-03-karbas` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (204,963 resting) | ~27.9% | ~$1.74 |
| `ewc-usgub-mi-2026-11-03-mikdug` | $25.00 ÷ 3 | 0.10 | 2,000 | SELL side (3,184 resting) | ~39.7% | ~$1.65 |
| `ewc-usse-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (14,713 resting) | ~1.9% | ~$1.42 |
| `enwc-ussep-sc-2026-08-11-rep-darnor` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (269,108 resting) | ~22.0% | ~$1.37 |
| `ewc-usse-nh-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (2,332 resting) | ~17.5% | ~$1.09 |
| `ewc-usgub-mi-2026-11-03-dem` | $25.00 ÷ 3 | 0.10 | 2,000 | SELL side (3,459 resting) | ~21.4% | ~$0.89 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (1,918 resting) | ~13.8% | ~$0.87 |
