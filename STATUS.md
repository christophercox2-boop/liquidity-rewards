...
## ✅ Last successful check: 2026-08-09 4:22 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$147.50/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-ca-2026-11-03-stehil` — SELL at the best price, ~$36.43/day for 200 contracts. Runners-up: `ewc-usgub-ca-2026-11-03-xavbec` (~$17.33/day), `apdc-jerpowgov-2026-08-31` (~$15.97/day)
...
### Estimated earning rate: ~$147.50/day (~$6.15/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `apdc-jerpowgov-2026-12-31` | BUY | 28.0¢ | 20 | 0 | $100.00 | ✅ scoring — ~99.9% of bid side (5,427 resting ≥ 5,000 ✓) ≈ $24.99/day (pool ÷ 2 markets) |
...
| `apdc-jerpowgov-2026-12-31` | SELL | 35.0¢ | 15 | 0 | $100.00 | ✅ scoring — ~89.5% of ask side (5,784 resting ≥ 5,000 ✓) ≈ $22.37/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-53` | BUY | 13.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~86.7% of bid side (10,712 resting ≥ 5,000 ✓) ≈ $3.33/day (pool ÷ 13 markets) |
| `tec-cbb-champ-2027-04-05-w-uconn` | BUY | 14.0¢ | 2 | 0 | $500.00 | ✅ scoring — ~80.3% of bid side (7,713 resting ≥ 2,500 ✓) ≈ $2.75/day (pool ÷ 73 markets) |
...
| `scc-hrep-rep-2026-11-03-gte190` | BUY | 71.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~71.4% of bid side (80,188 resting ≥ 5,000 ✓) ≈ $2.97/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-48` | SELL | 20.0¢ | 23 | 0 | $100.00 | ✅ scoring — ~57.8% of ask side (99,366 resting ≥ 5,000 ✓) ≈ $2.22/day (pool ÷ 13 markets) |
...
| `tec-cbb-champ-2027-04-05-w-iowast` | BUY | 1.0¢ | 2,500 | 4 | $500.00 | ✅ scoring — ~43.8% of bid side (3,062 resting ≥ 2,500 ✓) ≈ $1.50/day (pool ÷ 73 markets) |
| `scc-hrep-rep-2026-11-03-gte195` | BUY | 50.0¢ | 25 | 0 | $100.00 | ✅ scoring — ~39.6% of bid side (80,735 resting ≥ 5,000 ✓) ≈ $1.65/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte195` | BUY | 49.0¢ | 115 | 1 | $100.00 | ✅ scoring — ~36.5% of bid side (80,735 resting ≥ 5,000 ✓) ≈ $1.52/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-49` | BUY | 19.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~34.6% of bid side (50,760 resting ≥ 5,000 ✓) ≈ $1.33/day (pool ÷ 13 markets) |
...
<details><summary><code>apdc-jerpowgov-2026-12-31</code> BUY 20 @ 28¢ → $24.99/day</summary>
...
`yours 2.0 / Σ 2.5 = 80.3%`  
`$500 ÷ 73 ÷ 2 = $3.42 × 80.3% = $2.75/day`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte190</code> BUY 10 @ 71¢ → $2.97/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 71¢ | 14 (10 yours) | ×0.2^0 = 14.0 |
|  | 3¢ | 33 | ×0.2^68 = 0.0 |
|  | 2¢ | 79,941 | ×0.2^69 = 0.0 |
| | | **Σ** | **14.0** |
...
<details><summary><code>scc-senate-gop-2026-11-03-48</code> SELL 23 @ 20¢ → $2.22/day</summary>
...
<details><summary><code>tec-cbb-champ-2027-04-05-w-iowast</code> BUY 2,500 @ 1¢ → $1.50/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 5¢ | 13 | ×0.35^0 = 13.0 |
|  | 3¢ | 250 | ×0.35^2 = 30.6 |
| ▶ | 1¢ | 2,799 (2,500 yours) | ×0.35^4 = 42.0 |
| | | **Σ** | **85.6** |

`yours 37.5 / Σ 85.6 = 43.8%`  
`$500 ÷ 73 ÷ 2 = $3.42 × 43.8% = $1.50/day`  
...
22. `tec-cbb-champ-2027-04-05-w-ind`
23. `tec-cbb-champ-2027-04-05-w-iowa`
24. `tec-cbb-champ-2027-04-05-w-iowast` ← this one
25. `tec-cbb-champ-2027-04-05-w-kan`
26. `tec-cbb-champ-2027-04-05-w-lou`
27. `tec-cbb-champ-2027-04-05-w-loych`
28. `tec-cbb-champ-2027-04-05-w-lsutig`
...
<details><summary><code>scc-senate-gop-2026-11-03-49</code> BUY 10 @ 19¢ → $1.33/day</summary>
...
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (326,574 resting) | ~23.1% | ~$17.33 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (5,681 resting) | ~63.9% | ~$15.97 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (66,750 resting) | ~58.4% | ~$14.59 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (61,706 resting) | ~17.1% | ~$12.82 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (40,920 resting) | ~48.2% | ~$12.04 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,475 resting) | ~44.1% | ~$11.03 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (67,154 resting) | ~6.5% | ~$4.89 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (187,956 resting) | ~5.0% | ~$3.78 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (98,529 resting) | ~14.7% | ~$3.67 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (6,217 resting) | ~10.3% | ~$2.58 |
| `ewc-usgub-ia-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (67,156 resting) | ~41.2% | ~$2.57 |
