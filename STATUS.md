...
## ✅ Last successful check: 2026-08-18 5:45 PM ET
...
**Earning right now:** ~$211.85/day estimated (ceiling, not promise — details below)
...
### Estimated earning rate: ~$211.85/day (~$8.83/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `usgubewc-usgub-id-2026-11-03-dem` | SELL | 6.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (208,293 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-51` | BUY | 14.0¢ | 7 | 0 | $100.00 | ✅ scoring — ~100.0% of bid side (305,681 resting ≥ 5,000 ✓) ≈ $3.85/day (event pool ÷ 13 markets) |
...
| `usgubewc-usgub-ct-2026-11-03-dem` | BUY | 94.0¢ | 4 | 0 | $25.00 | ✅ scoring — ~94.3% of bid side (500,268 resting ≥ 2,000 ✓) ≈ $5.90/day (event pool ÷ 2 markets) |
| `enwc-uspres-nom-dem-2028-petbut` | SELL | 7.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~94.3% of ask side (33,669 resting ≥ 20,000 ✓) ≈ $5.55/day (event pool ÷ 17 markets) |
| `scc-senate-gop-2026-11-03-52` | BUY | 10.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~93.8% of bid side (305,762 resting ≥ 5,000 ✓) ≈ $3.61/day (event pool ÷ 13 markets) |
...
| `ussewc-usse-wy-2026-11-03-rep` | BUY | 83.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~50.0% of bid side (500,207 resting ≥ 2,000 ✓) ≈ $3.12/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-tn-2026-11-03-rep` | BUY | 83.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~50.0% of bid side (2,116 resting ≥ 2,000 ✓) ≈ $3.12/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-tn-2026-11-03-rep` | BUY | 83.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~50.0% of bid side (2,116 resting ≥ 2,000 ✓) ≈ $3.12/day (event pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-47` | BUY | 12.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~49.0% of bid side (105,730 resting ≥ 5,000 ✓) ≈ $1.88/day (event pool ÷ 13 markets) |
| `scc-senate-gop-2026-11-03-47` | BUY | 12.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~49.0% of bid side (105,730 resting ≥ 5,000 ✓) ≈ $1.88/day (event pool ÷ 13 markets) |
...
| `ewc-usp-2028-11-07-jbpri` | BUY | 12.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~43.1% of bid side (30,219 resting ≥ 20,000 ✓) ≈ $1.60/day (event pool ÷ 27 markets) |
| `usgubewc-usgub-md-2026-11-03-rep` | BUY | 1.0¢ | 1,799 | 0 | $25.00 | ✅ scoring — ~42.3% of bid side (4,252 resting ≥ 2,000 ✓) ≈ $2.64/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-tn-2026-11-03-rep` | BUY | 95.0¢ | 35 | 0 | $25.00 | ✅ scoring — ~39.1% of bid side (500,447 resting ≥ 2,000 ✓) ≈ $2.45/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-ma-2026-11-03-rep` | SELL | 7.0¢ | 2 | 0 | $25.00 | ✅ scoring — ~37.0% of ask side (2,031 resting ≥ 2,000 ✓) ≈ $2.31/day (event pool ÷ 2 markets) |
...
<details><summary><code>usgubewc-usgub-id-2026-11-03-dem</code> SELL 3 @ 6¢ → $6.25/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 6¢ | 3 (3 yours) | ×0.1^0 = 3.0 |
|  | 21¢ | 1 | ×0.1^15 = 0.0 |
|  | 95¢ | 1 | ×0.1^89 = 0.0 |
...
<details><summary><code>scc-senate-gop-2026-11-03-52</code> BUY 1 @ 10¢ → $3.61/day</summary>
...
<details><summary><code>usgubewc-usgub-md-2026-11-03-rep</code> BUY 1,799 @ 1¢ → $2.64/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 4,252 (1,799 yours) | ×0.1^0 = 4,252.0 |
| | | **Σ** | **4,252.0** |

`yours 1,799.0 / Σ 4,252.0 = 42.3%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 42.3% = $2.64/day`  
...
<details><summary><code>usgubewc-usgub-ma-2026-11-03-rep</code> SELL 2 @ 7¢ → $2.31/day</summary>
...
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (285,469 resting) | ~3.3% | ~$2.50 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (632,414 resting) | ~6.8% | ~$1.70 |
| `ewc-usse-nc-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (66,317 resting) | ~6.2% | ~$1.56 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (265,540 resting) | ~1.9% | ~$1.45 |
...
| `ewc-usgub-wi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (1,244,460 resting) | ~21.3% | ~$1.33 |
