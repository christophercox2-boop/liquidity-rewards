...
## ✅ Last successful check: 2026-08-09 11:44 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$145.24/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-ca-2026-11-03-stehil` — SELL at the best price, ~$41.12/day for 200 contracts. Runners-up: `ewc-usgub-ga-2026-11-03-rep` (~$33.58/day), `apdc-jerpowgov-2026-08-31` (~$15.67/day)
...
### Estimated earning rate: ~$145.24/day (~$6.05/hour)
...
| `scc-senate-gop-2026-11-03-51` | BUY | 19.0¢ | 2 | 1 | $100.00 | ✅ scoring — ~97.6% of bid side (200,317 resting ≥ 5,000 ✓) ≈ $3.75/day (pool ÷ 13 markets) |
| `ussewc-usse-tn-2026-11-03-dem` | BUY | 1.0¢ | 2,000 | 0 | $25.00 | ✅ scoring — ~95.2% of bid side (2,100 resting ≥ 2,000 ✓) ≈ $5.95/day (pool ÷ 2 markets) |
| `ussewc-usse-wy-2026-11-03-rep` | SELL | 99.0¢ | 2,000 | 0 | $25.00 | ✅ scoring — ~90.3% of ask side (2,216 resting ≥ 2,000 ✓) ≈ $5.64/day (pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-53` | BUY | 13.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~88.2% of bid side (10,712 resting ≥ 5,000 ✓) ≈ $3.39/day (pool ÷ 13 markets) |
| `ussewc-usse-wy-2026-11-03-rep` | BUY | 50.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~80.0% of bid side (2,140 resting ≥ 2,000 ✓) ≈ $5.00/day (pool ÷ 2 markets) |
| `ussewc-usse-tn-2026-11-03-dem` | SELL | 50.0¢ | 40 | 0 | $25.00 | ✅ scoring — ~80.0% of ask side (4,640 resting ≥ 2,000 ✓) ≈ $5.00/day (pool ÷ 2 markets) |
| `ussewc-usse-tn-2026-11-03-rep` | SELL | 99.0¢ | 2,000 | 0 | $25.00 | ✅ scoring — ~74.6% of ask side (2,681 resting ≥ 2,000 ✓) ≈ $4.66/day (pool ÷ 2 markets) |
...
| `scc-hrep-rep-2026-11-03-gte200` | BUY | 61.0¢ | 10 | 2 | $100.00 | ✅ scoring — ~64.7% of bid side (80,220 resting ≥ 5,000 ✓) ≈ $2.70/day (pool ÷ 12 markets) |
...
| `opdc-mcconnell-resign-2026-11-02` | SELL | 19.0¢ | 24 | 0 | $25.00 | ✅ scoring — ~49.1% of ask side (4,262 resting ≥ 2,000 ✓) ≈ $6.13/day |
...
| `scc-hrep-rep-2026-11-03-gte205` | SELL | 48.0¢ | 20 | 0 | $100.00 | ✅ scoring — ~31.7% of ask side (62,888 resting ≥ 5,000 ✓) ≈ $1.32/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-52` | SELL | 15.0¢ | 8 | 0 | $100.00 | ✅ scoring — ~28.4% of ask side (113,556 resting ≥ 5,000 ✓) ≈ $1.09/day (pool ÷ 13 markets) |
...
|---|---:|---:|---:|
|  | 20¢ | 0 | ×0.2^0 = 0.0 |
| ▶ | 19¢ | 2 (2 yours) | ×0.2^1 = 0.4 |
|  | 5¢ | 115 | ×0.2^15 = 0.0 |
|  | 1¢ | 200,200 | ×0.2^19 = 0.0 |
| | | **Σ** | **0.4** |

`yours 0.4 / Σ 0.4 = 97.6%`  
...
<details><summary><code>ussewc-usse-tn-2026-11-03-dem</code> BUY 2,000 @ 1¢ → $5.95/day</summary>
...
<details><summary><code>ussewc-usse-wy-2026-11-03-rep</code> SELL 2,000 @ 99¢ → $5.64/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 99¢ | 2,216 (2,000 yours) | ×0.1^0 = 2,216.0 |
| | | **Σ** | **2,216.0** |

`yours 2,000.0 / Σ 2,216.0 = 90.3%`  
...
<details><summary><code>ussewc-usse-wy-2026-11-03-rep</code> BUY 40 @ 50¢ → $5.00/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 50¢ | 40 (40 yours) | ×0.1^0 = 40.0 |
|  | 49¢ | 100 | ×0.1^1 = 10.0 |
|  | 1¢ | 2,000 | ×0.1^49 = 0.0 |
| | | **Σ** | **50.0** |
...
<details><summary><code>ussewc-usse-tn-2026-11-03-dem</code> SELL 40 @ 50¢ → $5.00/day</summary>
...
<details><summary><code>ussewc-usse-tn-2026-11-03-rep</code> SELL 2,000 @ 99¢ → $4.66/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 99¢ | 2,681 (2,000 yours) | ×0.1^0 = 2,681.0 |
| | | **Σ** | **2,681.0** |

`yours 2,000.0 / Σ 2,681.0 = 74.6%`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte200</code> BUY 10 @ 61¢ → $2.70/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 63¢ | 0 | ×0.2^0 = 0.0 |
| ▶ | 61¢ | 15 (10 yours) | ×0.2^2 = 0.6 |
|  | 59¢ | 5 | ×0.2^4 = 0.0 |
|  | 2¢ | 80,000 | ×0.2^61 = 0.0 |
| | | **Σ** | **0.6** |

`yours 0.4 / Σ 0.6 = 64.7%`  
`$100 ÷ 12 ÷ 2 = $4.17 × 64.7% = $2.70/day`  
...
<details><summary><code>opdc-mcconnell-resign-2026-11-02</code> SELL 24 @ 19¢ → $6.13/day</summary>
...
`yours 24.0 / Σ 48.9 = 49.1%`  
`$25 ÷ 1 ÷ 2 = $12.50 × 49.1% = $6.13/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-52</code> SELL 8 @ 15¢ → $1.09/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 15¢ | 29 (8 yours) | ×0.2^0 = 29.3 |
|  | 50¢ | 125 | ×0.2^35 = 0.0 |
|  | 97¢ | 58,824 | ×0.2^82 = 0.0 |
| | | **Σ** | **29.3** |

`yours 8.3 / Σ 29.3 = 28.4%`  
...
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (61,568 resting) | ~44.8% | ~$33.58 |
...
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,607 resting) | ~59.5% | ~$14.87 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (5,563 resting) | ~47.2% | ~$11.80 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (39,854 resting) | ~21.1% | ~$5.28 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (67,064 resting) | ~6.7% | ~$5.04 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (189,085 resting) | ~5.0% | ~$3.77 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (86,891 resting) | ~12.4% | ~$3.10 |
| `ewc-usgub-ia-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (67,391 resting) | ~40.3% | ~$2.52 |
