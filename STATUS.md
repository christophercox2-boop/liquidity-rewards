...
## ✅ Last successful check: 2026-08-18 2:53 AM ET
...
**Earning right now:** ~$172.61/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-usgubp-ok-2026-06-16-rep-gendru` — BUY at the best price, ~$23.04/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$2.64/day), `ewc-usgub-oh-2026-11-03-dem` (~$1.77/day)
...
### Estimated earning rate: ~$172.61/day (~$7.19/hour)
...
| `erac-usgubp-ak-adv-2026-08-18-edndev` | BUY | 1.0¢ | 9,899 | 0 | $500.00 | ✅ scoring — ~79.5% of bid side (12,455 resting ≥ 10,000 ✓) ≈ $10.46/day (event pool ÷ 19 markets) |
| `ewc-usp-2028-11-07-jonoss` | BUY | 18.0¢ | 45 | 1 | $200.00 | ✅ scoring — ~79.5% of bid side (74,664 resting ≥ 20,000 ✓) ≈ $2.94/day (event pool ÷ 27 markets) |
| `ewc-usp-2028-11-07-jonoss` | SELL | 20.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~77.2% of ask side (79,254 resting ≥ 20,000 ✓) ≈ $2.86/day (event pool ÷ 27 markets) |
| `ewc-usp-2028-11-07-rahema` | BUY | 10.0¢ | 45 | 0 | $200.00 | ✅ scoring — ~75.7% of bid side (100,999 resting ≥ 20,000 ✓) ≈ $2.80/day (event pool ÷ 27 markets) |
...
| `enwc-uspres-nom-dem-2028-jonoss` | BUY | 26.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~50.3% of bid side (79,321 resting ≥ 20,000 ✓) ≈ $2.96/day (event pool ÷ 17 markets) |
| `erac-usgubp-ak-adv-2026-08-18-jonkre` | BUY | 82.0¢ | 10 | 0 | $500.00 | ✅ scoring — ~47.2% of bid side (10,985 resting ≥ 10,000 ✓) ≈ $6.21/day (event pool ÷ 19 markets) |
| `erac-usgubp-ak-adv-2026-08-18-jonkre` | BUY | 82.0¢ | 10 | 0 | $500.00 | ✅ scoring — ~47.2% of bid side (10,985 resting ≥ 10,000 ✓) ≈ $6.21/day (event pool ÷ 19 markets) |
| `enwc-uspres-nom-dem-2028-stasmi` | SELL | 4.0¢ | 50 | 0 | $200.00 | ✅ scoring — ~46.7% of ask side (43,940 resting ≥ 20,000 ✓) ≈ $2.75/day (event pool ÷ 17 markets) |
...
| `ewc-usp-2028-11-07-markel` | SELL | 13.0¢ | 16 | 0 | $200.00 | ✅ scoring — ~39.0% of ask side (62,044 resting ≥ 20,000 ✓) ≈ $1.45/day (event pool ÷ 27 markets) |
| `usgubewc-usgub-ne-2026-11-03-rep` | BUY | 91.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~37.5% of bid side (510,288 resting ≥ 2,000 ✓) ≈ $2.34/day (event pool ÷ 2 markets) |
...
<details><summary><code>erac-usgubp-ak-adv-2026-08-18-edndev</code> BUY 9,899 @ 1¢ → $10.46/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 12,455 (9,899 yours) | ×0.2^0 = 12,454.9 |
| | | **Σ** | **12,454.9** |

`yours 9,899.1 / Σ 12,454.9 = 79.5%`  
`$500 ÷ 19 ÷ 2 = $13.16 × 79.5% = $10.46/day`  
...
<details><summary><code>ewc-usp-2028-11-07-jonoss</code> BUY 45 @ 18¢ → $2.94/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 19¢ | 1 | ×0.2^0 = 1.0 |
| ▶ | 18¢ | 50 (45 yours) | ×0.2^1 = 10.0 |
|  | 15¢ | 204 | ×0.2^4 = 0.3 |
|  | 13¢ | 1 | ×0.2^6 = 0.0 |
|  | 12¢ | 1 | ×0.2^7 = 0.0 |
|  | 11¢ | 11 | ×0.2^8 = 0.0 |
...
`yours 9.0 / Σ 11.3 = 79.5%`  
`$200 ÷ 27 ÷ 2 = $3.70 × 79.5% = $2.94/day`  
...
<details><summary><code>ewc-usp-2028-11-07-jonoss</code> SELL 1 @ 20¢ → $2.86/day</summary>
...
|  | 27¢ | 1 | ×0.2^7 = 0.0 |
|  | 29¢ | 510 | ×0.2^9 = 0.0 |
|  | 30¢ | 58,479 | ×0.2^10 = 0.0 |
| | | **Σ** | **1.3** |

`yours 1.0 / Σ 1.3 = 77.2%`  
`$200 ÷ 27 ÷ 2 = $3.70 × 77.2% = $2.86/day`  
...
<details><summary><code>ewc-usp-2028-11-07-rahema</code> BUY 45 @ 10¢ → $2.80/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 10¢ | 59 (45 yours) | ×0.2^0 = 59.3 |
|  | 8¢ | 1 | ×0.2^2 = 0.0 |
|  | 7¢ | 1 | ×0.2^3 = 0.0 |
|  | 5¢ | 5 | ×0.2^5 = 0.0 |
|  | 2¢ | 111 | ×0.2^8 = 0.0 |
...
<details><summary><code>enwc-uspres-nom-dem-2028-jonoss</code> BUY 1 @ 26¢ → $2.96/day</summary>
...
|  | 15¢ | 595 | ×0.2^11 = 0.0 |
|  | 13¢ | 1,923 | ×0.2^13 = 0.0 |
|  | 10¢ | 26,250 | ×0.2^16 = 0.0 |
| | | **Σ** | **2.0** |

`yours 1.0 / Σ 2.0 = 50.3%`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-stasmi</code> SELL 50 @ 4¢ → $2.75/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 4¢ | 107 (50 yours) | ×0.2^0 = 107.0 |
|  | 12¢ | 32 | ×0.2^8 = 0.0 |
|  | 15¢ | 4 | ×0.2^11 = 0.0 |
|  | 16¢ | 4 | ×0.2^12 = 0.0 |
...
`yours 50.0 / Σ 107.0 = 46.7%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 46.7% = $2.75/day`  
...
<details><summary><code>ewc-usp-2028-11-07-markel</code> SELL 16 @ 13¢ → $1.45/day</summary>
...
`yours 16.0 / Σ 41.0 = 39.0%`  
`$200 ÷ 27 ÷ 2 = $3.70 × 39.0% = $1.45/day`  
...
<details><summary><code>usgubewc-usgub-ne-2026-11-03-rep</code> BUY 3 @ 91¢ → $2.34/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 91¢ | 8 (3 yours) | ×0.1^0 = 8.0 |
|  | 75¢ | 50 | ×0.1^16 = 0.0 |
|  | 44¢ | 1 | ×0.1^47 = 0.0 |
|  | 43¢ | 23 | ×0.1^48 = 0.0 |
|  | 38¢ | 1 | ×0.1^53 = 0.0 |
...
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (289,194 resting) | ~2.4% | ~$1.77 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (4,891 resting) | ~6.0% | ~$1.50 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (634,981 resting) | ~5.7% | ~$1.42 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (84,824 resting) | ~1.6% | ~$1.18 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (91,222 resting) | ~18.7% | ~$1.17 |
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (76,218 resting) | ~1.5% | ~$1.15 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (95,089 resting) | ~1.4% | ~$1.05 |
| `enwc-usgubp-fl-2026-08-18-rep-jaycol` | $500.00 ÷ 3 | 0.20 | 10,000 | SELL side (148,165 resting) | ~1.2% | ~$1.02 |
| `ewc-usse-nc-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (66,394 resting) | ~4.0% | ~$1.00 |
| `enwc-usgubp-fl-2026-08-18-rep-jamfis` | $500.00 ÷ 3 | 0.20 | 10,000 | BUY side (18,574 resting) | ~1.1% | ~$0.89 |
