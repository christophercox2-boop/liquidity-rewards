...
## ✅ Last successful check: 2026-07-25 11:36 AM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$85.22/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-usgubp-ok-2026-06-16-rep-mikmaz` — BUY at the best price, ~$7.05/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$4.62/day), `enwc-ussep-mn-2026-08-11-dem-angcra` (~$4.41/day)
...
### Estimated earning rate: ~$85.22/day (~$3.55/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `vmc-ussep-misen-2026-08-04-els15-20` | SELL | 24.0¢ | 70 | 0 | $100.00 | ✅ scoring — ~99.8% of ask side (63,851 resting ≥ 2,000 ✓) ≈ $4.99/day (pool ÷ 10 markets) |
...
| `scc-senate-gop-2026-11-03-51` | BUY | 16.0¢ | 200 | 2 | $100.00 | ✅ scoring — ~79.2% of bid side (200,407 resting ≥ 2,000 ✓) ≈ $3.05/day (pool ÷ 13 markets) |
...
| `vmc-ussep-misen-2026-08-04-els15-20` | BUY | 2.0¢ | 2,001 | 0 | $100.00 | ✅ scoring — ~63.5% of bid side (34,202 resting ≥ 2,000 ✓) ≈ $3.18/day (pool ÷ 10 markets) |
| `iarc-group-2026-12-31-tuccar` | BUY | 1.0¢ | 2,000 | 1 | $100.00 | ✅ scoring — ~61.3% of bid side (3,256 resting ≥ 2,000 ✓) ≈ $3.07/day (pool ÷ 10 markets) |
...
| `enwc-ussep-sc-2026-08-11-rep-joewil` | BUY | 1.0¢ | 2,000 | 2 | $100.00 | ✅ scoring — ~38.0% of bid side (3,449 resting ≥ 2,000 ✓) ≈ $1.58/day (pool ÷ 12 markets) |
...
| `vmc-ussep-misen-2026-08-04-ste10-15` | SELL | 14.0¢ | 11 | 1 | $100.00 | ✅ scoring — ~12.7% of ask side (40,995 resting ≥ 2,000 ✓) ≈ $0.63/day (pool ÷ 10 markets) |
...
| `scc-senate-gop-2026-11-03-52` | BUY | 8.0¢ | 200 | 6 | $100.00 | ✅ scoring — ~7.9% of bid side (50,675 resting ≥ 2,000 ✓) ≈ $0.31/day (pool ÷ 13 markets) |
...
<details><summary><code>vmc-ussep-misen-2026-08-04-els15-20</code> SELL 70 @ 24¢ → $4.99/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 24¢ | 70 (70 yours) | ×0.5^0 = 70.0 |
|  | 32¢ | 29 | ×0.5^8 = 0.1 |
|  | 40¢ | 16 | ×0.5^16 = 0.0 |
|  | 45¢ | 25 | ×0.5^21 = 0.0 |
|  | 55¢ | 44 | ×0.5^31 = 0.0 |
|  | 98¢ | 63,168 | ×0.5^74 = 0.0 |
| | | **Σ** | **70.1** |

`yours 70.0 / Σ 70.1 = 99.8%`  
`$100 ÷ 10 ÷ 2 = $5.00 × 99.8% = $4.99/day`  
...
<details><summary><code>vmc-ussep-misen-2026-08-04-els15-20</code> BUY 2,001 @ 2¢ → $3.18/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 2¢ | 3,150 (2,001 yours) | ×0.5^0 = 3,150.0 |
| | | **Σ** | **3,150.0** |

`yours 2,001.0 / Σ 3,150.0 = 63.5%`  
`$100 ÷ 10 ÷ 2 = $5.00 × 63.5% = $3.18/day`  
...
`yours 1,000.0 / Σ 1,630.0 = 61.3%`  
`$100 ÷ 10 ÷ 2 = $5.00 × 61.3% = $3.07/day`  
...
<details><summary><code>enwc-ussep-sc-2026-08-11-rep-joewil</code> BUY 2,000 @ 1¢ → $1.58/day</summary>
...
`yours 500.0 / Σ 1,317.5 = 38.0%`  
`$100 ÷ 12 ÷ 2 = $4.17 × 38.0% = $1.58/day`  
...
<details><summary><code>vmc-ussep-misen-2026-08-04-ste10-15</code> SELL 11 @ 14¢ → $0.63/day</summary>
...
`yours 5.5 / Σ 43.4 = 12.7%`  
`$100 ÷ 10 ÷ 2 = $5.00 × 12.7% = $0.63/day`  
...
|  | 2¢ | 50,250 | ×0.5^12 = 12.3 |
| | | **Σ** | **39.4** |

`yours 3.1 / Σ 39.4 = 7.9%`  
...
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.50 | 2,000 | SELL side (31,992 resting) | ~17.6% | ~$4.41 |
| `ewc-usgub-ks-2026-11-03-rep` | $100.00 ÷ 2 | 0.50 | 2,000 | SELL side (105,769 resting) | ~11.4% | ~$2.85 |
| `enwc-ussep-mi-2026-08-04-dem-halste` | $100.00 ÷ 3 | 0.50 | 2,000 | BUY side (101,220 resting) | ~14.7% | ~$2.45 |
| `enwc-ussep-mi-2026-08-04-dem-abdels` | $100.00 ÷ 3 | 0.50 | 2,000 | BUY side (137,362 resting) | ~14.1% | ~$2.35 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.50 | 2,000 | SELL side (3,757 resting) | ~8.3% | ~$2.07 |
| `ewc-usgub-ks-2026-11-03-dem` | $100.00 ÷ 2 | 0.50 | 2,000 | BUY side (185,041 resting) | ~7.8% | ~$1.94 |
| `ewc-usgub-ga-2026-11-03-dem` | $100.00 ÷ 2 | 0.50 | 2,000 | BUY side (45,976 resting) | ~7.5% | ~$1.88 |
| `ewc-usgub-wi-2026-11-03-rep` | $100.00 ÷ 2 | 0.50 | 2,000 | BUY side (71,075 resting) | ~7.2% | ~$1.80 |
| `ewc-usgub-ga-2026-11-03-rep` | $100.00 ÷ 2 | 0.50 | 2,000 | SELL side (109,417 resting) | ~6.8% | ~$1.71 |
