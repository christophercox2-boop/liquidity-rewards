...
## ✅ Last successful check: 2026-08-20 4:57 AM ET
...
**Earning right now:** ~$524.29/day estimated (ceiling, not promise — details below)
...
**What else to join:** `paccc-usho-midterms-2026-11-03-rep` — BUY at the best price, ~$27.21/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$12.49/day), `ewc-usgub-ga-2026-11-03-dem` (~$6.48/day)
...
### Estimated earning rate: ~$524.29/day (~$21.85/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `usgubewc-usgub-me-2026-11-03-dem` | BUY | 89.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (505,607 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
| `ewc-usp-2028-11-07-rokha` | SELL | 6.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~99.9% of ask side (50,985 resting ≥ 20,000 ✓) ≈ $3.70/day (event pool ÷ 27 markets) |
| `ussewc-usse-ky-2026-11-03-dem` | SELL | 12.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~99.9% of ask side (68,981 resting ≥ 2,000 ✓) ≈ $6.24/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-ar-2026-11-03-dem` | SELL | 10.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~99.0% of ask side (268,953 resting ≥ 2,000 ✓) ≈ $6.18/day (event pool ÷ 2 markets) |
...
| `ewc-usp-2028-11-07-jbpri` | BUY | 8.0¢ | 135 | 0 | $200.00 | ✅ scoring — ~94.9% of bid side (50,353 resting ≥ 20,000 ✓) ≈ $3.52/day (event pool ÷ 27 markets) |
...
| `ussewc-usse-or-2026-11-03-rep` | SELL | 6.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~89.9% of ask side (130,854 resting ≥ 2,000 ✓) ≈ $5.62/day (event pool ÷ 2 markets) |
| `ussewc-usse-la-2026-11-03-dem` | SELL | 8.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~89.3% of ask side (70,586 resting ≥ 2,000 ✓) ≈ $5.58/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-sd-2026-11-03-dem` | BUY | 1.0¢ | 1,700 | 0 | $25.00 | ✅ scoring — ~85.0% of bid side (2,000 resting ≥ 2,000 ✓) ≈ $5.31/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-hi-2026-11-03-rep` | BUY | 1.0¢ | 1,799 | 1 | $25.00 | ✅ scoring — ~84.5% of bid side (2,103 resting ≥ 2,000 ✓) ≈ $5.28/day (event pool ÷ 2 markets) |
| `ussewc-usse-ks-2026-11-03-dem` | SELL | 26.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~81.3% of ask side (130,857 resting ≥ 2,000 ✓) ≈ $5.08/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-co-2026-11-03-rep` | SELL | 10.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~74.6% of ask side (131,097 resting ≥ 2,000 ✓) ≈ $4.66/day (event pool ÷ 2 markets) |
...
| `enwc-uspres-nom-dem-2028-petbut` | BUY | 12.0¢ | 68 | 0 | $200.00 | ✅ scoring — ~70.4% of bid side (96,882 resting ≥ 20,000 ✓) ≈ $4.14/day (event pool ÷ 17 markets) |
...
| `ewc-usp-2028-11-07-jamtal` | BUY | 6.0¢ | 100 | 0 | $200.00 | ✅ scoring — ~65.1% of bid side (160,141 resting ≥ 20,000 ✓) ≈ $2.41/day (event pool ÷ 27 markets) |
...
<details><summary><code>usgubewc-usgub-me-2026-11-03-dem</code> BUY 3 @ 89¢ → $6.25/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 89¢ | 3 (3 yours) | ×0.1^0 = 3.0 |
|  | 70¢ | 100 | ×0.1^19 = 0.0 |
|  | 67¢ | 4 | ×0.1^22 = 0.0 |
|  | 61¢ | 0 | ×0.1^28 = 0.0 |
|  | 55¢ | 200 | ×0.1^34 = 0.0 |
|  | 50¢ | 100 | ×0.1^39 = 0.0 |
|  | 2¢ | 500,000 | ×0.1^87 = 0.0 |
| | | **Σ** | **3.0** |
...
<details><summary><code>ewc-usp-2028-11-07-rokha</code> SELL 1 @ 6¢ → $3.70/day</summary>
...
|  | 20¢ | 287 | ×0.2^14 = 0.0 |
|  | 21¢ | 91 | ×0.2^15 = 0.0 |
|  | 25¢ | 30,266 | ×0.2^19 = 0.0 |
| | | **Σ** | **1.0** |

`yours 1.0 / Σ 1.0 = 99.9%`  
`$200 ÷ 27 ÷ 2 = $3.70 × 99.9% = $3.70/day`  
...
<details><summary><code>ussewc-usse-ky-2026-11-03-dem</code> SELL 1 @ 12¢ → $6.24/day</summary>
...
<details><summary><code>ussewc-usse-ar-2026-11-03-dem</code> SELL 1 @ 10¢ → $6.18/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-jbpri</code> BUY 135 @ 8¢ → $3.52/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 8¢ | 142 (135 yours) | ×0.2^0 = 141.5 |
|  | 6¢ | 1 | ×0.2^2 = 0.0 |
|  | 4¢ | 1 | ×0.2^4 = 0.0 |
|  | 2¢ | 112 | ×0.2^6 = 0.0 |
|  | 1¢ | 50,097 | ×0.2^7 = 0.6 |
...
`yours 135.0 / Σ 142.2 = 94.9%`  
`$200 ÷ 27 ÷ 2 = $3.70 × 94.9% = $3.52/day`  
...
<details><summary><code>ussewc-usse-or-2026-11-03-rep</code> SELL 1 @ 6¢ → $5.62/day</summary>
...
<details><summary><code>ussewc-usse-la-2026-11-03-dem</code> SELL 1 @ 8¢ → $5.58/day</summary>
...
<details><summary><code>usgubewc-usgub-sd-2026-11-03-dem</code> BUY 1,700 @ 1¢ → $5.31/day</summary>
...
<details><summary><code>usgubewc-usgub-hi-2026-11-03-rep</code> BUY 1,799 @ 1¢ → $5.28/day</summary>
...
<details><summary><code>ussewc-usse-ks-2026-11-03-dem</code> SELL 1 @ 26¢ → $5.08/day</summary>
...
<details><summary><code>usgubewc-usgub-co-2026-11-03-rep</code> SELL 1 @ 10¢ → $4.66/day</summary>
...
<details><summary><code>enwc-uspres-nom-dem-2028-petbut</code> BUY 68 @ 12¢ → $4.14/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 12¢ | 96 (68 yours) | ×0.2^0 = 96.0 |
|  | 11¢ | 2 | ×0.2^1 = 0.4 |
|  | 10¢ | 2 | ×0.2^2 = 0.1 |
|  | 8¢ | 6 | ×0.2^4 = 0.0 |
|  | 7¢ | 30 | ×0.2^5 = 0.0 |
...
`yours 68.0 / Σ 96.6 = 70.4%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 70.4% = $4.14/day`  
...
<details><summary><code>ewc-usp-2028-11-07-jamtal</code> BUY 100 @ 6¢ → $2.41/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 6¢ | 101 (100 yours) | ×0.2^0 = 101.0 |
|  | 5¢ | 4 | ×0.2^1 = 0.8 |
|  | 4¢ | 15 | ×0.2^2 = 0.6 |
|  | 1¢ | 160,021 | ×0.2^5 = 51.2 |
| | | **Σ** | **153.6** |

`yours 100.0 / Σ 153.6 = 65.1%`  
`$200 ÷ 27 ÷ 2 = $3.70 × 65.1% = $2.41/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `paccc-usho-midterms-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (822,039 resting) | ~36.3% | ~$27.21 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (90,277 resting) | ~50.0% | ~$12.49 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (62,782 resting) | ~8.6% | ~$6.48 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (26,252 resting) | ~5.9% | ~$4.40 |
| `paccc-usse-midterms-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (912,887 resting) | ~5.5% | ~$4.11 |
| `paccc-usse-midterms-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (786,796 resting) | ~3.5% | ~$2.62 |
| `ewc-usse-tx-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (924,692 resting) | ~3.4% | ~$2.53 |
| `paccc-usho-midterms-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (541,431 resting) | ~2.7% | ~$2.01 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (630,663 resting) | ~7.2% | ~$1.80 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (39,942 resting) | ~6.4% | ~$1.61 |
| `ewc-usgub-wi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (1,238,985 resting) | ~25.4% | ~$1.59 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (81,399 resting) | ~20.2% | ~$1.26 |
