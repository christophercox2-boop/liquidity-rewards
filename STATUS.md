...
## ✅ Last successful check: 2026-07-19 6:10 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$66.89/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-ussep-mi-2026-08-04-dem-abdels` — BUY at the best price, ~$11.83/day for 200 contracts. Runners-up: `enwc-ussep-me-2026-07-27-dem-trojac` (~$11.31/day), `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$8.70/day)
...
### Estimated earning rate: ~$66.89/day (~$2.79/hour)
...
| `enwc-usgubp-wi-2026-08-11-dem-manbar` | SELL | 5.0¢ | 93 | 0 | $250.00 | ✅ scoring — ~22.2% of ask side (11,264 resting ≥ 10,000 ✓) ≈ $4.63/day (pool ÷ 6 markets) |
...
| `vmc-ussep-misen-2026-08-04-elsgte20` | SELL | 48.0¢ | 100 | 0 | $250.00 | ✅ scoring — ~11.0% of ask side (15,543 resting ≥ 10,000 ✓) ≈ $1.38/day (pool ÷ 10 markets) |
...
| `enwc-ussep-nh-2026-09-01-rep-scobro` | SELL | 21.0¢ | 100 | 0 | $250.00 | ✅ scoring — ~4.4% of ask side (22,129 resting ≥ 10,000 ✓) ≈ $2.78/day (pool ÷ 2 markets) |
| `enwc-ussep-nh-2026-09-01-rep-johsun` | BUY | 87.0¢ | 100 | 0 | $250.00 | ✅ scoring — ~2.2% of bid side (39,029 resting ≥ 10,000 ✓) ≈ $1.36/day (pool ÷ 2 markets) |
| `enwc-ussep-nh-2026-09-08-dem-chrpap` | BUY | 60.0¢ | 100 | 1 | $250.00 | ✅ scoring — ~1.9% of bid side (11,683 resting ≥ 10,000 ✓) ≈ $1.19/day (pool ÷ 2 markets) |
...
<details><summary><code>enwc-usgubp-wi-2026-08-11-dem-manbar</code> SELL 93 @ 5¢ → $4.63/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 5¢ | 417 (93 yours) | ×0.3^0 = 417.0 |
|  | 7¢ | 12 | ×0.3^2 = 1.1 |
|  | 30¢ | 250 | ×0.3^25 = 0.0 |
|  | 99¢ | 10,585 | ×0.3^94 = 0.0 |
| | | **Σ** | **418.1** |

`yours 93.0 / Σ 418.1 = 22.2%`  
`$250 ÷ 6 ÷ 2 = $20.83 × 22.2% = $4.63/day`  
...
<details><summary><code>vmc-ussep-misen-2026-08-04-elsgte20</code> SELL 100 @ 48¢ → $1.38/day</summary>
...
`yours 100.0 / Σ 909.0 = 11.0%`  
`$250 ÷ 10 ÷ 2 = $12.50 × 11.0% = $1.38/day`  
...
| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 21¢ | 149 (100 yours) | ×0.3^0 = 149.0 |
|  | 22¢ | 1,010 | ×0.3^1 = 303.0 |
|  | 23¢ | 19,969 | ×0.3^2 = 1,797.2 |
| | | **Σ** | **2,249.2** |

`yours 100.0 / Σ 2,249.2 = 4.4%`  
...
<details><summary><code>enwc-ussep-nh-2026-09-01-rep-johsun</code> BUY 100 @ 87¢ → $1.36/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 87¢ | 1,178 (100 yours) | ×0.3^0 = 1,178.0 |
|  | 86¢ | 147 | ×0.3^1 = 44.1 |
|  | 85¢ | 37,604 | ×0.3^2 = 3,384.4 |
| | | **Σ** | **4,606.5** |

`yours 100.0 / Σ 4,606.5 = 2.2%`  
`$250 ÷ 2 ÷ 2 = $62.50 × 2.2% = $1.36/day`  
...
<details><summary><code>enwc-ussep-nh-2026-09-08-dem-chrpap</code> BUY 100 @ 60¢ → $1.19/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 61¢ | 1,499 | ×0.3^0 = 1,499.0 |
| ▶ | 60¢ | 264 (100 yours) | ×0.3^1 = 79.2 |
|  | 1¢ | 9,920 | ×0.3^60 = 0.0 |
| | | **Σ** | **1,578.2** |

`yours 30.0 / Σ 1,578.2 = 1.9%`  
`$250 ÷ 2 ÷ 2 = $62.50 × 1.9% = $1.19/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `enwc-ussep-mi-2026-08-04-dem-abdels` | $250.00 ÷ 3 | 0.30 | 10,000 | BUY side (11,692 resting) | ~28.4% | ~$11.83 |
| `enwc-ussep-me-2026-07-27-dem-trojac` | $250.00 ÷ 9 | 0.30 | 10,000 | BUY side (15,162 resting) | ~81.4% | ~$11.31 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $250.00 ÷ 2 | 0.30 | 10,000 | BUY side (27,853 resting) | ~13.9% | ~$8.70 |
...
| `enwc-usgubp-sd-2026-06-02-rep-tobdoe` | $250.00 ÷ 2 | 0.30 | 10,000 | BUY side (17,719 resting) | ~8.3% | ~$5.19 |
| `ewc-usgub-mi-2026-11-03-rep` | $250.00 ÷ 3 | 0.30 | 10,000 | BUY side (59,293 resting) | ~7.8% | ~$3.25 |
| `ewc-usgub-ia-2026-11-03-rep` | $250.00 ÷ 2 | 0.30 | 10,000 | BUY side (70,110 resting) | ~4.0% | ~$2.48 |
...
| `enwc-usgubp-sd-2026-06-02-rep-larrho` | $250.00 ÷ 2 | 0.30 | 10,000 | BUY side (79,216 resting) | ~3.0% | ~$1.87 |
