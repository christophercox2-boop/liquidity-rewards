...
## ✅ Last successful check: 2026-08-17 12:20 AM ET
...
**Earning right now:** ~$971.35/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-oh-2026-11-03-rep` — BUY at the best price, ~$7.35/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$3.70/day), `ewc-usgub-ga-2026-11-03-rep` (~$2.56/day)
...
### Estimated earning rate: ~$971.35/day (~$40.47/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `ussewc-usse-sc-2026-11-03-dem` | SELL | 17.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (195,977 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-ms-2026-11-03-dem` | SELL | 12.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (66,033 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-nm-2026-11-03-rep` | SELL | 7.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (65,477 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-id-2026-11-03-dem` | SELL | 5.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (208,293 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
...
| `usgubewc-usgub-md-2026-11-03-rep` | SELL | 6.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (65,478 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
| `ussewc-usse-ma-2026-11-03-rep` | SELL | 5.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (65,486 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-ok-2026-11-03-dem` | SELL | 6.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~99.9% of ask side (130,727 resting ≥ 2,000 ✓) ≈ $6.24/day (event pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-54` | BUY | 15.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~99.8% of bid side (10,451 resting ≥ 5,000 ✓) ≈ $3.84/day (event pool ÷ 13 markets) |
...
| `usgubewc-usgub-ma-2026-11-03-rep` | SELL | 9.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~99.0% of ask side (2,002 resting ≥ 2,000 ✓) ≈ $6.19/day (event pool ÷ 2 markets) |
| `ewc-usp-2028-11-07-kamhar` | BUY | 13.0¢ | 209 | 0 | $1,000.00 | ✅ scoring — ~99.0% of bid side (70,661 resting ≥ 20,000 ✓) ≈ $18.32/day (event pool ÷ 27 markets) |
...
| `ussewc-usse-sc-2026-11-03-dem` | BUY | 14.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~98.4% of bid side (2,118 resting ≥ 2,000 ✓) ≈ $6.15/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-ne-2026-11-03-dem` | BUY | 5.0¢ | 45 | 0 | $25.00 | ✅ scoring — ~97.4% of bid side (2,046 resting ≥ 2,000 ✓) ≈ $6.09/day (event pool ÷ 2 markets) |
| `scc-hrep-rep-2026-11-03-gte215` | BUY | 13.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~97.3% of bid side (400,454 resting ≥ 5,000 ✓) ≈ $4.05/day (event pool ÷ 12 markets) |
...
| `ewc-usp-2028-11-07-gleyou` | BUY | 10.0¢ | 58 | 0 | $1,000.00 | ✅ scoring — ~96.6% of bid side (40,057 resting ≥ 20,000 ✓) ≈ $17.89/day (event pool ÷ 27 markets) |
| `ewc-usp-2028-11-07-elomus` | BUY | 14.0¢ | 0 | 0 | $1,000.00 | ✅ scoring — ~92.8% of bid side (27,507 resting ≥ 20,000 ✓) ≈ $17.19/day (event pool ÷ 27 markets) |
| …and 840 more | | | | | | |
...
<details><summary><code>ussewc-usse-ms-2026-11-03-dem</code> SELL 1 @ 12¢ → $6.25/day</summary>
...
<details><summary><code>scc-senate-gop-2026-11-03-54</code> BUY 1 @ 15¢ → $3.84/day</summary>
...
<details><summary><code>usgubewc-usgub-ma-2026-11-03-rep</code> SELL 1 @ 9¢ → $6.19/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-kamhar</code> BUY 209 @ 13¢ → $18.32/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 13¢ | 211 (209 yours) | ×0.2^0 = 211.2 |
|  | 3¢ | 70,250 | ×0.2^10 = 0.0 |
| | | **Σ** | **211.2** |

`yours 209.0 / Σ 211.2 = 99.0%`  
`$1,000 ÷ 27 ÷ 2 = $18.52 × 99.0% = $18.32/day`  
...
<details><summary><code>usgubewc-usgub-ne-2026-11-03-dem</code> BUY 45 @ 5¢ → $6.09/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 5¢ | 46 (45 yours) | ×0.1^0 = 46.0 |
|  | 2¢ | 2 | ×0.1^3 = 0.0 |
|  | 1¢ | 1,998 | ×0.1^4 = 0.2 |
| | | **Σ** | **46.2** |

`yours 45.0 / Σ 46.2 = 97.4%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 97.4% = $6.09/day`  
...
<details><summary><code>ewc-usp-2028-11-07-gleyou</code> BUY 58 @ 10¢ → $17.89/day</summary>
...
`$1,000 ÷ 27 ÷ 2 = $18.52 × 96.6% = $17.89/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (276,971 resting) | ~9.8% | ~$7.35 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (27,734 resting) | ~14.8% | ~$3.70 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (65,030 resting) | ~3.4% | ~$2.56 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (281,839 resting) | ~3.4% | ~$2.53 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (89,155 resting) | ~3.3% | ~$2.51 |
| `ewc-usse-mi-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (629,984 resting) | ~39.2% | ~$2.45 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (37,865 resting) | ~8.6% | ~$2.15 |
...
| `ewc-usgub-wi-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (1,239,379 resting) | ~24.8% | ~$1.55 |
| `apdc-jerpowgov-2026-08-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (5,262 resting) | ~6.0% | ~$1.49 |
