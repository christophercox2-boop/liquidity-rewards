...
## ✅ Last successful check: 2026-07-29 9:09 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$86.41/day estimated (ceiling, not promise — details below)

**Earned:** $1,321.25 lifetime ($1,240.74 paid). Last three recorded days — 2026-07-29: **$0.16** · 2026-07-28: **$79.65** · 2026-07-27: **$125.34** _(Polymarket reports ~1–2 days behind)_
...
### Estimated earning rate: ~$86.41/day (~$3.60/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `scc-hrep-rep-2026-11-03-gte200` | BUY | 85.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~100.0% of bid side (5,288 resting ≥ 5,000 ✓) ≈ $4.17/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte185` | BUY | 90.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~82.0% of bid side (5,290 resting ≥ 5,000 ✓) ≈ $3.42/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-55` | SELL | 15.0¢ | 50 | 1 | $100.00 | ✅ scoring — ~78.3% of ask side (141,664 resting ≥ 5,000 ✓) ≈ $3.01/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte210` | SELL | 58.0¢ | 40 | 0 | $100.00 | ✅ scoring — ~76.9% of ask side (8,473 resting ≥ 5,000 ✓) ≈ $3.21/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-54` | SELL | 17.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~71.3% of ask side (125,503 resting ≥ 5,000 ✓) ≈ $2.74/day (pool ÷ 13 markets) |
...
| `scc-senate-gop-2026-11-03-51` | SELL | 22.0¢ | 22 | 0 | $100.00 | ✅ scoring — ~59.5% of ask side (240,519 resting ≥ 5,000 ✓) ≈ $2.29/day (pool ÷ 13 markets) |
...
| `vmc-ussep-misen-2026-08-04-els5-10` | BUY | 14.0¢ | 100 | 1 | $25.00 | ✅ scoring — ~47.6% of bid side (5,380 resting ≥ 2,000 ✓) ≈ $0.60/day (pool ÷ 10 markets) |
...
| `scc-hrep-rep-2026-11-03-gte220` | SELL | 18.0¢ | 11 | 0 | $100.00 | ✅ scoring — ~33.2% of ask side (5,381 resting ≥ 5,000 ✓) ≈ $1.38/day (pool ÷ 12 markets) |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte210</code> SELL 40 @ 58¢ → $3.21/day</summary>
...
<details><summary><code>scc-senate-gop-2026-11-03-54</code> SELL 50 @ 17¢ → $2.74/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 17¢ | 69 (50 yours) | ×0.2^0 = 69.0 |
|  | 18¢ | 5 | ×0.2^1 = 1.0 |
|  | 19¢ | 3 | ×0.2^2 = 0.1 |
|  | 20¢ | 3 | ×0.2^3 = 0.0 |
|  | 30¢ | 4 | ×0.2^13 = 0.0 |
...
<details><summary><code>scc-senate-gop-2026-11-03-51</code> SELL 22 @ 22¢ → $2.29/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 22¢ | 37 (22 yours) | ×0.2^0 = 37.0 |
|  | 30¢ | 4 | ×0.2^8 = 0.0 |
|  | 50¢ | 100 | ×0.2^28 = 0.0 |
|  | 98¢ | 1,741 | ×0.2^76 = 0.0 |
...
<details><summary><code>vmc-ussep-misen-2026-08-04-els5-10</code> BUY 100 @ 14¢ → $0.60/day</summary>
...
|---|---:|---:|---:|
| 2026-07-29 | ~$64.25 | $0.16 | 0% |
| 2026-07-28 | ~$148.78 | $79.65 | 54% |
| 2026-07-27 | ~$145.69 | $125.34 | 86% |

Biggest gaps on 2026-07-29: `apdc-petehegseth-2026-12-31` (est ~$12.86 → got $0.00), `scc-senate-gop-2026-11-03-51` (est ~$3.21 → got $0.00), `scc-senate-gop-2026-11-03-48` (est ~$2.61 → got $0.00)
...
| `ewc-usse-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (64,505 resting) | ~6.0% | ~$4.51 |
...
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (8,404 resting) | ~10.1% | ~$2.52 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (103,049 resting) | ~2.8% | ~$2.08 |
...
| Pending | $79.30 |
| Skipped | $1.21 |
| **Total earned** | **$1,321.25** |

1256 reward rows · 27 days with rewards · 343 markets · since 2026-03-21
