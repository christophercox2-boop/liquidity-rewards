...
## ✅ Last successful check: 2026-07-29 9:18 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$77.92/day estimated (ceiling, not promise — details below)
...
### Estimated earning rate: ~$77.92/day (~$3.25/hour)
...
| `scc-senate-gop-2026-11-03-51` | SELL | 22.0¢ | 22 | 0 | $100.00 | ✅ scoring — ~64.7% of ask side (240,516 resting ≥ 5,000 ✓) ≈ $2.49/day (pool ÷ 13 markets) |
| `scc-senate-gop-2026-11-03-55` | SELL | 15.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~63.4% of ask side (126,687 resting ≥ 5,000 ✓) ≈ $2.44/day (pool ÷ 13 markets) |
...
| `scc-hrep-rep-2026-11-03-gte200` | BUY | 85.0¢ | 50 | 0 | $100.00 | ✅ scoring — ~54.9% of bid side (5,546 resting ≥ 5,000 ✓) ≈ $2.29/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte220` | SELL | 18.0¢ | 11 | 0 | $100.00 | ✅ scoring — ~47.6% of ask side (5,503 resting ≥ 5,000 ✓) ≈ $1.98/day (pool ÷ 12 markets) |
...
| `vmc-ussep-misen-2026-08-04-els5-10` | BUY | 14.0¢ | 100 | 1 | $25.00 | ✅ scoring — ~33.3% of bid side (5,389 resting ≥ 2,000 ✓) ≈ $0.42/day (pool ÷ 10 markets) |
...
<details><summary><code>scc-senate-gop-2026-11-03-51</code> SELL 22 @ 22¢ → $2.49/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 22¢ | 34 (22 yours) | ×0.2^0 = 34.0 |
|  | 30¢ | 4 | ×0.2^8 = 0.0 |
|  | 50¢ | 100 | ×0.2^28 = 0.0 |
|  | 98¢ | 1,741 | ×0.2^76 = 0.0 |
...
`yours 22.0 / Σ 34.0 = 64.7%`  
`$100 ÷ 13 ÷ 2 = $3.85 × 64.7% = $2.49/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-55</code> SELL 50 @ 15¢ → $2.44/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte200</code> BUY 50 @ 85¢ → $2.29/day</summary>
...
<details><summary><code>vmc-ussep-misen-2026-08-04-els5-10</code> BUY 100 @ 14¢ → $0.42/day</summary>
...
|---|---:|---:|---:|
| 2026-07-29 | ~$65.16 | $0.32 | 0% |
| 2026-07-28 | ~$148.78 | $79.65 | 54% |
| 2026-07-27 | ~$145.69 | $125.34 | 86% |

Biggest gaps on 2026-07-29: `apdc-petehegseth-2026-12-31` (est ~$13.10 → got $0.00), `scc-senate-gop-2026-11-03-51` (est ~$3.25 → got $0.00), `scc-senate-gop-2026-11-03-48` (est ~$2.52 → got $0.00)
...
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (175,477 resting) | ~4.4% | ~$3.32 |
| `ewc-usse-tx-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (282,641 resting) | ~4.3% | ~$3.20 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (7,253 resting) | ~12.6% | ~$3.14 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (102,483 resting) | ~3.0% | ~$2.24 |
| `ewc-usse-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (84,505 resting) | ~3.0% | ~$2.23 |
