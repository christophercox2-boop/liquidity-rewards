...
## ✅ Last successful check: 2026-08-08 3:47 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$138.84/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-ca-2026-11-03-stehil` — SELL at the best price, ~$41.11/day for 200 contracts. Runners-up: `ewc-usse-oh-2026-11-03-dem` (~$19.79/day), `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$9.45/day)
...
### Estimated earning rate: ~$138.84/day (~$5.78/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `scc-senate-gop-2026-11-03-49` | SELL | 29.0¢ | 5 | 0 | $100.00 | ✅ scoring — ~100.0% of ask side (113,451 resting ≥ 5,000 ✓) ≈ $3.85/day (pool ÷ 13 markets) |
| `opdc-mcconnell-resign-2026-11-02` | BUY | 12.0¢ | 100 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (35,548 resting ≥ 2,000 ✓) ≈ $12.50/day |
...
| `scc-senate-gop-2026-11-03-49` | BUY | 27.0¢ | 17 | 0 | $100.00 | ✅ scoring — ~100.0% of bid side (50,384 resting ≥ 5,000 ✓) ≈ $3.84/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte200` | BUY | 57.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~99.8% of bid side (80,492 resting ≥ 5,000 ✓) ≈ $4.16/day (pool ÷ 12 markets) |
| `scc-hrep-rep-2026-11-03-gte215` | BUY | 33.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~99.5% of bid side (200,461 resting ≥ 5,000 ✓) ≈ $4.15/day (pool ÷ 12 markets) |
...
| `scc-senate-gop-2026-11-03-50` | BUY | 25.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~98.9% of bid side (100,581 resting ≥ 5,000 ✓) ≈ $3.81/day (pool ÷ 13 markets) |
...
| `pandc-anydis-2027-12-31` | SELL | 30.0¢ | 10 | 0 | $50.00 | ✅ scoring — ~90.9% of ask side (10,902 resting ≥ 10,000 ✓) ≈ $11.36/day (pool ÷ 2 markets) |
...
| `apdc-alito-2026-12-31` | BUY | 16.0¢ | 21 | 0 | $100.00 | ✅ scoring — ~57.6% of bid side (5,504 resting ≥ 5,000 ✓) ≈ $14.39/day (pool ÷ 2 markets) |
...
| `apdc-jerpowgov-2026-12-31` | BUY | 24.0¢ | 30 | 0 | $100.00 | ✅ scoring — ~30.0% of bid side (5,490 resting ≥ 5,000 ✓) ≈ $7.50/day (pool ÷ 2 markets) |
...
| `tec-cbb-champ-2027-04-05-w-nebr` | BUY | 1.0¢ | 1,000 | 1 | $500.00 | ✅ scoring — ~25.1% of bid side (3,899 resting ≥ 2,500 ✓) ≈ $0.86/day (pool ÷ 73 markets) |
...
<details><summary><code>scc-senate-gop-2026-11-03-49</code> SELL 5 @ 29¢ → $3.85/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 29¢ | 5 (5 yours) | ×0.2^0 = 5.0 |
|  | 34¢ | 0 | ×0.2^5 = 0.0 |
|  | 50¢ | 13 | ×0.2^21 = 0.0 |
|  | 63¢ | 0 | ×0.2^34 = 0.0 |
|  | 76¢ | 0 | ×0.2^47 = 0.0 |
...
<details><summary><code>scc-senate-gop-2026-11-03-49</code> BUY 17 @ 27¢ → $3.84/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte200</code> BUY 10 @ 57¢ → $4.16/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 57¢ | 10 (10 yours) | ×0.2^0 = 10.0 |
|  | 54¢ | 1 | ×0.2^3 = 0.0 |
|  | 51¢ | 20 | ×0.2^6 = 0.0 |
|  | 48¢ | 11 | ×0.2^9 = 0.0 |
|  | 2¢ | 80,250 | ×0.2^55 = 0.0 |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte215</code> BUY 10 @ 33¢ → $4.15/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 33¢ | 10 (10 yours) | ×0.2^0 = 10.0 |
|  | 31¢ | 1 | ×0.2^2 = 0.0 |
|  | 1¢ | 200,450 | ×0.2^32 = 0.0 |
| | | **Σ** | **10.0** |

`yours 10.0 / Σ 10.0 = 99.5%`  
...
<details><summary><code>apdc-alito-2026-12-31</code> BUY 21 @ 16¢ → $14.39/day</summary>
...
`yours 20.9 / Σ 36.2 = 57.6%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 57.6% = $14.39/day`  
...
<details><summary><code>apdc-jerpowgov-2026-12-31</code> BUY 30 @ 24¢ → $7.50/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 24¢ | 100 (30 yours) | ×0.2^0 = 100.0 |
|  | 2¢ | 100 | ×0.2^22 = 0.0 |
|  | 1¢ | 5,290 | ×0.2^23 = 0.0 |
| | | **Σ** | **100.0** |

`yours 30.0 / Σ 100.0 = 30.0%`  
`$100 ÷ 2 ÷ 2 = $25.00 × 30.0% = $7.50/day`  
...
<details><summary><code>tec-cbb-champ-2027-04-05-w-nebr</code> BUY 1,000 @ 1¢ → $0.86/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 2¢ | 50 | ×0.35^0 = 50.0 |
| ▶ | 1¢ | 3,849 (1,000 yours) | ×0.35^1 = 1,347.1 |
| | | **Σ** | **1,397.1** |

`yours 350.0 / Σ 1,397.1 = 25.1%`  
`$500 ÷ 73 ÷ 2 = $3.42 × 25.1% = $0.86/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (220,093 resting) | ~54.8% | ~$41.11 |
| `ewc-usse-oh-2026-11-03-dem` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (123,963 resting) | ~79.2% | ~$19.79 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (76,871 resting) | ~37.8% | ~$9.45 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (29,445 resting) | ~34.1% | ~$8.52 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (78,314 resting) | ~30.1% | ~$7.52 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (320,039 resting) | ~8.7% | ~$6.49 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (67,048 resting) | ~6.6% | ~$4.97 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (44,243 resting) | ~14.2% | ~$3.54 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (190,133 resting) | ~3.5% | ~$2.66 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (88,018 resting) | ~3.3% | ~$2.50 |
| `ewc-usse-tx-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (278,726 resting) | ~2.5% | ~$1.91 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (64,071 resting) | ~2.2% | ~$1.67 |
