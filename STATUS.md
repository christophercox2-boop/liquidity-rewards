...
## ✅ Last successful check: 2026-08-19 2:26 PM ET
...
**Earning right now:** ~$401.17/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-usgubp-ok-2026-06-16-rep-gendru` — BUY at the best price, ~$16.41/day for 200 contracts. Runners-up: `ewc-usgub-ga-2026-11-03-dem` (~$9.89/day), `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$9.33/day)
...
### Estimated earning rate: ~$401.17/day (~$16.72/hour)
...
| `usgubewc-usgub-ri-2026-11-03-dem` | BUY | 98.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (2,052 resting ≥ 2,000 ✓) ≈ $4.17/day (event pool ÷ 3 markets) |
| `ussewc-usse-ky-2026-11-03-rep` | BUY | 97.0¢ | 20 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (501,293 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-tx-2026-11-03-rep` | SELL | 88.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (65,236 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
| `ussewc-usse-ky-2026-11-03-dem` | SELL | 7.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (69,028 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
| `scc-senate-gop-2026-11-03-49` | SELL | 21.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~99.8% of ask side (92,011 resting ≥ 5,000 ✓) ≈ $3.84/day (event pool ÷ 13 markets) |
| `ussewc-usse-sc-2026-11-03-rep` | SELL | 87.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~98.9% of ask side (2,065 resting ≥ 2,000 ✓) ≈ $6.18/day (event pool ÷ 2 markets) |
| `ussewc-usse-la-2026-11-03-dem` | SELL | 8.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~98.9% of ask side (70,536 resting ≥ 2,000 ✓) ≈ $6.18/day (event pool ÷ 2 markets) |
| `enwc-uspres-nom-dem-2028-jossha` | BUY | 10.0¢ | 124 | 0 | $200.00 | ✅ scoring — ~96.6% of bid side (133,192 resting ≥ 20,000 ✓) ≈ $5.68/day (event pool ÷ 17 markets) |
...
| `scc-senate-gop-2026-11-03-50` | SELL | 22.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~86.3% of ask side (92,842 resting ≥ 5,000 ✓) ≈ $3.32/day (event pool ÷ 13 markets) |
| `enwc-uspres-nom-dem-2028-petbut` | BUY | 12.0¢ | 69 | 0 | $200.00 | ✅ scoring — ~84.6% of bid side (98,147 resting ≥ 20,000 ✓) ≈ $4.97/day (event pool ÷ 17 markets) |
...
| `usgubewc-usgub-md-2026-11-03-rep` | SELL | 5.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~75.5% of ask side (65,534 resting ≥ 2,000 ✓) ≈ $4.72/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-la-2026-11-03-rep` | BUY | 91.0¢ | 4 | 0 | $25.00 | ✅ scoring — ~66.7% of bid side (500,304 resting ≥ 2,000 ✓) ≈ $4.17/day (event pool ÷ 2 markets) |
...
| `ussewc-usse-ok-2026-11-03-rep` | BUY | 95.0¢ | 5 | 0 | $25.00 | ✅ scoring — ~64.1% of bid side (600,369 resting ≥ 2,000 ✓) ≈ $4.01/day (event pool ÷ 2 markets) |
| `enwc-uspres-nom-dem-2028-andbes` | BUY | 12.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~64.0% of bid side (43,410 resting ≥ 20,000 ✓) ≈ $3.76/day (event pool ÷ 17 markets) |
| `enwc-uspres-nom-dem-2028-gavnew` | BUY | 21.0¢ | 23 | 0 | $200.00 | ✅ scoring — ~64.0% of bid side (223,467 resting ≥ 20,000 ✓) ≈ $3.76/day (event pool ÷ 17 markets) |
...
| `usgubewc-usgub-al-2026-11-03-rep` | BUY | 97.0¢ | 14 | 0 | $25.00 | ✅ scoring — ~56.0% of bid side (300,878 resting ≥ 2,000 ✓) ≈ $3.50/day (event pool ÷ 2 markets) |
...
<details><summary><code>usgubewc-usgub-ri-2026-11-03-dem</code> BUY 3 @ 98¢ → $4.17/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 98¢ | 3 (3 yours) | ×0.1^0 = 3.0 |
|  | 91¢ | 0 | ×0.1^7 = 0.0 |
|  | 90¢ | 0 | ×0.1^8 = 0.0 |
|  | 84¢ | 0 | ×0.1^14 = 0.0 |
|  | 82¢ | 50 | ×0.1^16 = 0.0 |
...
<details><summary><code>ussewc-usse-ky-2026-11-03-rep</code> BUY 20 @ 97¢ → $6.25/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 97¢ | 20 (20 yours) | ×0.1^0 = 20.0 |
|  | 87¢ | 50 | ×0.1^10 = 0.0 |
|  | 86¢ | 965 | ×0.1^11 = 0.0 |
|  | 55¢ | 33 | ×0.1^42 = 0.0 |
|  | 40¢ | 25 | ×0.1^57 = 0.0 |
|  | 2¢ | 500,000 | ×0.1^95 = 0.0 |
| | | **Σ** | **20.0** |
...
<details><summary><code>usgubewc-usgub-tx-2026-11-03-rep</code> SELL 1 @ 88¢ → $6.25/day</summary>
...
<details><summary><code>ussewc-usse-ky-2026-11-03-dem</code> SELL 1 @ 7¢ → $6.25/day</summary>
...
<details><summary><code>ussewc-usse-sc-2026-11-03-rep</code> SELL 1 @ 87¢ → $6.18/day</summary>
...
<details><summary><code>ussewc-usse-la-2026-11-03-dem</code> SELL 1 @ 8¢ → $6.18/day</summary>
...
<details><summary><code>enwc-uspres-nom-dem-2028-jossha</code> BUY 124 @ 10¢ → $5.68/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 10¢ | 125 (124 yours) | ×0.2^0 = 125.0 |
|  | 7¢ | 1 | ×0.2^3 = 0.0 |
|  | 6¢ | 255 | ×0.2^4 = 0.4 |
|  | 5¢ | 1 | ×0.2^5 = 0.0 |
|  | 4¢ | 46,360 | ×0.2^6 = 3.0 |
...
`yours 124.0 / Σ 128.4 = 96.6%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 96.6% = $5.68/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-50</code> SELL 1 @ 22¢ → $3.32/day</summary>
...
<details><summary><code>enwc-uspres-nom-dem-2028-petbut</code> BUY 69 @ 12¢ → $4.97/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 12¢ | 81 (69 yours) | ×0.2^0 = 81.0 |
|  | 11¢ | 2 | ×0.2^1 = 0.4 |
|  | 10¢ | 2 | ×0.2^2 = 0.1 |
|  | 8¢ | 6 | ×0.2^4 = 0.0 |
|  | 7¢ | 60 | ×0.2^5 = 0.0 |
...
`yours 69.0 / Σ 81.6 = 84.6%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 84.6% = $4.97/day`  
...
<details><summary><code>usgubewc-usgub-md-2026-11-03-rep</code> SELL 1 @ 5¢ → $4.72/day</summary>
...
<details><summary><code>ussewc-usse-ok-2026-11-03-rep</code> BUY 5 @ 95¢ → $4.01/day</summary>
...
`yours 5.0 / Σ 7.8 = 64.1%`  
`$25 ÷ 2 ÷ 2 = $6.25 × 64.1% = $4.01/day`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-andbes</code> BUY 1 @ 12¢ → $3.76/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 12¢ | 1 (1 yours) | ×0.2^0 = 1.4 |
|  | 9¢ | 1 | ×0.2^3 = 0.0 |
|  | 8¢ | 64 | ×0.2^4 = 0.1 |
|  | 4¢ | 273 | ×0.2^8 = 0.0 |
|  | 3¢ | 110 | ×0.2^9 = 0.0 |
...
`yours 1.0 / Σ 1.6 = 64.0%`  
`$200 ÷ 17 ÷ 2 = $5.88 × 64.0% = $3.76/day`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-gavnew</code> BUY 23 @ 21¢ → $3.76/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 21¢ | 29 (23 yours) | ×0.2^0 = 28.6 |
|  | 20¢ | 1 | ×0.2^1 = 0.2 |
|  | 19¢ | 8 | ×0.2^2 = 0.3 |
|  | 18¢ | 6 | ×0.2^3 = 0.0 |
|  | 17¢ | 112 | ×0.2^4 = 0.2 |
...
<details><summary><code>usgubewc-usgub-al-2026-11-03-rep</code> BUY 14 @ 97¢ → $3.50/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 97¢ | 25 (14 yours) | ×0.1^0 = 25.0 |
|  | 94¢ | 6 | ×0.1^3 = 0.0 |
|  | 90¢ | 17 | ×0.1^7 = 0.0 |
|  | 89¢ | 50 | ×0.1^8 = 0.0 |
|  | 88¢ | 30 | ×0.1^9 = 0.0 |
|  | 84¢ | 50 | ×0.1^13 = 0.0 |
|  | 54¢ | 500 | ×0.1^43 = 0.0 |
|  | 2¢ | 300,000 | ×0.1^95 = 0.0 |
| | | **Σ** | **25.0** |

`yours 14.0 / Σ 25.0 = 56.0%`  
...
|---|---:|---:|---:|---|---:|---:|
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (26,650 resting) | ~65.6% | ~$16.41 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (80,043 resting) | ~13.2% | ~$9.89 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (26,823 resting) | ~37.3% | ~$9.33 |
| `paccc-usho-midterms-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (536,496 resting) | ~10.3% | ~$7.74 |
| `ewc-usse-mi-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (632,075 resting) | ~61.0% | ~$3.81 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (205,799 resting) | ~4.9% | ~$3.68 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (27,014 resting) | ~4.7% | ~$3.54 |
| `paccc-usse-midterms-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (669,652 resting) | ~2.7% | ~$2.05 |
| `paccc-usho-midterms-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (828,116 resting) | ~2.7% | ~$2.04 |
| `ewc-usse-ak-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (388,390 resting) | ~30.6% | ~$1.91 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (555,903 resting) | ~7.1% | ~$1.77 |
| `ewc-usgub-ca-2026-11-03-stehil` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (47,891 resting) | ~2.3% | ~$1.70 |
