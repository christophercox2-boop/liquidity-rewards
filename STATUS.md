...
## ✅ Last successful check: 2026-08-16 11:03 AM ET
...
**Earning right now:** ~$71.07/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usgub-ga-2026-11-03-rep` — BUY at the best price, ~$41.51/day for 200 contracts. Runners-up: `ewc-usse-tx-2026-11-03-dem` (~$20.11/day), `ewc-usgub-ga-2026-11-03-dem` (~$18.69/day)
...
### Estimated earning rate: ~$71.07/day (~$2.96/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `enwc-uspres-nom-dem-2028-kamhar` | SELL | 21.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~99.5% of ask side (85,793 resting ≥ 20,000 ✓) ≈ $13.82/day (program pool ÷ 36 markets) |
| `enwc-uspres-nom-dem-2028-jonste` | SELL | 13.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~97.4% of ask side (70,890 resting ≥ 20,000 ✓) ≈ $13.53/day (program pool ÷ 36 markets) |
| `enwc-uspres-nom-dem-2028-petbut` | SELL | 16.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~94.0% of ask side (73,411 resting ≥ 20,000 ✓) ≈ $13.05/day (program pool ÷ 36 markets) |
...
| `enwc-uspres-nom-rep-2028-rondes` | BUY | 9.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~36.4% of bid side (180,454 resting ≥ 20,000 ✓) ≈ $5.06/day (program pool ÷ 36 markets) |
...
| `enwc-uspres-nom-dem-2028-petbut` | BUY | 13.0¢ | 1 | 1 | $1,000.00 | ✅ scoring — ~9.1% of bid side (26,484 resting ≥ 20,000 ✓) ≈ $1.26/day (program pool ÷ 36 markets) |
...
| `enwc-uspres-nom-rep-2028-rondes` | BUY | 7.0¢ | 1 | 2 | $1,000.00 | ✅ scoring — ~1.5% of bid side (180,454 resting ≥ 20,000 ✓) ≈ $0.20/day (program pool ÷ 36 markets) |
| `scc-senate-gop-2026-11-03-52` | BUY | 6.0¢ | 1 | 3 | $100.00 | ✅ scoring — ~0.9% of bid side (340,440 resting ≥ 5,000 ✓) ≈ $0.03/day (pool ÷ 13 markets) |
...
| `enwc-uspres-nom-dem-2028-jamtal` | SELL | 17.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~0.5% of ask side (72,681 resting ≥ 20,000 ✓) ≈ $0.07/day (program pool ÷ 36 markets) |
...
| `enwc-uspres-nom-dem-2028-jossha` | BUY | 5.0¢ | 1 | 2 | $1,000.00 | ✅ scoring — ~0.2% of bid side (176,454 resting ≥ 20,000 ✓) ≈ $0.02/day (program pool ÷ 36 markets) |
| `enwc-uspres-nom-dem-2028-wesmoo` | BUY | 4.0¢ | 1 | 1 | $1,000.00 | ✅ scoring — ~0.1% of bid side (180,456 resting ≥ 20,000 ✓) ≈ $0.01/day (program pool ÷ 36 markets) |
...
| `enwc-uspres-nom-rep-2028-rondes` | BUY | 5.0¢ | 1 | 4 | $1,000.00 | ✅ scoring — ~0.1% of bid side (180,454 resting ≥ 20,000 ✓) ≈ $0.01/day (program pool ÷ 36 markets) |
...
| `enwc-uspres-nom-dem-2028-jossha` | BUY | 4.0¢ | 1 | 3 | $1,000.00 | ✅ scoring — ~0.0% of bid side (176,454 resting ≥ 20,000 ✓) ≈ $0.00/day (program pool ÷ 36 markets) |
...
| `enwc-uspres-nom-dem-2028-wesmoo` | BUY | 3.0¢ | 1 | 2 | $1,000.00 | ✅ scoring — ~0.0% of bid side (180,456 resting ≥ 20,000 ✓) ≈ $0.00/day (program pool ÷ 36 markets) |
| …and 95 more | | | | | | |
...
<details><summary><code>enwc-uspres-nom-dem-2028-jonste</code> SELL 1 @ 13¢ → $13.53/day</summary>
...
`yours 1.0 / Σ 1.0 = 97.4%`  
`$1,000 ÷ 36 ÷ 2 = $13.89 × 97.4% = $13.53/day`  
...
<details><summary><code>enwc-uspres-nom-dem-2028-petbut</code> BUY 1 @ 13¢ → $1.26/day</summary>
...
<details><summary><code>enwc-uspres-nom-rep-2028-rondes</code> BUY 1 @ 7¢ → $0.20/day</summary>
...
<details><summary><code>enwc-uspres-nom-dem-2028-wesmoo</code> BUY 1 @ 3¢ → $0.00/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 5¢ | 4 | ×0.2^0 = 3.6 |
|  | 4¢ | 1 | ×0.2^1 = 0.2 |
| ▶ | 3¢ | 1 (1 yours) | ×0.2^2 = 0.0 |
|  | 1¢ | 180,450 | ×0.2^4 = 288.7 |
| | | **Σ** | **292.5** |

`yours 0.0 / Σ 292.5 = 0.0%`  
`$1,000 ÷ 36 ÷ 2 = $13.89 × 0.0% = $0.00/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (57,180 resting) | ~55.3% | ~$41.51 |
...
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (277,222 resting) | ~10.4% | ~$7.80 |
...
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (281,018 resting) | ~2.1% | ~$1.56 |
...
| `ewc-usse-ak-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (374,132 resting) | ~22.5% | ~$1.41 |
| `ewc-usgub-ks-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (59,106 resting) | ~21.0% | ~$1.31 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | SELL side (92,782 resting) | ~20.6% | ~$1.29 |
