...
## ✅ Last successful check: 2026-08-06 10:21 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$114.00/day estimated (ceiling, not promise — details below)
...
**What else to join:** `apdc-jerpowgov-2026-12-31` — BUY at the best price, ~$10.96/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$10.39/day), `enwc-usgubp-ok-2026-06-16-rep-gendru` (~$6.37/day)
...
### Estimated earning rate: ~$114.00/day (~$4.75/hour)
...
| `opdc-mcconnell-resign-2026-11-02` | BUY | 12.0¢ | 11 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (35,499 resting ≥ 2,000 ✓) ≈ $12.50/day |
| `opdc-mcconnell-resign-2026-11-02` | SELL | 14.0¢ | 20 | 0 | $25.00 | ✅ scoring — ~98.5% of ask side (5,247 resting ≥ 2,000 ✓) ≈ $12.31/day |
...
| `lawec-cryptoleg-2026-12-31` | BUY | 25.0¢ | 10 | 0 | $25.00 | ✅ scoring — ~76.9% of bid side (26,579 resting ≥ 2,000 ✓) ≈ $4.81/day (pool ÷ 2 markets) |
...
| `scc-hrep-rep-2026-11-03-gte185` | SELL | 82.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~61.5% of ask side (7,280 resting ≥ 5,000 ✓) ≈ $2.56/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte215` | BUY | 10.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~50.1% of bid side (200,251 resting ≥ 5,000 ✓) ≈ $2.09/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte185` | BUY | 73.0¢ | 31 | 0 | $100.00 | ✅ scoring — ~41.9% of bid side (80,524 resting ≥ 5,000 ✓) ≈ $1.75/day (pool ÷ 12 markets) |
...
| `scc-hrep-rep-2026-11-03-gte195` | SELL | 76.0¢ | 20 | 1 | $100.00 | ✅ scoring — ~36.3% of ask side (5,497 resting ≥ 5,000 ✓) ≈ $1.51/day (pool ÷ 12 markets) |
...
| `dccc-cyclo-us-2026-08-31-gt7000` | BUY | 91.0¢ | 50 | 0 | $50.00 | ✅ scoring — ~31.7% of bid side (10,550 resting ≥ 10,000 ✓) ≈ $1.32/day (pool ÷ 6 markets) |
| `dccc-cyclo-us-2026-08-31-gt6000` | BUY | 91.0¢ | 50 | 0 | $50.00 | ✅ scoring — ~31.7% of bid side (10,150 resting ≥ 10,000 ✓) ≈ $1.32/day (pool ÷ 6 markets) |
...
| `scc-hrep-rep-2026-11-03-gte200` | BUY | 51.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~31.2% of bid side (80,493 resting ≥ 5,000 ✓) ≈ $1.30/day (pool ÷ 12 markets) |
| `dccc-measles-us-2026-12-31-gt3000` | BUY | 60.0¢ | 20 | 0 | $50.00 | ✅ scoring — ~30.3% of bid side (10,514 resting ≥ 10,000 ✓) ≈ $1.26/day (pool ÷ 6 markets) |
| …and 48 more | | | | | | |
...
<details><summary><code>opdc-mcconnell-resign-2026-11-02</code> SELL 20 @ 14¢ → $12.31/day</summary>
...
<details><summary><code>lawec-cryptoleg-2026-12-31</code> BUY 10 @ 25¢ → $4.81/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 25¢ | 13 (10 yours) | ×0.1^0 = 13.0 |
|  | 20¢ | 4 | ×0.1^5 = 0.0 |
|  | 11¢ | 93 | ×0.1^14 = 0.0 |
|  | 6¢ | 875 | ×0.1^19 = 0.0 |
|  | 5¢ | 144 | ×0.1^20 = 0.0 |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte185</code> SELL 10 @ 82¢ → $2.56/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte215</code> BUY 10 @ 10¢ → $2.09/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 10¢ | 12 (10 yours) | ×0.2^0 = 12.0 |
|  | 9¢ | 39 | ×0.2^1 = 7.9 |
|  | 1¢ | 200,200 | ×0.2^9 = 0.1 |
| | | **Σ** | **20.0** |

`yours 10.0 / Σ 20.0 = 50.1%`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte185</code> BUY 31 @ 73¢ → $1.75/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 73¢ | 74 (31 yours) | ×0.2^0 = 74.0 |
|  | 2¢ | 80,250 | ×0.2^71 = 0.0 |
| | | **Σ** | **74.0** |

`yours 31.0 / Σ 74.0 = 41.9%`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte195</code> SELL 20 @ 76¢ → $1.51/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
|  | 75¢ | 7 | ×0.2^0 = 7.0 |
| ▶ | 76¢ | 20 (20 yours) | ×0.2^1 = 4.0 |
|  | 79¢ | 13 | ×0.2^4 = 0.0 |
|  | 99¢ | 5,457 | ×0.2^24 = 0.0 |
| | | **Σ** | **11.0** |

`yours 4.0 / Σ 11.0 = 36.3%`  
...
<details><summary><code>dccc-measles-us-2026-12-31-gt3000</code> BUY 20 @ 60¢ → $1.26/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 60¢ | 20 (20 yours) | ×0.25^0 = 20.0 |
|  | 59¢ | 184 | ×0.25^1 = 46.0 |
|  | 50¢ | 110 | ×0.25^10 = 0.0 |
|  | 1¢ | 10,200 | ×0.25^59 = 0.0 |
| | | **Σ** | **66.0** |

`yours 20.0 / Σ 66.0 = 30.3%`  
`$50 ÷ 6 ÷ 2 = $4.17 × 30.3% = $1.26/day`  
...
|---|---:|---:|---:|---|---:|---:|
| `apdc-jerpowgov-2026-12-31` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (5,504 resting) | ~43.8% | ~$10.96 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,098 resting) | ~41.6% | ~$10.39 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (77,417 resting) | ~25.5% | ~$6.37 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (213,257 resting) | ~4.2% | ~$3.15 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (73,336 resting) | ~3.9% | ~$2.91 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (56,521 resting) | ~3.9% | ~$2.91 |
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (6,881 resting) | ~10.7% | ~$2.67 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (88,966 resting) | ~3.2% | ~$2.41 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (106,393 resting) | ~3.0% | ~$2.22 |
| `ewc-usse-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (90,098 resting) | ~2.9% | ~$2.16 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (47,319 resting) | ~8.2% | ~$2.04 |
| `ewc-usse-me-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (190,398 resting) | ~2.7% | ~$2.01 |
