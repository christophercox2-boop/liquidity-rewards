...
## ✅ Last successful check: 2026-08-18 6:58 PM ET
...
**Earning right now:** ~$273.00/day estimated (ceiling, not promise — details below)
...
### Estimated earning rate: ~$273.00/day (~$11.37/hour)
...
| `usgubewc-usgub-nm-2026-11-03-dem` | BUY | 93.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (500,669 resting ≥ 2,000 ✓) ≈ $6.25/day (event pool ÷ 2 markets) |
...
| `enwc-uspres-nom-rep-2028-rondes` | BUY | 9.0¢ | 135 | 1 | $200.00 | ✅ scoring — ~96.2% of bid side (63,768 resting ≥ 20,000 ✓) ≈ $6.87/day (event pool ÷ 14 markets) |
...
| `scc-hrep-rep-2026-11-03-gte210` | BUY | 44.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~90.9% of bid side (400,516 resting ≥ 5,000 ✓) ≈ $3.79/day (event pool ÷ 12 markets) |
...
| `usgubewc-usgub-hi-2026-11-03-dem` | BUY | 95.0¢ | 3 | 0 | $25.00 | ✅ scoring — ~85.7% of bid side (500,378 resting ≥ 2,000 ✓) ≈ $5.36/day (event pool ÷ 2 markets) |
...
| `scc-senate-gop-2026-11-03-52` | BUY | 11.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~82.1% of bid side (305,764 resting ≥ 5,000 ✓) ≈ $3.16/day (event pool ÷ 13 markets) |
...
| `usgubewc-usgub-md-2026-11-03-rep` | BUY | 1.0¢ | 1,799 | 0 | $25.00 | ✅ scoring — ~69.0% of bid side (2,607 resting ≥ 2,000 ✓) ≈ $4.31/day (event pool ÷ 2 markets) |
...
| `ewc-usp-2028-11-07-petbut` | SELL | 9.0¢ | 1 | 0 | $200.00 | ✅ scoring — ~50.6% of ask side (59,348 resting ≥ 20,000 ✓) ≈ $1.87/day (event pool ÷ 27 markets) |
...
| `usgubewc-usgub-ct-2026-11-03-dem` | BUY | 95.0¢ | 4 | 0 | $25.00 | ✅ scoring — ~49.9% of bid side (500,287 resting ≥ 2,000 ✓) ≈ $3.12/day (event pool ÷ 2 markets) |
| `usgubewc-usgub-ct-2026-11-03-dem` | BUY | 95.0¢ | 4 | 0 | $25.00 | ✅ scoring — ~49.9% of bid side (500,287 resting ≥ 2,000 ✓) ≈ $3.12/day (event pool ÷ 2 markets) |
...
<details><summary><code>enwc-uspres-nom-rep-2028-rondes</code> BUY 135 @ 9¢ → $6.87/day</summary>
...
`yours 27.0 / Σ 28.1 = 96.2%`  
`$200 ÷ 14 ÷ 2 = $7.14 × 96.2% = $6.87/day`  
...
<details><summary><code>usgubewc-usgub-md-2026-11-03-rep</code> BUY 1,799 @ 1¢ → $4.31/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 1¢ | 2,607 (1,799 yours) | ×0.1^0 = 2,607.0 |
| | | **Σ** | **2,607.0** |

`yours 1,799.0 / Σ 2,607.0 = 69.0%`  
...
<details><summary><code>ewc-usp-2028-11-07-petbut</code> SELL 1 @ 9¢ → $1.87/day</summary>
...
|  | 19¢ | 1 | ×0.2^10 = 0.0 |
|  | 23¢ | 55 | ×0.2^14 = 0.0 |
|  | 25¢ | 38,947 | ×0.2^16 = 0.0 |
| | | **Σ** | **2.0** |

`yours 1.0 / Σ 2.0 = 50.6%`  
...
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (284,457 resting) | ~3.6% | ~$2.68 |
| `ewc-usse-oh-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (631,818 resting) | ~9.3% | ~$2.34 |
| `ewc-usse-nc-2026-11-03-rep` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (66,474 resting) | ~6.6% | ~$1.64 |
...
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (280,763 resting) | ~1.9% | ~$1.42 |
