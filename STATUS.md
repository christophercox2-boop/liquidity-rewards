...
## ✅ Last successful check: 2026-08-16 2:30 PM ET
...
**Earning right now:** ~$308.96/day estimated (ceiling, not promise — details below)
...
**What else to join:** `ewc-usse-tx-2026-11-03-dem` — BUY at the best price, ~$15.35/day for 200 contracts. Runners-up: `ewc-usgub-oh-2026-11-03-rep` (~$5.08/day), `ewc-usgub-ga-2026-11-03-dem` (~$3.81/day)
...
### Estimated earning rate: ~$308.96/day (~$12.87/hour)
...
| `usgubewc-usgub-ri-2026-11-03-kenblo` | SELL | 5.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~100.0% of ask side (2,586 resting ≥ 2,000 ✓) ≈ $4.17/day (pool ÷ 3 markets) |
| `scc-senate-gop-2026-11-03-50` | SELL | 20.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~99.1% of ask side (92,851 resting ≥ 5,000 ✓) ≈ $3.81/day (pool ÷ 13 markets) |
| `usgubewc-usgub-ri-2026-11-03-dem` | SELL | 85.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~99.0% of ask side (2,228 resting ≥ 2,000 ✓) ≈ $4.13/day (pool ÷ 3 markets) |
| `scc-hrep-rep-2026-11-03-gte205` | SELL | 39.0¢ | 1 | 1 | $100.00 | ✅ scoring — ~90.9% of ask side (82,299 resting ≥ 5,000 ✓) ≈ $3.79/day (pool ÷ 12 markets) |
| `usgubewc-usgub-ri-2026-11-03-rep` | SELL | 7.0¢ | 1 | 0 | $25.00 | ✅ scoring — ~90.9% of ask side (2,252 resting ≥ 2,000 ✓) ≈ $3.79/day (pool ÷ 3 markets) |
...
| `ewc-usp-2028-11-07-gleyou` | BUY | 10.0¢ | 60 | 0 | $1,000.00 | ✅ scoring — ~90.0% of bid side (40,064 resting ≥ 20,000 ✓) ≈ $8.49/day (program pool ÷ 53 markets) |
...
| `ewc-usp-2028-11-07-dontru` | BUY | 10.0¢ | 60 | 0 | $1,000.00 | ✅ scoring — ~89.9% of bid side (40,064 resting ≥ 20,000 ✓) ≈ $8.49/day (program pool ÷ 53 markets) |
...
| `ewc-usp-2028-11-07-elomus` | BUY | 15.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~89.3% of bid side (27,505 resting ≥ 20,000 ✓) ≈ $8.42/day (program pool ÷ 53 markets) |
...
| `ewc-usp-2028-11-07-petbut` | BUY | 14.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~85.5% of bid side (30,009 resting ≥ 20,000 ✓) ≈ $8.06/day (program pool ÷ 53 markets) |
| `scc-senate-gop-2026-11-03-49` | SELL | 23.0¢ | 1 | 0 | $100.00 | ✅ scoring — ~82.9% of ask side (91,784 resting ≥ 5,000 ✓) ≈ $3.19/day (pool ÷ 13 markets) |
| `ewc-usp-2028-11-07-rahema` | BUY | 15.0¢ | 1 | 0 | $1,000.00 | ✅ scoring — ~75.7% of bid side (70,013 resting ≥ 20,000 ✓) ≈ $7.14/day (program pool ÷ 53 markets) |
...
| `enwc-ushrp-fl19-2026-08-18-jimobe` | BUY | 1.0¢ | 2,000 | 0 | $25.00 | ✅ scoring — ~66.7% of bid side (3,000 resting ≥ 2,000 ✓) ≈ $1.19/day (pool ÷ 7 markets) |
| …and 486 more | | | | | | |
...
<details><summary><code>scc-senate-gop-2026-11-03-50</code> SELL 1 @ 20¢ → $3.81/day</summary>
...
<details><summary><code>usgubewc-usgub-ri-2026-11-03-dem</code> SELL 1 @ 85¢ → $4.13/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte205</code> SELL 1 @ 39¢ → $3.79/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
|  | 38¢ | 0 | ×0.2^0 = 0.0 |
| ▶ | 39¢ | 1 (1 yours) | ×0.2^1 = 0.2 |
|  | 47¢ | 0 | ×0.2^9 = 0.0 |
|  | 49¢ | 1 | ×0.2^11 = 0.0 |
|  | 59¢ | 1 | ×0.2^21 = 0.0 |
|  | 60¢ | 25 | ×0.2^22 = 0.0 |
...
<details><summary><code>usgubewc-usgub-ri-2026-11-03-rep</code> SELL 1 @ 7¢ → $3.79/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-dontru</code> BUY 60 @ 10¢ → $8.49/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-elomus</code> BUY 1 @ 15¢ → $8.42/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-petbut</code> BUY 1 @ 14¢ → $8.06/day</summary>
...
<details><summary><code>scc-senate-gop-2026-11-03-49</code> SELL 1 @ 23¢ → $3.19/day</summary>
...
<details><summary><code>ewc-usp-2028-11-07-rahema</code> BUY 1 @ 15¢ → $7.14/day</summary>
...
<details><summary><code>enwc-ushrp-fl19-2026-08-18-jimobe</code> BUY 2,000 @ 1¢ → $1.19/day</summary>
...
|---|---:|---:|---:|---|---:|---:|
| `ewc-usse-tx-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (631,709 resting) | ~20.5% | ~$15.35 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (278,431 resting) | ~6.8% | ~$5.08 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (93,229 resting) | ~5.1% | ~$3.81 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (27,735 resting) | ~14.8% | ~$3.70 |
| `ewc-usgub-ks-2026-11-03-rep` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (95,320 resting) | ~58.9% | ~$3.68 |
| `ewc-usgub-ga-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (96,874 resting) | ~3.5% | ~$2.61 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (278,085 resting) | ~3.0% | ~$2.27 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (651,703 resting) | ~3.0% | ~$2.23 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (37,877 resting) | ~8.5% | ~$2.12 |
| `enwc-usgubp-fl-2026-08-18-rep-jamfis` | $300.00 ÷ 3 | 0.20 | 10,000 | BUY side (21,725 resting) | ~2.9% | ~$1.44 |
| `ewc-usse-ak-2026-11-03-dem` | $25.00 ÷ 2 | 0.10 | 2,000 | BUY side (359,959 resting) | ~22.1% | ~$1.38 |
| `ewc-usgub-mi-2026-11-03-mikdug` | $25.00 ÷ 3 | 0.10 | 2,000 | SELL side (73,217 resting) | ~30.6% | ~$1.28 |
