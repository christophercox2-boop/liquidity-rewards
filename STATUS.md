...
## ✅ Last successful check: 2026-08-06 9:36 PM ET

This runs automatically every hour. **If the timestamp above is more than ~2 hours old, something is broken** — check the [Actions tab](https://github.com/wfco223/Liquidity-rewards/actions/workflows/liquidity-rewards.yml).

## 📌 Summary

**Earning right now:** ~$89.58/day estimated (ceiling, not promise — details below)
...
**What else to join:** `enwc-ussep-mn-2026-08-11-dem-pegfla` — BUY at the best price, ~$16.71/day for 200 contracts. Runners-up: `enwc-usgubp-ok-2026-06-16-rep-mikmaz` (~$10.48/day), `ewc-usgub-ca-2026-11-03-xavbec` (~$9.08/day)
...
### Estimated earning rate: ~$89.58/day (~$3.73/hour)

Rough estimate — assumes the books, pools, and your orders stay as they are, both sides keep qualifying, each pool covers its whole event/race (so it's divided across that race's open markets), and splits evenly between bid and ask. Scored with the official formula: `DiscountFactor ^ (ticks from best price) × size`, counting only orders inside the Target Size window. Earning orders first.

| Market | Side | Price | Size | Ticks off best | Reward pool | Earning? |
|---|---|---:|---:|---:|---:|---|
| `scc-hrep-rep-2026-11-03-gte195` | BUY | 22.0¢ | 80 | 0 | $100.00 | ✅ scoring — ~100.0% of bid side (80,370 resting ≥ 5,000 ✓) ≈ $4.17/day (pool ÷ 12 markets) |
...
| `opdc-mcconnell-resign-2026-11-02` | BUY | 16.0¢ | 20 | 0 | $25.00 | ✅ scoring — ~100.0% of bid side (35,398 resting ≥ 2,000 ✓) ≈ $12.50/day |
...
| `dccc-measles-us-2026-12-31-gt3000` | BUY | 56.0¢ | 20 | 0 | $50.00 | ✅ scoring — ~43.0% of bid side (10,524 resting ≥ 10,000 ✓) ≈ $1.79/day (pool ÷ 6 markets) |
...
| `scc-senate-gop-2026-11-03-53` | SELL | 27.0¢ | 20 | 0 | $100.00 | ✅ scoring — ~42.5% of ask side (98,698 resting ≥ 5,000 ✓) ≈ $1.63/day (pool ÷ 13 markets) |
...
| `scc-hrep-rep-2026-11-03-gte200` | BUY | 51.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~31.2% of bid side (80,493 resting ≥ 5,000 ✓) ≈ $1.30/day (pool ÷ 12 markets) |
| `scc-hrep-rep-2026-11-03-gte190` | BUY | 66.0¢ | 10 | 0 | $100.00 | ✅ scoring — ~28.6% of bid side (80,248 resting ≥ 5,000 ✓) ≈ $1.19/day (pool ÷ 12 markets) |
| `scc-senate-gop-2026-11-03-53` | BUY | 9.0¢ | 100 | 0 | $100.00 | ✅ scoring — ~28.5% of bid side (10,547 resting ≥ 5,000 ✓) ≈ $1.10/day (pool ÷ 13 markets) |
| `scc-hrep-rep-2026-11-03-gte225` | BUY | 8.0¢ | 30 | 1 | $100.00 | ✅ scoring — ~25.8% of bid side (80,545 resting ≥ 5,000 ✓) ≈ $1.07/day (pool ÷ 12 markets) |
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte195</code> BUY 80 @ 22¢ → $4.17/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 22¢ | 80 (80 yours) | ×0.2^0 = 80.0 |
|  | 3¢ | 150 | ×0.2^19 = 0.0 |
|  | 2¢ | 79,940 | ×0.2^20 = 0.0 |
| | | **Σ** | **80.0** |
...
<details><summary><code>opdc-mcconnell-resign-2026-11-02</code> BUY 20 @ 16¢ → $12.50/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 16¢ | 20 (20 yours) | ×0.1^0 = 20.0 |
|  | 13¢ | 1 | ×0.1^3 = 0.0 |
|  | 12¢ | 11 | ×0.1^4 = 0.0 |
|  | 9¢ | 6 | ×0.1^7 = 0.0 |
|  | 8¢ | 18 | ×0.1^8 = 0.0 |
...
<details><summary><code>dccc-measles-us-2026-12-31-gt3000</code> BUY 20 @ 56¢ → $1.79/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
| ▶ | 56¢ | 20 (20 yours) | ×0.25^0 = 20.0 |
|  | 55¢ | 100 | ×0.25^1 = 25.0 |
|  | 53¢ | 94 | ×0.25^3 = 1.5 |
|  | 50¢ | 110 | ×0.25^6 = 0.0 |
|  | 1¢ | 10,200 | ×0.25^55 = 0.0 |
| | | **Σ** | **46.5** |

`yours 20.0 / Σ 46.5 = 43.0%`  
`$50 ÷ 6 ÷ 2 = $4.17 × 43.0% = $1.79/day`  
...
<details><summary><code>scc-senate-gop-2026-11-03-53</code> SELL 20 @ 27¢ → $1.63/day</summary>

| | Asks | Resting | Score |
|---|---:|---:|---:|
| ▶ | 27¢ | 26 (20 yours) | ×0.2^0 = 26.0 |
|  | 28¢ | 100 | ×0.2^1 = 20.0 |
|  | 30¢ | 131 | ×0.2^3 = 1.0 |
|  | 50¢ | 39 | ×0.2^23 = 0.0 |
|  | 97¢ | 43,824 | ×0.2^70 = 0.0 |
| | | **Σ** | **47.0** |

`yours 20.0 / Σ 47.0 = 42.5%`  
`$100 ÷ 13 ÷ 2 = $3.85 × 42.5% = $1.63/day`  
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte190</code> BUY 10 @ 66¢ → $1.19/day</summary>
...
<details><summary><code>scc-hrep-rep-2026-11-03-gte225</code> BUY 30 @ 8¢ → $1.07/day</summary>

| | Bids | Resting | Score |
|---|---:|---:|---:|
|  | 9¢ | 17 | ×0.2^0 = 17.0 |
| ▶ | 8¢ | 30 (30 yours) | ×0.2^1 = 6.0 |
|  | 5¢ | 48 | ×0.2^4 = 0.1 |
|  | 1¢ | 80,450 | ×0.2^8 = 0.2 |
| | | **Σ** | **23.3** |

`yours 6.0 / Σ 23.3 = 25.8%`  
...
|---|---:|---:|---:|---|---:|---:|
| `enwc-ussep-mn-2026-08-11-dem-pegfla` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (5,227 resting) | ~66.8% | ~$16.71 |
| `enwc-usgubp-ok-2026-06-16-rep-mikmaz` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (76,369 resting) | ~41.9% | ~$10.48 |
| `ewc-usgub-ca-2026-11-03-xavbec` | $300.00 ÷ 2 | 0.20 | 10,000 | SELL side (94,782 resting) | ~12.1% | ~$9.08 |
| `apdc-jerpowgov-2026-12-31` | $100.00 ÷ 2 | 0.20 | 5,000 | SELL side (13,304 resting) | ~29.3% | ~$7.32 |
| `enwc-usgubp-ok-2026-06-16-rep-gendru` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (76,692 resting) | ~25.5% | ~$6.37 |
| `ewc-usgub-oh-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (53,407 resting) | ~8.4% | ~$6.27 |
| `ewc-usgub-oh-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (72,040 resting) | ~5.8% | ~$4.34 |
| `ewc-usse-me-2026-11-03-rep` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (172,189 resting) | ~4.3% | ~$3.24 |
| `ewc-usse-me-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (198,788 resting) | ~3.5% | ~$2.64 |
| `ewc-usgub-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (73,866 resting) | ~3.2% | ~$2.41 |
| `ewc-usse-ga-2026-11-03-dem` | $300.00 ÷ 2 | 0.20 | 10,000 | BUY side (74,989 resting) | ~2.9% | ~$2.16 |
| `enwc-ussep-mn-2026-08-11-dem-angcra` | $100.00 ÷ 2 | 0.20 | 5,000 | BUY side (46,438 resting) | ~8.2% | ~$2.04 |
...
|---|---|---:|---:|
| 2026-08-06 9:36 PM ET | ✅ ok | 1676 | $1659.88 |
| 2026-08-06 9:28 PM ET | ✅ ok | 1676 | $1659.88 |
