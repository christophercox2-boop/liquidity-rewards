...
from v2.estimator import ET, Estimator, et_day, top_up_book
...
class TestIntegration(unittest.TestCase):
    ...
    def test_gap_is_capped_so_dead_time_is_not_billed(self):
        ...
        t0 = noon_et()
        e.sample(t0, one_order(), books_at(t0), st)
        e.sample(t0 + 5000, one_order(), books_at(t0 + 5000), st)  # 83 min gap
    ...
    def test_stale_books_bank_time_instead_of_accruing(self):
        ...
        e.sample(t0, one_order(), stale, st)
        e.sample(t0 + 100, one_order(), stale, st)
...
class TestDayRoll(unittest.TestCase):
    def test_day_closes_at_midnight_eastern(self):
        ...
        e.sample(d, one_order(), books_at(d), st)
        e.sample(d + 240, one_order(), books_at(d + 240), st)
        ...
        e.sample(roll, one_order(), books_at(roll - 1000), st)
...
class TestPersistence(unittest.TestCase):
    def test_roundtrip_keeps_the_running_day(self):
        ...
        e2.sample(t0 + 200, one_order(), books_at(t0 + 200), st)
